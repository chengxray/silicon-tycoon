var xe=Object.defineProperty;var ge=(I,t,e)=>t in I?xe(I,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):I[t]=e;var g=(I,t,e)=>ge(I,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function e(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(a){if(a.ep)return;a.ep=!0;const n=e(a);fetch(a.href,n)}})();class B{static getRequiredRankWeight(t){return t<=2?1:t<=4?2:t===5?3:4}static checkTPMConditions(t,e){if(!e)return{isTPMActive:!1,reason:"未指派工程師進駐"};if(e.moduleSpecialty!==t.category)return{isTPMActive:!1,reason:`專長不符！該機台為 ${t.category}，工程師專精為 ${e.moduleSpecialty}`};const s=this.getRequiredRankWeight(t.tier),a=this.RANK_WEIGHT[e.rank];return a<s?{isTPMActive:!1,reason:`職等不足！機台需等級 ${s}，該工程師為 ${e.rank} (等級 ${a})`}:e.workShift==="OFF"?{isTPMActive:!1,reason:"該工程師目前處於排休狀態 (OFF)，機台暫無在線工程師值班"}:e.fatigue>=50?{isTPMActive:!1,reason:`工程師疲勞度過高 (${e.fatigue} >= 50)，在線預防保養中斷`}:e.shiftMode!=="THREE_SHIFT"?{isTPMActive:!1,reason:"非三班輪調制（超時兩班制疲勞將持續爬升，無法達成 24H 永久零故障保障）"}:{isTPMActive:!0,reason:"🛡️ 滿足專長相符、資歷合規、在線值勤且低疲勞，享有 24 小時不停機零故障保障！"}}static checkExplosionRisk(t,e){if(!e)return{hasRisk:!1,rankDiff:0};const s=this.getRequiredRankWeight(t.tier),a=this.RANK_WEIGHT[e.rank],n=s-a;return{hasRisk:n>=2,rankDiff:n}}static updateMachineHealth(t,e,s=1){const{isTPMActive:a}=this.checkTPMConditions(t,e);if(a){const c=Math.min(t.wear,5),p=100-c;return{newWear:c,healthPercent:p,isTPMActive:!0,breakdownOccurred:!1,isExploded:!1}}let r=Math.min(100,t.wear+.005*s);const i=100-r,o=(r/100)**2*.05*(s/60),l=Math.random()<o;let d=!1;if(l&&e){const c=this.getRequiredRankWeight(t.tier),p=this.RANK_WEIGHT[e.rank];c-p>=2&&Math.random()<.25&&(d=!0)}return{newWear:Number(r.toFixed(2)),healthPercent:Number(i.toFixed(2)),isTPMActive:!1,breakdownOccurred:l,isExploded:d}}static calculateOverhaulCost(t){return Math.round(t*.15)}}g(B,"RANK_WEIGHT",{"Young Specialist":1,"Skilled Worker":2,"Senior Engineer":3,Fellow:4});class W{static calculateEffectiveK1(t,e,s){let a=.8;switch(t){case"BASE":a=.8;break;case"CAR":a=.65;break;case"OPC":a=.5;break;case"PSM":a=.38;break;case"SAQP":a=.28;break}const r=Math.max(0,Math.min(100,e))/100*.05;let i=0,o=0;if(s&&s.moduleSpecialty==="LITHO")if(s.fatigue>=80)i=0,o=.03;else switch(s.rank){case"Young Specialist":i=.01;break;case"Skilled Worker":i=.02;break;case"Senior Engineer":i=.04;break;case"Fellow":i=.06;break}let l=a+r-i+o;return l=Math.max(t==="SAQP"?.15:.25,Math.min(.95,l)),{effectiveK1:Number(l.toFixed(3)),k1Tech:a,deltaWear:Number(r.toFixed(3)),deltaEngineer:Number(i.toFixed(3)),deltaFatigue:Number(o.toFixed(3))}}static calculateEffectiveCD(t,e,s,a){const n=this.OPTICAL_CATALOG[t];if(!n)return 999999;const{effectiveK1:r}=this.calculateEffectiveK1(e,s,a),i=r*(n.wavelengthNm/n.numericalAperture);return Math.round(i)}static validateResolution(t,e,s,a,n){if(!this.OPTICAL_CATALOG[t])return{canResolve:!1,effectiveCD:999999,effectiveK1:.8,reason:"未知的微影機台型號"};const{effectiveK1:i}=this.calculateEffectiveK1(s,a,n),o=this.calculateEffectiveCD(t,s,a,n);return o>e?{canResolve:!1,effectiveCD:o,effectiveK1:i,reason:`光學解析度不足！當前極限 CD 為 ${o}nm，無法解析目標 ${e}nm 製程（磨損或人員疲勞導致 k1 劣化至 ${i}）。`}:{canResolve:!0,effectiveCD:o,effectiveK1:i}}static getProcessWindowPenalty(t){if(t>=.38)return 0;const e=(.38-t)*.5;return Math.max(0,Math.min(.25,e))}}g(W,"OPTICAL_CATALOG",{litho_contact:{modelId:"litho_contact",name:"Contact Aligner (接觸式微影機)",wavelengthNm:436,numericalAperture:.116,baseRayleighLimitNm:3007,unlockTier:1,baseCost:25e5,baseMttrSec:10},litho_projection:{modelId:"litho_projection",name:"1x Projection Aligner (1:1 投影微影機)",wavelengthNm:436,numericalAperture:.194,baseRayleighLimitNm:1798,unlockTier:1,baseCost:6e6,baseMttrSec:15},litho_gline:{modelId:"litho_gline",name:"G-Line Stepper (步進縮小曝光機)",wavelengthNm:436,numericalAperture:.35,baseRayleighLimitNm:997,unlockTier:2,baseCost:18e6,baseMttrSec:20},litho_iline:{modelId:"litho_iline",name:"I-Line Stepper (高壓汞燈微影機)",wavelengthNm:365,numericalAperture:.5,baseRayleighLimitNm:584,unlockTier:3,baseCost:35e6,baseMttrSec:30},litho_krf:{modelId:"litho_krf",name:"KrF DUV Scanner (準分子雷射掃描機)",wavelengthNm:248,numericalAperture:.7,baseRayleighLimitNm:283,unlockTier:4,baseCost:85e6,baseMttrSec:40},litho_arfdry:{modelId:"litho_arfdry",name:"ArF Dry Scanner (氟化氬乾式微影機)",wavelengthNm:193,numericalAperture:.85,baseRayleighLimitNm:182,unlockTier:4,baseCost:18e7,baseMttrSec:50},litho_arfi:{modelId:"litho_arfi",name:"ArFi Immersion TWINSCAN (雙工件台浸潤微影機)",wavelengthNm:193,numericalAperture:1.35,baseRayleighLimitNm:114,unlockTier:5,baseCost:45e7,baseMttrSec:60},litho_euv:{modelId:"litho_euv",name:"EUV Scanner (極紫外真空微影機)",wavelengthNm:13.5,numericalAperture:.33,baseRayleighLimitNm:33,unlockTier:6,baseCost:25e8,baseMttrSec:90},litho_highna:{modelId:"litho_highna",name:"High-NA EUV Scanner (變形高數值孔徑微影機)",wavelengthNm:13.5,numericalAperture:.55,baseRayleighLimitNm:20,unlockTier:6,baseCost:6e9,baseMttrSec:120}});class D{static isTileInYellowRoom(t,e,s){return s&&s.length>0?s.some(a=>a.x===t&&a.y===e):e<=3&&t>=3&&t<=7}static isMachineInYellowRoom(t,e){return this.isTileInYellowRoom(t.gridX,t.gridY,e)}static getStationRequiredSeconds(t,e,s,a){let n=this.BASE_STATION_DURATION_SEC[t]||10;return t==="LIT"&&e&&(n=this.LIT_SUBSTEP_DURATION_SEC[e]||10),s&&(n-=Math.min(2,(s.tier-1)*.5),s.wear>50&&(n+=Math.round((s.wear-50)/50*3))),a&&s&&a.moduleSpecialty===s.category&&a.fatigue<80&&(n=Math.max(4,Math.round(n*.85))),Math.max(4,Math.round(n))}static getStationSequence(t){return t?["FILM","LIT","ETCH","DIFF","CMP"]:["FILM","LIT","ETCH","DIFF"]}static calculateEffectiveQTimeSec(t,e,s,a){let n=45;t==="LIT"&&e==="ETCH"?n=45:t==="ETCH"&&e==="DIFF"?n=60:t==="CMP"&&(n=45);let r=1;a.includes("1000")&&!a.includes("10000")?r=1.15:a.includes("100")&&!a.includes("1000")?r=1.3:a.includes("1")&&!a.includes("10")&&(r=1.5);let i=1;return s>=1e3?i=1.5:s<=28&&(i=.8),Math.round(n*r*i)}static checkQTimeStatus(t,e,s=5e4){if(!t.qTimeDeadline)return{isOverdue:!1,overdueSeconds:0,isFatal:!1,canRework:!1,reworkCost:0,penaltyYieldRatio:1,urgencyLevel:"SAFE",remainingSeconds:999};const a=t.qTimeDeadline-e,n=t.currentStation==="ETCH";if(a>15)return{isOverdue:!1,overdueSeconds:0,isFatal:!1,canRework:!1,reworkCost:0,penaltyYieldRatio:1,urgencyLevel:"SAFE",remainingSeconds:a};if(a>0)return{isOverdue:!1,overdueSeconds:0,isFatal:!1,canRework:!1,reworkCost:0,penaltyYieldRatio:1,urgencyLevel:"WARNING",remainingSeconds:a};const r=Math.abs(a);return r<=15?{isOverdue:!0,overdueSeconds:r,isFatal:!1,canRework:!1,reworkCost:0,penaltyYieldRatio:.65,urgencyLevel:"CRITICAL",remainingSeconds:0}:n?{isOverdue:!0,overdueSeconds:r,isFatal:!0,canRework:!0,reworkCost:s,penaltyYieldRatio:0,urgencyLevel:"EXPIRED",remainingSeconds:0}:{isOverdue:!0,overdueSeconds:r,isFatal:!0,canRework:!1,reworkCost:0,penaltyYieldRatio:0,urgencyLevel:"EXPIRED",remainingSeconds:0}}static executeReworkLot(t,e){return t.currentStation="LIT",t.litSubStep="COAT",t.qTimeDeadline=null,t.status="PROCESSING",t.yieldMultiplier=Math.max(.85,t.yieldMultiplier*.95),{success:!0,message:`成功救回批次 ${t.lotId}！耗費溶劑費 NT$ ${e.toLocaleString()}，已退回黃光塗膠站重新加工。`}}static advanceLotStation(t,e,s,a,n,r,i){const o=this.getStationSequence(e);if(r&&i&&t.currentStation==="LIT"){const d=r.find(p=>p.category==="LITHO"),c=r.find(p=>p.category==="TRACK");(t.litSubStep==="EXPOSE"&&d&&!this.isMachineInYellowRoom(d,i)||(t.litSubStep==="COAT"||t.litSubStep==="DEVELOP")&&c&&!this.isMachineInYellowRoom(c,i))&&(t.yieldMultiplier=0,t.hasYellowRoomViolation=!0)}if(t.currentStation==="LIT"){if(!t.litSubStep||t.litSubStep==="COAT")return t.litSubStep="EXPOSE",t.qTimeDeadline=null,{nextStation:"LIT",nextSubStep:"EXPOSE",isLayerCompleted:!1,isLotCompleted:!1};if(t.litSubStep==="EXPOSE")return t.litSubStep="DEVELOP",t.qTimeDeadline=null,{nextStation:"LIT",nextSubStep:"DEVELOP",isLayerCompleted:!1,isLotCompleted:!1};if(t.litSubStep==="DEVELOP"){t.currentStation="ETCH",t.litSubStep=void 0;const d=this.calculateEffectiveQTimeSec("LIT","ETCH",s,a);return t.qTimeDeadline=n+d,{nextStation:"ETCH",isLayerCompleted:!1,isLotCompleted:!1}}}const l=o.indexOf(t.currentStation);if(l>=0&&l<o.length-1){const d=o[l+1];if(t.currentStation=d,d==="LIT"&&(t.litSubStep="COAT"),t.currentStation==="DIFF"){const c=this.calculateEffectiveQTimeSec("ETCH","DIFF",s,a);t.qTimeDeadline=n+c}else t.qTimeDeadline=null;return{nextStation:d,isLayerCompleted:!1,isLotCompleted:!1}}return t.currentLayer<t.totalLayers?(t.currentLayer+=1,t.currentStation="FILM",t.litSubStep=void 0,t.qTimeDeadline=null,{nextStation:"FILM",isLayerCompleted:!0,isLotCompleted:!1}):(t.status="COMPLETED",t.qTimeDeadline=null,{nextStation:t.currentStation,isLayerCompleted:!0,isLotCompleted:!0})}static calculateStationThroughputs(t,e,s){var l;const a=["FILM","TRACK","LIT","ETCH","DIFF","CMP"],n={FILM:{station:"FILM",totalCapacity:0,machineCount:0,isChokePoint:!1},TRACK:{station:"TRACK",totalCapacity:0,machineCount:0,isChokePoint:!1},LIT:{station:"LIT",totalCapacity:0,machineCount:0,isChokePoint:!1},ETCH:{station:"ETCH",totalCapacity:0,machineCount:0,isChokePoint:!1},DIFF:{station:"DIFF",totalCapacity:0,machineCount:0,isChokePoint:!1},CMP:{station:"CMP",totalCapacity:0,machineCount:0,isChokePoint:!1}},r=new Map;for(const d of e)r.set(d.id,d);for(const d of t){if(d.status==="EXPLODED")continue;let c=d.category;d.category==="LITHO"&&(c="LIT");const p=((l=this.BASE_THROUGHPUT_BY_TIER[c])==null?void 0:l[d.tier])??10,h=1-d.wear/100*.3;let u=1;if(d.assignedEngineerId&&r.has(d.assignedEngineerId)){const b=r.get(d.assignedEngineerId);b.moduleSpecialty===d.category&&b.fatigue<80&&(u=1.2)}c==="LIT"&&d.pairedTrackIds&&d.pairedTrackIds.length>=2&&(u+=.05);const m=p*h*u;n[c].totalCapacity+=m,n[c].machineCount+=1}let i=1/0,o="TRACK";for(const d of a)d==="CMP"&&!s||n[d].totalCapacity<i&&(i=n[d].totalCapacity,o=d);return i<1/0&&o&&(n[o].isChokePoint=!0),n}static calculateLogisticsFactor(t,e,s){let a=.5;t.oht?a=1.2:t.agv&&(a=.85);let n=5;if(e.length>=2){let o=0,l=0;for(let d=0;d<e.length-1;d++){const c=Math.abs(e[d].gridX-e[d+1].gridX)+Math.abs(e[d].gridY-e[d+1].gridY);o+=c,l++}n=l>0?o/l:5}const r=Math.max(.6,Math.min(1.1,6/Math.max(2,n))),i=Math.min(.2,s*.02);return Number((a*r*(1-i)).toFixed(2))}static calculateFactoryWorkload(t,e,s,a,n){const r=this.calculateStationThroughputs(t,e,n),i=this.calculateLogisticsFactor(a,t,s.length),o=["FILM","TRACK","LIT","ETCH","DIFF"];n&&o.push("CMP");let l=1/0;for(const u of o){const m=r[u].totalCapacity;m<l&&(l=m)}const d=Math.max(1,l*i);let c=0;for(const u of s)(u.status==="PROCESSING"||u.status==="WAITING_QTIME"||u.status==="TRANSPORTING")&&(c+=u.waferCount);const p=Math.min(150,Math.round(c/d*100));let h="SMOOTH";return p>85?h="OVERLOADED":p>=70&&(h="HEAVY"),{workloadPercent:p,maxCapacityWafersPerMin:Math.round(d),totalDemandWafers:c,statusLevel:h,throughputs:r}}static diagnoseBottleneck(t,e,s,a,n){var u;const{workloadPercent:r,throughputs:i}=this.calculateFactoryWorkload(t,e,s,a,n),o=t.find(m=>m.wear>=70);if(o){const m=o.category==="LITHO"?"LIT":o.category;return{category:"MAINTENANCE",title:"機台嚴重老化致效能衰退",stationName:o.category,description:`【${o.name}】磨損度高達 ${o.wear}%，抽真空與加工速率嚴重衰退超過 20%！`,recommendation:"請立即指派工程師對該機台執行「就地大修（Overhaul）」或保養，恢復 100% 原始效能。",workloadPercent:r,chokePointThroughput:Math.round(((u=i[m])==null?void 0:u.totalCapacity)??10)}}const l=i.TRACK.totalCapacity,d=i.LIT.totalCapacity;if(l<d&&l<40)return{category:"CAPACITY",title:"塗膠顯影 (Track) 先天物理產能瓶頸",stationName:"TRACK",description:`LITHO 曝光機正在空轉等待！【Track 塗膠顯影站】產能僅 ${Math.round(l)} 片/分，是產線最大卡點！`,recommendation:"光阻旋塗與烘烤受熱擴散物理限制，建議增購第 2 台 Track 機台或將其並聯綁定至微影機以分流消化產能！",workloadPercent:r,chokePointThroughput:Math.round(l)};let c="FILM",p=1/0;const h=["FILM","TRACK","LIT","ETCH","DIFF"];n&&h.push("CMP");for(const m of h)i[m].totalCapacity<p&&(p=i[m].totalCapacity,c=m);return p<=15?{category:"CAPACITY",title:"關鍵製程站點設備數量不足",stationName:c,description:`【${c} 站】產能僅 ${Math.round(p)} 片/分，遠低於其他站點，晶圓在門口嚴重堆積！`,recommendation:`建議前往商城增購第 2 台 ${c} 設備進行分流，或將現有機台升級為更高階型號。`,workloadPercent:r,chokePointThroughput:Math.round(p)}:!a.agv&&!a.oht&&s.length>=2?{category:"LOGISTICS",title:"人工手持搬運效率偏低",stationName:"AMHS 物流",description:"當前仍為「技術員手持晶圓盒步行搬運」，走動搬運耗時佔據了整個製程週期的 40% 以上！",recommendation:"投片量已超越人工負荷極限！強烈建議研發解鎖「地面 AGV 自走車」或「天花板 OHT 天軌」。",workloadPercent:r,chokePointThroughput:Math.round(p)}:{category:"LAYOUT",title:"機台動線規劃待最佳化",stationName:"廠房佈局",description:"前後站點相隔較遠，搬運載具在走道往返耗時過多，拉長了晶圓整體的傳送等待時間。",recommendation:"建議在廠房編輯模式中將相鄰製程機台（如 Track 與 Litho、Etch 與 Diff）就近排列，縮短傳送時間。",workloadPercent:r,chokePointThroughput:Math.round(p)}}static autoFillBestEconomyAllocation(t,e){const s=e.filter(o=>o.category==="LITHO");if(s.length===0)return[];const a=[...s].sort((o,l)=>{var p,h;const d=((p=W.OPTICAL_CATALOG[o.modelId])==null?void 0:p.baseRayleighLimitNm)??9999,c=((h=W.OPTICAL_CATALOG[l.modelId])==null?void 0:h.baseRayleighLimitNm)??9999;return d-c}),n=a[0],r=a[a.length-1],i=[];for(let o=1;o<=t.layerCount;o++){let l=o<=3,d=l?t.nodeNm:Math.max(t.nodeNm*2.5,350),c=l?n.modelId:r.modelId;i.push({layerIndex:o,layerType:l?"關鍵層 (Critical Layer)":"繞線層 (Metal Interconnect)",targetCD:Math.round(d),assignedMachineModelId:c})}return i}}g(D,"BASE_STATION_DURATION_SEC",{FILM:10,LIT:27,ETCH:12,DIFF:16,CMP:10}),g(D,"LIT_SUBSTEP_DURATION_SEC",{COAT:7,EXPOSE:12,DEVELOP:8}),g(D,"BASE_THROUGHPUT_BY_TIER",{LIT:{1:10,2:25,3:55,4:120,5:260,6:180},TRACK:{1:6,2:16,3:35,4:75,5:140,6:160},FILM:{1:12,2:24,3:50,4:110,5:220,6:200},ETCH:{1:12,2:24,3:50,4:110,5:220,6:200},DIFF:{1:10,2:20,3:45,4:100,5:200,6:180},CMP:{1:0,2:0,3:40,4:90,5:180,6:160}});const L={machines:{litho_contact:{path:"./assets/machines/litho_contact.png",label:"Contact Aligner",tier:1},litho_projection:{path:"./assets/machines/litho_projection.png",label:"1x Projection Aligner",tier:1},litho_gline:{path:"./assets/machines/litho_gline.png",label:"G-Line Stepper",tier:2},litho_iline:{path:"./assets/machines/litho_iline.png",label:"I-Line Stepper",tier:3},litho_krf:{path:"./assets/machines/litho_krf.png",label:"KrF DUV Scanner",tier:4},litho_arfdry:{path:"./assets/machines/litho_arfdry.png",label:"ArF Dry Scanner",tier:4},litho_arfi:{path:"./assets/machines/litho_arfi.png",label:"ArFi Immersion TWINSCAN",tier:5},litho_euv:{path:"./assets/machines/litho_euv.png",label:"EUV Scanner (無標誌 2.5D 旗艦)",tier:6},litho_highna:{path:"./assets/machines/litho_highna.png",label:"High-NA EUV Scanner",tier:6},track_manual:{path:"./assets/machines/track_manual.png",label:"手動旋塗熱板台",tier:1},track_single:{path:"./assets/machines/track_clean.png",label:"單軌自動塗膠顯影機",tier:2},track_dual:{path:"./assets/machines/track_dual.png",label:"雙軌連線 Track",tier:3},track_clean:{path:"./assets/machines/track_clean.png",label:"多工位精密 Clean Track",tier:4},track_advanced:{path:"./assets/machines/track_advanced.png",label:"先進極限分子級 Track",tier:6},etch_wet:{path:"./assets/machines/etch_wet.png",label:"濕式酸槽清洗台",tier:1},etch_plasma:{path:"./assets/machines/etch_plasma.png",label:"電漿乾式蝕刻機 (RIE)",tier:3},film_furnace:{path:"./assets/machines/film_furnace.png",label:"高溫熱氧化爐管",tier:1},film_pecvd:{path:"./assets/machines/film_pecvd.png",label:"電漿化學沉積 / ALD 機",tier:4},diff_furnace:{path:"./assets/machines/diff_furnace.png",label:"熱擴散高溫爐管",tier:1},diff_implanter:{path:"./assets/machines/diff_implanter.png",label:"大束流離子佈植機",tier:2},cmp_polisher:{path:"./assets/machines/cmp_polisher.png",label:"化學機械平坦化研磨機",tier:3}},characters:{tech_cleanroom:{path:"./assets/characters/tech_cleanroom.png",label:"Cleanroom Technician"},agv_carrier:{path:"./assets/characters/agv_carrier.png",label:"AGV Wafer Carrier"},oht_shuttle:{path:"./assets/characters/oht_shuttle.png",label:"OHT Sky-Rail Shuttle"}}};class f{static getContext(){if(this.isMuted)return null;if(!this.audioCtx){const t=window.AudioContext||window.webkitAudioContext;t&&(this.audioCtx=new t)}return this.audioCtx&&this.audioCtx.state==="suspended"&&this.audioCtx.resume(),this.audioCtx}static toggleMute(){return this.isMuted=!this.isMuted,this.isMuted}static isAudioMuted(){return this.isMuted}static playClick(){const t=this.getContext();if(!t)return;const e=t.createOscillator(),s=t.createGain(),a=t.currentTime;e.type="sine",e.frequency.setValueAtTime(800,a),e.frequency.exponentialRampToValueAtTime(1200,a+.04),s.gain.setValueAtTime(.15,a),s.gain.exponentialRampToValueAtTime(.001,a+.04),e.connect(s),s.connect(t.destination),e.start(a),e.stop(a+.04)}static playCoin(){const t=this.getContext();if(!t)return;const e=t.currentTime,s=t.createOscillator(),a=t.createOscillator(),n=t.createGain();s.type="sine",s.frequency.setValueAtTime(987.77,e),s.frequency.setValueAtTime(1318.51,e+.08),a.type="triangle",a.frequency.setValueAtTime(1975.53,e+.08),n.gain.setValueAtTime(.2,e),n.gain.exponentialRampToValueAtTime(.001,e+.28),s.connect(n),a.connect(n),n.connect(t.destination),s.start(e),s.stop(e+.28),a.start(e+.08),a.stop(e+.28)}static playCoinChime(){this.playCoin()}static playSuccess(){const t=this.getContext();if(!t)return;const e=t.currentTime;[523.25,659.25,783.99,1046.5].forEach((a,n)=>{const r=t.createOscillator(),i=t.createGain(),o=e+n*.08;r.type="triangle",r.frequency.setValueAtTime(a,o),i.gain.setValueAtTime(.2,o),i.gain.exponentialRampToValueAtTime(.001,o+.35),r.connect(i),i.connect(t.destination),r.start(o),r.stop(o+.35)})}static playFanfare(){this.playSuccess()}static playWarning(){const t=this.getContext();if(!t)return;const e=t.currentTime,s=t.createOscillator(),a=t.createGain();s.type="sawtooth",s.frequency.setValueAtTime(440,e),s.frequency.setValueAtTime(554.37,e+.1),a.gain.setValueAtTime(.12,e),a.gain.exponentialRampToValueAtTime(.001,e+.25),s.connect(a),a.connect(t.destination),s.start(e),s.stop(e+.25)}static playCriticalAlarm(){const t=this.getContext();if(!t)return;const e=t.currentTime,s=t.createOscillator(),a=t.createGain();s.type="sawtooth",s.frequency.setValueAtTime(600,e),s.frequency.linearRampToValueAtTime(950,e+.18),s.frequency.linearRampToValueAtTime(600,e+.36),a.gain.setValueAtTime(.18,e),a.gain.exponentialRampToValueAtTime(.001,e+.4),s.connect(a),a.connect(t.destination),s.start(e),s.stop(e+.4)}static playExplosion(){const t=this.getContext();if(!t)return;const e=t.currentTime,s=t.sampleRate*.6,a=t.createBuffer(1,s,t.sampleRate),n=a.getChannelData(0);for(let l=0;l<s;l++)n[l]=Math.random()*2-1;const r=t.createBufferSource();r.buffer=a;const i=t.createBiquadFilter();i.type="lowpass",i.frequency.setValueAtTime(800,e),i.frequency.exponentialRampToValueAtTime(40,e+.6);const o=t.createGain();o.gain.setValueAtTime(.4,e),o.gain.exponentialRampToValueAtTime(.001,e+.6),r.connect(i),i.connect(o),o.connect(t.destination),r.start(e),r.stop(e+.6)}static playRework(){const t=this.getContext();if(!t)return;const e=t.currentTime,s=t.sampleRate*.4,a=t.createBuffer(1,s,t.sampleRate),n=a.getChannelData(0);for(let l=0;l<s;l++)n[l]=Math.random()*2-1;const r=t.createBufferSource();r.buffer=a;const i=t.createBiquadFilter();i.type="bandpass",i.frequency.setValueAtTime(1200,e),i.frequency.exponentialRampToValueAtTime(300,e+.4),i.Q.value=3;const o=t.createGain();o.gain.setValueAtTime(.2,e),o.gain.exponentialRampToValueAtTime(.001,e+.4),r.connect(i),i.connect(o),o.connect(t.destination),r.start(e),r.stop(e+.4)}static playAlarm(){this.playWarning()}static playDing(){this.playCoin()}}g(f,"audioCtx",null),g(f,"isMuted",!1);const ae=class ae extends Phaser.Scene{constructor(){super({key:ae.KEY});g(this,"saveGame");g(this,"tileWidth",200);g(this,"tileHeight",100);g(this,"isPlannerMode",!1);g(this,"plannerTool","NONE");g(this,"movingMachineId",null);g(this,"pointerDownMachineId",null);g(this,"plannerIndicatorGraphics");g(this,"selectionRingGraphics");g(this,"onStateUpdateCallback");g(this,"floorGraphics");g(this,"railGraphics");g(this,"machineMap",new Map);g(this,"technicians",[]);g(this,"ohtShuttles",[]);g(this,"agvCarriers",[]);g(this,"isDragging",!1);g(this,"dragStartX",0);g(this,"dragStartY",0);g(this,"totalDragDistance",0);g(this,"dragThreshold",6);g(this,"justSelectedMachineOnPointerUp",!1);g(this,"onMachineClickCallback")}init(e){this.saveGame=e.saveGame,this.onMachineClickCallback=e.onMachineClick,this.onStateUpdateCallback=e.onStateUpdate}preload(){this.load.on("complete",()=>{this.refreshMachineSprites()}),this.load.on("loaderror",e=>{console.warn("⚠️ 貼圖載入失敗:",e==null?void 0:e.key,e==null?void 0:e.url)});for(const[e,s]of Object.entries(L.machines))this.textures.exists(e)||this.load.image(e,s.path);for(const[e,s]of Object.entries(L.characters))!this.textures.exists(e)&&s.path&&this.load.image(e,s.path)}refreshMachineSprites(){for(const e of this.saveGame.machines){const s=this.machineMap.get(e.id);if(s&&!s.sprite&&this.textures.exists(e.modelId)){s.fallback&&(s.fallback.destroy(),s.fallback=void 0);const a=this.add.image(0,-35,e.modelId),n=this.tileWidth*.95;a.setDisplaySize(n,n),s.container.addAt(a,1),s.sprite=a}}}create(){this.floorGraphics=this.add.graphics(),this.selectionRingGraphics=this.add.graphics(),this.selectionRingGraphics.setDepth(45),this.plannerIndicatorGraphics=this.add.graphics(),this.plannerIndicatorGraphics.setDepth(48),this.railGraphics=this.add.graphics(),this.renderFloor(),this.renderOHTRails(),this.renderMachines(),this.spawnTechnicians(),this.spawnAGVCarriers(),this.spawnOHTShuttles(),this.cameras.main.centerOn(0,300),this.cameras.main.setZoom(.85),this.setupCameraControls(),this.scale.on("resize",this.onResize,this)}toScreen(e,s){const a=(e-s)*(this.tileWidth/2),n=(e+s)*(this.tileHeight/2);return{x:a,y:n}}toGrid(e,s){const a=Math.round(e/this.tileWidth+s/this.tileHeight),n=Math.round(s/this.tileHeight-e/this.tileWidth);return{gridX:a,gridY:n}}renderFloor(){this.floorGraphics.clear();const e=this.saveGame.facility.bayGridSize,s=this.saveGame.facility.yellowRoomTiles||[];for(let a=0;a<e.width;a++)for(let n=0;n<e.height;n++){const{x:r,y:i}=this.toScreen(a,n),o=s.length>0?s.some(h=>h.x===a&&h.y===n):n<=3&&a>=3&&a<=7,l={x:r,y:i-this.tileHeight/2},d={x:r+this.tileWidth/2,y:i},c={x:r,y:i+this.tileHeight/2},p={x:r-this.tileWidth/2,y:i};o?(this.floorGraphics.fillStyle(3153414,.96),this.floorGraphics.lineStyle(1.8,16096779,.55)):(this.floorGraphics.fillStyle((a+n)%2===0?594210:792109,.95),this.floorGraphics.lineStyle(1,1976635,.55)),this.floorGraphics.beginPath(),this.floorGraphics.moveTo(l.x,l.y),this.floorGraphics.lineTo(d.x,d.y),this.floorGraphics.lineTo(c.x,c.y),this.floorGraphics.lineTo(p.x,p.y),this.floorGraphics.closePath(),this.floorGraphics.fillPath(),this.floorGraphics.strokePath()}}renderOHTRails(){this.railGraphics.clear();const e=this.saveGame.facility.bayGridSize,s=-160;this.railGraphics.lineStyle(2.5,440020,.35);const a=this.toScreen(1,1),n=this.toScreen(e.width-2,1),r=this.toScreen(e.width-2,e.height-2),i=this.toScreen(1,e.height-2);this.railGraphics.beginPath(),this.railGraphics.moveTo(a.x,a.y+s),this.railGraphics.lineTo(n.x,n.y+s),this.railGraphics.lineTo(r.x,r.y+s),this.railGraphics.lineTo(i.x,i.y+s),this.railGraphics.closePath(),this.railGraphics.strokePath()}renderMachines(){const e=new Set(this.saveGame.machines.map(a=>a.id));for(const[a,n]of this.machineMap)e.has(a)||(n.container.destroy(),this.machineMap.delete(a));const s=new Map(this.saveGame.staff.map(a=>[a.id,a]));for(const a of this.saveGame.machines){const{x:n,y:r}=this.toScreen(a.gridX,a.gridY),i=(a.gridX+a.gridY)*10+50;let o=this.machineMap.get(a.id);if(o){if(o.container.setPosition(n,r),o.container.setDepth(i),!o.sprite&&this.textures.exists(a.modelId)){o.fallback&&(o.fallback.destroy(),o.fallback=void 0);const h=this.add.image(0,-25,a.modelId),u=118;h.setDisplaySize(u,u),o.container.addAt(h,1),o.sprite=h}if(o.ledArc.setFillStyle(this.getLEDColor(a.status)),o.label.setText(`${a.name} (${Math.round(a.wear)}%)`),a.status==="PROCESSING"){if(!o.processingText){const h=this.add.text(0,-104,"⚡ 加工中",{fontFamily:"Noto Sans TC, sans-serif",fontSize:"10px",fontStyle:"bold",color:"#38bdf8",backgroundColor:"rgba(8, 47, 73, 0.95)",padding:{x:5,y:2}});h.setOrigin(.5),o.container.add(h),o.processingText=h}}else o.processingText&&(o.processingText.destroy(),o.processingText=void 0);const l=D.isMachineInYellowRoom(a,this.saveGame.facility.yellowRoomTiles);if((a.category==="LITHO"||a.category==="TRACK")&&!l){if(!o.yellowAlertText){const h=this.add.text(0,-125,"🚨 缺乏黃光防護 (良率 0%)",{fontFamily:"Noto Sans TC, sans-serif",fontSize:"10px",fontStyle:"bold",color:"#ffffff",backgroundColor:"rgba(220, 38, 38, 0.95)",padding:{x:6,y:3}});h.setOrigin(.5),o.container.add(h),o.yellowAlertText=h}}else o.yellowAlertText&&(o.yellowAlertText.destroy(),o.yellowAlertText=void 0);const c=a.assignedEngineerId?s.get(a.assignedEngineerId):null,p=B.checkTPMConditions(a,c);if(p.isTPMActive&&!o.tpmText){const h=this.add.text(0,-104,"🛡️ TPM 零故障",{fontFamily:"Noto Sans TC, sans-serif",fontSize:"10px",fontStyle:"bold",color:"#10b981",backgroundColor:"rgba(6, 78, 59, 0.92)",padding:{x:5,y:2}});h.setOrigin(.5),o.container.add(h),o.tpmText=h}else!p.isTPMActive&&o.tpmText&&(o.tpmText.destroy(),o.tpmText=void 0)}else{const l=this.add.container(n,r);l.setDepth(i);const d=this.add.ellipse(0,10,88,38,0,.4);l.add(d);let c,p;const h=118;this.textures.exists(a.modelId)?(c=this.add.image(0,-25,a.modelId),c.setDisplaySize(h,h),l.add(c)):(p=this.createFallbackMachineGraphic(a),l.add(p));const u=this.getLEDColor(a.status),m=this.add.circle(0,-82,6,u);l.add(m);const b=this.add.text(0,18,`${a.name} (${Math.round(a.wear)}%)`,{fontFamily:"Noto Sans TC, sans-serif",fontSize:"11px",fontStyle:"bold",color:"#f8fafc",backgroundColor:"rgba(15, 23, 42, 0.88)",padding:{x:6,y:3}});b.setOrigin(.5),l.add(b);const x=a.assignedEngineerId?s.get(a.assignedEngineerId):null,y=B.checkTPMConditions(a,x);let T;y.isTPMActive&&(T=this.add.text(0,-104,"🛡️ TPM 零故障",{fontFamily:"Noto Sans TC, sans-serif",fontSize:"10px",fontStyle:"bold",color:"#10b981",backgroundColor:"rgba(6, 78, 59, 0.92)",padding:{x:5,y:2}}),T.setOrigin(.5),l.add(T));let k;a.status==="PROCESSING"&&(k=this.add.text(0,-104,"⚡ 加工中",{fontFamily:"Noto Sans TC, sans-serif",fontSize:"10px",fontStyle:"bold",color:"#38bdf8",backgroundColor:"rgba(8, 47, 73, 0.95)",padding:{x:5,y:2}}),k.setOrigin(.5),l.add(k));const E=D.isMachineInYellowRoom(a,this.saveGame.facility.yellowRoomTiles),v=a.category==="LITHO"||a.category==="TRACK";let C;v&&!E&&(C=this.add.text(0,-125,"🚨 缺乏黃光防護 (良率 0%)",{fontFamily:"Noto Sans TC, sans-serif",fontSize:"10px",fontStyle:"bold",color:"#ffffff",backgroundColor:"rgba(220, 38, 38, 0.95)",padding:{x:6,y:3}}),C.setOrigin(.5),l.add(C));const O=96,F=96;l.setInteractive(new Phaser.Geom.Rectangle(-O/2,-F+15,O,F),Phaser.Geom.Rectangle.Contains),l.on("pointerdown",w=>{var P;document.querySelector(".modal-backdrop")||(((P=document.getElementById("modal-container"))==null?void 0:P.children.length)??0)>0||(this.pointerDownMachineId=a.id,w.event&&w.event.stopPropagation())}),l.on("pointerover",()=>{var P;if(document.querySelector(".modal-backdrop")||(((P=document.getElementById("modal-container"))==null?void 0:P.children.length)??0)>0)return;const w=this.machineMap.get(a.id);w!=null&&w.sprite&&w.sprite.setTint(3718648)}),l.on("pointerout",()=>{const w=this.machineMap.get(a.id);w!=null&&w.sprite&&w.sprite.clearTint()}),l.on("pointerup",w=>{var P;if(document.querySelector(".modal-backdrop")||(((P=document.getElementById("modal-container"))==null?void 0:P.children.length)??0)>0){this.pointerDownMachineId=null;return}this.pointerDownMachineId===a.id&&this.totalDragDistance<=this.dragThreshold&&(w.event&&w.event.stopPropagation(),f.playClick(),this.isPlannerMode&&this.plannerTool==="MOVE_MACHINE"?(this.justSelectedMachineOnPointerUp=!0,this.selectMachineToMove(a)):this.isPlannerMode||this.onMachineClickCallback&&this.onMachineClickCallback(a)),this.pointerDownMachineId=null}),this.machineMap.set(a.id,{container:l,ledArc:m,label:b,tpmText:T,processingText:k,yellowAlertText:C,sprite:c,fallback:p})}}}createFallbackMachineGraphic(e){const s=this.add.graphics(),a=60;let n=3900150;return e.category==="LITHO"&&(n=16096779),e.category==="TRACK"&&(n=1096065),e.category==="ETCH"&&(n=9133302),e.category==="DIFF"&&(n=15485081),e.category==="CMP"&&(n=440020),s.fillStyle(n,.9),s.beginPath(),s.moveTo(0,-70),s.lineTo(a/2,-60),s.lineTo(0,-50),s.lineTo(-a/2,-60),s.closePath(),s.fillPath(),s.fillStyle(n,.7),s.beginPath(),s.moveTo(-a/2,-60),s.lineTo(0,-50),s.lineTo(0,0),s.lineTo(-a/2,-10),s.closePath(),s.fillPath(),s.fillStyle(n,.5),s.beginPath(),s.moveTo(0,-50),s.lineTo(a/2,-60),s.lineTo(a/2,-10),s.lineTo(0,0),s.closePath(),s.fillPath(),s}getLEDColor(e){switch(e){case"IDLE":return 1096065;case"PROCESSING":return 440020;case"MAINTENANCE":return 16096779;case"EXPLODED":return 15680580}}spawnTechnicians(){const e=Math.min(6,Math.max(2,this.saveGame.staff.length));for(let s=0;s<e;s++){const a=this.add.container(0,0);a.setDepth(200);const n=this.add.ellipse(0,4,18,9,0,.35);if(a.add(n),this.textures.exists("tech_cleanroom")){const i=this.add.image(0,-18,"tech_cleanroom");i.setDisplaySize(48,48),a.add(i)}else{const i=this.add.circle(0,-12,8,16317180),o=this.add.rectangle(0,-12,8,4,3718648),l=this.add.rectangle(0,-4,12,12,14870768);a.add([l,i,o])}const r=this.toScreen(2+s,3);a.setPosition(r.x,r.y),this.technicians.push({container:a,targetX:r.x,targetY:r.y,speed:.6+Math.random()*.4})}}spawnAGVCarriers(){if(this.saveGame.unlockedFeatures.agv)for(let e=0;e<2;e++){const s=this.add.container(0,0);s.setDepth(205);const a=this.add.ellipse(0,4,24,12,0,.4);if(s.add(a),this.textures.exists("agv_carrier")){const r=this.add.image(0,-14,"agv_carrier");r.setDisplaySize(54,40),s.add(r)}else{const r=this.add.rectangle(0,-8,28,16,165063),i=this.add.rectangle(0,-18,16,12,1096065),o=this.add.circle(10,-8,3,15680580);s.add([r,i,o])}const n=this.toScreen(1+e*3,2);s.setPosition(n.x,n.y),this.agvCarriers.push({container:s,targetX:n.x,targetY:n.y,speed:1.1+e*.2})}}spawnOHTShuttles(){if(!this.saveGame.unlockedFeatures.oht)return;const e=!!this.saveGame.unlockedFeatures.shrOht,s=this.add.container(0,-160);if(s.setDepth(500),this.textures.exists("oht_shuttle")){const n=this.add.image(0,16,"oht_shuttle");n.setDisplaySize(56,42),e&&n.setTint(3462041),s.add(n)}else{const n=this.add.rectangle(0,0,8,12,4674921),r=this.add.rectangle(0,10,32,18,e?1096065:959977),i=this.add.rectangle(0,22,20,16,1096065),o=this.add.circle(12,10,3,e?1096065:2278750);s.add([n,r,i,o])}const a=this.toScreen(1,1);s.setPosition(a.x,a.y-160),this.ohtShuttles.push({container:s,progress:0,speed:e?.005:.002})}update(e,s){const a=this.saveGame.facility.bayGridSize,n=[this.toScreen(1,1),this.toScreen(a.width-2,1),this.toScreen(a.width-2,a.height-2),this.toScreen(1,a.height-2)];for(const r of this.ohtShuttles){r.progress=(r.progress+r.speed*(s/16))%1;const i=n.length,o=Math.floor(r.progress*i),l=(o+1)%i,d=r.progress*i%1,c=n[o],p=n[l],h=c.x+(p.x-c.x)*d,u=c.y+(p.y-c.y)*d-160;r.container.setPosition(h,u)}for(const r of this.technicians){const i=r.targetX-r.container.x,o=r.targetY-r.container.y,l=Math.sqrt(i*i+o*o);if(l<4){const d=Math.floor(Math.random()*(a.width-2))+1,c=Math.floor(Math.random()*(a.height-2))+1,p=this.toScreen(d,c);r.targetX=p.x,r.targetY=p.y}else r.container.x+=i/l*r.speed*(s/16),r.container.y+=o/l*r.speed*(s/16)}for(const r of this.agvCarriers){const i=r.targetX-r.container.x,o=r.targetY-r.container.y,l=Math.sqrt(i*i+o*o);if(l<4){const d=Math.floor(Math.random()*(a.width-2))+1,c=Math.floor(Math.random()*(a.height-2))+1,p=this.toScreen(d,c);r.targetX=p.x,r.targetY=p.y}else r.container.x+=i/l*r.speed*(s/16),r.container.y+=o/l*r.speed*(s/16)}}setPlannerMode(e,s="NONE"){this.isPlannerMode=e,this.plannerTool=s,this.movingMachineId=null,this.plannerIndicatorGraphics.clear(),this.selectionRingGraphics.clear()}selectMachineToMove(e){if(this.movingMachineId===e.id){this.movingMachineId=null,this.selectionRingGraphics.clear(),this.plannerIndicatorGraphics.clear(),f.playClick();return}this.movingMachineId=e.id,f.playClick(),this.drawSelectionRing(e.gridX,e.gridY)}drawSelectionRing(e,s){this.selectionRingGraphics.clear();const{x:a,y:n}=this.toScreen(e,s);this.selectionRingGraphics.lineStyle(3.5,440020,.95);const r={x:a,y:n-this.tileHeight/2-2},i={x:a+this.tileWidth/2+4,y:n},o={x:a,y:n+this.tileHeight/2+2},l={x:a-this.tileWidth/2-4,y:n};this.selectionRingGraphics.beginPath(),this.selectionRingGraphics.moveTo(r.x,r.y),this.selectionRingGraphics.lineTo(i.x,i.y),this.selectionRingGraphics.lineTo(o.x,o.y),this.selectionRingGraphics.lineTo(l.x,l.y),this.selectionRingGraphics.closePath(),this.selectionRingGraphics.strokePath()}updatePlannerCursorIndicator(e,s){if(!this.isPlannerMode||!this.plannerIndicatorGraphics)return;this.plannerIndicatorGraphics.clear();const{gridX:a,gridY:n}=this.toGrid(e,s),r=this.saveGame.facility.bayGridSize;if(a<0||a>=r.width||n<0||n>=r.height)return;const{x:i,y:o}=this.toScreen(a,n),l={x:i,y:o-this.tileHeight/2},d={x:i+this.tileWidth/2,y:o},c={x:i,y:o+this.tileHeight/2},p={x:i-this.tileWidth/2,y:o};this.plannerTool==="PAINT_YELLOW"?(this.plannerIndicatorGraphics.fillStyle(16096779,.45),this.plannerIndicatorGraphics.lineStyle(2.5,16498468,.95)):this.plannerTool==="PAINT_WHITE"?(this.plannerIndicatorGraphics.fillStyle(165063,.45),this.plannerIndicatorGraphics.lineStyle(2.5,3718648,.95)):this.plannerTool==="MOVE_MACHINE"&&(this.saveGame.machines.some(u=>u.id!==this.movingMachineId&&u.gridX===a&&u.gridY===n)?(this.plannerIndicatorGraphics.fillStyle(15680580,.45),this.plannerIndicatorGraphics.lineStyle(2.5,16281969,.95)):(this.plannerIndicatorGraphics.fillStyle(1096065,.45),this.plannerIndicatorGraphics.lineStyle(2.5,3462041,.95))),this.plannerIndicatorGraphics.beginPath(),this.plannerIndicatorGraphics.moveTo(l.x,l.y),this.plannerIndicatorGraphics.lineTo(d.x,d.y),this.plannerIndicatorGraphics.lineTo(c.x,c.y),this.plannerIndicatorGraphics.lineTo(p.x,p.y),this.plannerIndicatorGraphics.closePath(),this.plannerIndicatorGraphics.fillPath(),this.plannerIndicatorGraphics.strokePath()}handlePlannerTileClick(e,s){var n,r,i;const a=this.saveGame.facility.bayGridSize;if(!(e<0||e>=a.width||s<0||s>=a.height)){if(this.plannerTool==="PAINT_YELLOW")this.saveGame.facility.yellowRoomTiles||(this.saveGame.facility.yellowRoomTiles=[]),this.saveGame.facility.yellowRoomTiles.some(l=>l.x===e&&l.y===s)||(this.saveGame.facility.yellowRoomTiles.push({x:e,y:s}),f.playClick(),this.renderFloor(),this.renderMachines(),(n=this.onStateUpdateCallback)==null||n.call(this));else if(this.plannerTool==="PAINT_WHITE"){if(this.saveGame.facility.yellowRoomTiles){const o=this.saveGame.facility.yellowRoomTiles.findIndex(l=>l.x===e&&l.y===s);o>=0&&(this.saveGame.facility.yellowRoomTiles.splice(o,1),f.playClick(),this.renderFloor(),this.renderMachines(),(r=this.onStateUpdateCallback)==null||r.call(this))}}else if(this.plannerTool==="MOVE_MACHINE"&&this.movingMachineId){const o=this.saveGame.machines.find(d=>d.id===this.movingMachineId);if(!o||o.gridX===e&&o.gridY===s)return;if(this.saveGame.machines.some(d=>d.id!==this.movingMachineId&&d.gridX===e&&d.gridY===s)){f.playAlarm();return}o.gridX=e,o.gridY=s,f.playDing(),this.movingMachineId=null,this.selectionRingGraphics.clear(),this.plannerIndicatorGraphics.clear(),this.renderMachines(),this.renderOHTRails(),(i=this.onStateUpdateCallback)==null||i.call(this)}}}setupCameraControls(){this.input.on("pointerdown",e=>{var s;document.querySelector(".modal-backdrop")||(((s=document.getElementById("modal-container"))==null?void 0:s.children.length)??0)>0||e.leftButtonDown()&&(this.isDragging=!0,this.dragStartX=e.x,this.dragStartY=e.y,this.totalDragDistance=0)}),this.input.on("pointermove",e=>{if(this.isPlannerMode){const s=this.cameras.main.getWorldPoint(e.x,e.y);this.updatePlannerCursorIndicator(s.x,s.y)}if(this.isDragging){if(!e.isDown||!e.leftButtonDown()){this.isDragging=!1;return}const s=e.x-this.dragStartX,a=e.y-this.dragStartY;this.totalDragDistance+=Math.hypot(s,a),this.totalDragDistance>this.dragThreshold&&(this.cameras.main.scrollX-=s*.85/this.cameras.main.zoom,this.cameras.main.scrollY-=a*.85/this.cameras.main.zoom),this.dragStartX=e.x,this.dragStartY=e.y}}),this.input.on("pointerup",e=>{var a;const s=this.totalDragDistance>this.dragThreshold;if(this.isDragging=!1,this.pointerDownMachineId=null,this.justSelectedMachineOnPointerUp){this.justSelectedMachineOnPointerUp=!1;return}if(!(document.querySelector(".modal-backdrop")||(((a=document.getElementById("modal-container"))==null?void 0:a.children.length)??0)>0)&&!s&&this.isPlannerMode){const n=this.cameras.main.getWorldPoint(e.x,e.y),{gridX:r,gridY:i}=this.toGrid(n.x,n.y);this.handlePlannerTileClick(r,i)}}),window.addEventListener("mouseup",()=>{this.isDragging=!1,this.pointerDownMachineId=null}),window.addEventListener("blur",()=>{this.isDragging=!1,this.pointerDownMachineId=null}),this.input.on("wheel",(e,s,a,n)=>{var i;if(document.querySelector(".modal-backdrop")||(((i=document.getElementById("modal-container"))==null?void 0:i.children.length)??0)>0)return;const r=Phaser.Math.Clamp(this.cameras.main.zoom-n*.001,.45,2.2);this.cameras.main.setZoom(r)})}onResize(e){this.cameras.main.setSize(e.width,e.height)}updateState(e){const s=!this.saveGame||e.userId&&this.saveGame.userId!==e.userId;if(this.saveGame=e,s){for(const[a,n]of this.machineMap)n.container.destroy();this.machineMap.clear();for(const a of this.technicians)a.container.destroy();this.technicians=[];for(const a of this.agvCarriers)a.container.destroy();this.agvCarriers=[];for(const a of this.ohtShuttles)a.container.destroy();this.ohtShuttles=[],this.movingMachineId=null,this.selectionRingGraphics.clear(),this.plannerIndicatorGraphics.clear(),this.renderFloor(),this.renderOHTRails(),this.renderMachines(),this.spawnTechnicians(),this.saveGame.unlockedFeatures.agv&&this.spawnAGVCarriers(),this.saveGame.unlockedFeatures.oht&&this.spawnOHTShuttles()}else if(this.renderFloor(),this.renderMachines(),this.saveGame.unlockedFeatures.agv&&this.agvCarriers.length===0&&this.spawnAGVCarriers(),this.saveGame.unlockedFeatures.oht){if(this.ohtShuttles.length===0)this.spawnOHTShuttles();else if(this.saveGame.unlockedFeatures.shrOht)for(const a of this.ohtShuttles){a.speed=.005;const n=a.container.getAt(0);n&&n.setTint&&n.setTint(3462041)}}}};g(ae,"KEY","CleanroomScene");let ee=ae;class _{static getInitialAchievements(){return JSON.parse(JSON.stringify(this.INITIAL_ACHIEVEMENTS))}static checkAchievements(t){const e=[],s=new Map;for(const l of t.achievements)s.set(l.id,l);const a=l=>{const d=s.get(l);d&&!d.unlocked&&(d.unlocked=!0,e.push(d))};t.rollingYieldHistory.length>=1&&a("first_silicon"),(t.activeLots.some(l=>l.currentStation==="LIT"||l.currentStation==="ETCH"||l.currentStation==="DIFF")||t.rollingYieldHistory.length>=1)&&a("step_into_yellow");const r=t.activeOrders.filter(l=>l.status==="FULFILLED");r.length>=1&&a("first_cash"),t.unlockedFeatures.mesAutoDispatch&&a("mes_mastery"),r.some(l=>l.nodeNm<=350)&&a("submicron_explorer"),t.unlockedFeatures.cmp&&t.machines.some(l=>l.category==="CMP")&&a("copper_cmp_era"),t.machines.some(l=>l.modelId==="litho_arfi")&&a("immersion_wave"),t.machines.some(l=>l.modelId==="litho_euv"||l.modelId==="litho_highna")&&a("euv_domination");const i=new Map(t.staff.map(l=>[l.id,l]));let o=0;for(const l of t.machines){const d=l.assignedEngineerId?i.get(l.assignedEngineerId):null;B.checkTPMConditions(l,d).isTPMActive&&o++}if(o>=3&&a("tpm_zero_defect"),t.machines.some(l=>{var d;return l.category==="LITHO"&&(((d=l.pairedTrackIds)==null?void 0:d.length)??0)>=2})&&a("inline_cluster_master"),t.facility.cleanroomPhase>=4&&a("gigafab_expansion"),t.unlockedFeatures.agv&&t.unlockedFeatures.oht&&a("automation_highway"),t.rollingYieldHistory.some(l=>l>=.99)&&a("flawless_wafer"),t.rollingYieldHistory.length>=5){const l=t.rollingYieldHistory.slice(-5);l.reduce((c,p)=>c+p,0)/l.length>=.95&&a("five_star_foundry")}return t.player.cash>=1e8&&a("trillion_chip_dynasty"),{newlyUnlocked:e}}static triggerManualUnlock(t,e){const s=t.find(a=>a.id===e);return s&&!s.unlocked?(s.unlocked=!0,!0):!1}static claimReward(t,e){const s=t.find(a=>a.id===e);return s?s.unlocked?s.claimed?{success:!1,cash:0,message:"該成就獎勵已領取"}:(s.claimed=!0,{success:!0,cash:s.rewardCash,message:`🏆 成功領取成就【${s.title}】獎勵！獲得獎勵金 NT$ ${s.rewardCash.toLocaleString()}！`}):{success:!1,cash:0,message:"尚未達成該成就解鎖條件"}:{success:!1,cash:0,message:"找不到該成就"}}}g(_,"INITIAL_ACHIEVEMENTS",[{id:"first_silicon",category:"onboarding",title:"矽島啟航 (First Silicon)",description:"成功在廠房內完成並產出第一批晶圓。",rewardCash:5e4,unlocked:!1,claimed:!1},{id:"step_into_yellow",category:"onboarding",title:"邁入黃光密室 (Yellow Room Entry)",description:"首次完成微影站塗膠、曝光與顯影連線作業。",rewardCash:8e4,unlocked:!1,claimed:!1},{id:"first_cash",category:"onboarding",title:"首桶金進帳 (First Cash Delivery)",description:"成功履約第一張客戶製造合約並取得全額尾款。",rewardCash:1e5,unlocked:!1,claimed:!1},{id:"mes_mastery",category:"onboarding",title:"智慧製造大師 (MES Mastery)",description:"完成新手教學，解鎖並啟用 MES 智慧自動派工系統。",rewardCash:15e4,unlocked:!1,claimed:!1},{id:"submicron_explorer",category:"process",title:"突破次微米壁壘 (Sub-micron Explorer)",description:"成功承接並交付線寬 <= 350nm 之高階次微米訂單。",rewardCash:5e5,unlocked:!1,claimed:!1},{id:"copper_cmp_era",category:"process",title:"銅導線與平坦化時代 (CMP Era)",description:"解鎖並在廠房內運作 CMP 化學機械平坦化拋光設備。",rewardCash:1e6,unlocked:!1,claimed:!1},{id:"immersion_wave",category:"process",title:"水中折射奇蹟 (Immersion Wave)",description:"購買並安裝 Tier 5 ArFi 浸潤微影雙工件台設備 (TWINSCAN)。",rewardCash:5e6,unlocked:!1,claimed:!1},{id:"euv_domination",category:"process",title:"極紫外神之光 (EUV Domination)",description:"購買並啟用極紫外光微影巨獸 (EUV Scanner)。",rewardCash:2e7,unlocked:!1,claimed:!1},{id:"tpm_zero_defect",category:"operation",title:"零非計畫停機殿堂 (TPM Zero-Defect)",description:"同時維持 3 台以上機台處於 🛡️ TPM 24H 零故障在線維護保障狀態。",rewardCash:2e6,unlocked:!1,claimed:!1},{id:"inline_cluster_master",category:"operation",title:"雙軌並聯突破極限 (Inline Cluster Master)",description:"為微影機台並聯配套綁定 2 台以上 Track 塗膠顯影設備，消除產能瓶頸。",rewardCash:15e5,unlocked:!1,claimed:!1},{id:"gigafab_expansion",category:"operation",title:"GigaFab 超級晶圓廠 (GigaFab Expansion)",description:"將潔淨室無塵廠房拓建至 Phase 4 (24x24 巨型潔淨室)。",rewardCash:1e7,unlocked:!1,claimed:!1},{id:"automation_highway",category:"operation",title:"自動化天軌物流 (Automation Highway)",description:"同時解鎖地面 AGV 自走車與天花板 OHT 懸吊天軌系統。",rewardCash:3e6,unlocked:!1,claimed:!1},{id:"flawless_wafer",category:"yield",title:"神級黃金良率 (Flawless Wafer 99%+)",description:"成功生產交付一批最終良率達 99% 以上的頂級晶圓。",rewardCash:1e6,unlocked:!1,claimed:!1},{id:"rework_savior",category:"yield",title:"點石成金光阻重洗 (Rework Savior)",description:"成功對 Q-Time 逾期晶圓執行光阻重洗 (Rework)，拯救昂貴晶片免於報廢。",rewardCash:5e5,unlocked:!1,claimed:!1},{id:"five_star_foundry",category:"yield",title:"五星品質金字招牌 (Five-Star Foundry)",description:"累積至少 5 批出貨紀錄，且 RollingYieldIndex 滾動良率指數突破 95%！",rewardCash:8e6,unlocked:!1,claimed:!1},{id:"trillion_chip_dynasty",category:"yield",title:"稱霸全球矽島霸權 (Silicon Hegemony)",description:"總現金累積突破 NT$ 100,000,000，建立無可撼動的半導體傳奇帝國。",rewardCash:5e7,unlocked:!1,claimed:!1}]);class A{static getTodayDateString(t=new Date){const e=t.getFullYear(),s=String(t.getMonth()+1).padStart(2,"0"),a=String(t.getDate()).padStart(2,"0");return`${e}-${s}-${a}`}static getWeekString(t=new Date){const e=new Date(t.valueOf()),s=(t.getDay()+6)%7;e.setDate(e.getDate()-s+3);const a=e.valueOf();e.setMonth(0,1),e.getDay()!==4&&e.setMonth(0,1+(4-e.getDay()+7)%7);const n=1+Math.ceil((a-e.valueOf())/6048e5);return`${e.getFullYear()}-W${String(n).padStart(2,"0")}`}static getMonthString(t=new Date){const e=t.getFullYear(),s=String(t.getMonth()+1).padStart(2,"0");return`${e}-${s}`}static createEmptyRecord(t,e,s,a=5e7,n=7e7){return{periodType:t,periodIndex:e,label:s,timestamp:Date.now(),revenue:{waferSales:0,nreFees:0,subsidies:0,totalRevenue:0},expenses:{depreciation:0,maintenance:0,utilities:0,payroll:0,scraps:0,capex:0,totalExpenses:0},grossProfit:0,grossMarginPct:0,netProfit:0,netMarginPct:0,endingCash:a,endingNetWorth:n}}static initFinancialState(t=5e7,e=7e7){const s=this.getTodayDateString();return{daySeconds:0,currentDay:1,currentWeek:1,currentMonth:1,currentDateStr:s,today:this.createEmptyRecord("DAY",1,`📅 ${s} (今日)`,t,e),thisWeek:this.createEmptyRecord("WEEK",1,`📅 本周 (${this.getWeekString()})`,t,e),thisMonth:this.createEmptyRecord("MONTH",1,`📅 本月 (${this.getMonthString()})`,t,e),dailyHistory:[],weeklyHistory:[],monthlyHistory:[],allTimeRevenue:0,allTimeExpenses:0,allTimeProfit:0}}static calculateCompanyNetWorth(t){const e=t.player.cash,s=t.machines.reduce((r,i)=>{const o=i.tier*15e6,l=Math.max(.2,(100-i.wear)/100);return r+Math.round(o*l)},0),a=t.facility.cleanroomPhase*25e6,n=t.clawbackDebt||0;return Math.max(0,e+s+a-n)}static recordWaferSales(t,e){const s=this.ensureFinancialState(t);s.today.revenue.waferSales+=e,s.thisWeek.revenue.waferSales+=e,s.thisMonth.revenue.waferSales+=e,s.allTimeRevenue+=e,this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t)}static recordNREFee(t,e){const s=this.ensureFinancialState(t);s.today.revenue.nreFees+=e,s.thisWeek.revenue.nreFees+=e,s.thisMonth.revenue.nreFees+=e,s.allTimeRevenue+=e,this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t)}static recordSubsidy(t,e){const s=this.ensureFinancialState(t);s.today.revenue.subsidies+=e,s.thisWeek.revenue.subsidies+=e,s.thisMonth.revenue.subsidies+=e,s.allTimeRevenue+=e,this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t)}static recordMaintenance(t,e){const s=this.ensureFinancialState(t);s.today.expenses.maintenance+=e,s.thisWeek.expenses.maintenance+=e,s.thisMonth.expenses.maintenance+=e,s.allTimeExpenses+=e,this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t)}static recordCapEx(t,e){const s=this.ensureFinancialState(t);s.today.expenses.capex+=e,s.thisWeek.expenses.capex+=e,s.thisMonth.expenses.capex+=e,s.allTimeExpenses+=e,this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t)}static recordSigningBonus(t,e){const s=this.ensureFinancialState(t);s.today.expenses.payroll+=e,s.thisWeek.expenses.payroll+=e,s.thisMonth.expenses.payroll+=e,s.allTimeExpenses+=e,this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t)}static recordScrapLoss(t,e){const s=this.ensureFinancialState(t);s.today.expenses.scraps+=e,s.thisWeek.expenses.scraps+=e,s.thisMonth.expenses.scraps+=e,s.allTimeExpenses+=e,this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t)}static tickSimulation(t,e=1){const s=this.ensureFinancialState(t),a=t.machines.reduce((p,h)=>p+h.tier*1200,0)*e;s.today.expenses.depreciation+=Math.round(a),s.thisWeek.expenses.depreciation+=Math.round(a),s.thisMonth.expenses.depreciation+=Math.round(a);const n=t.machines.filter(p=>p.status==="PROCESSING").length,i=(t.facility.cleanroomPhase*800+n*600)*e;s.today.expenses.utilities+=Math.round(i),s.thisWeek.expenses.utilities+=Math.round(i),s.thisMonth.expenses.utilities+=Math.round(i);const d=t.staff.reduce((p,h)=>p+h.salary,0)/300*e;s.today.expenses.payroll+=Math.round(d),s.thisWeek.expenses.payroll+=Math.round(d),s.thisMonth.expenses.payroll+=Math.round(d),this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t);const c=this.getTodayDateString();if(s.currentDateStr||(s.currentDateStr=c),s.currentDateStr!==c){const p=s.currentDateStr;s.currentDateStr=c,this.closeDay(t,p,c)}}static closeDay(t,e,s){const a=this.ensureFinancialState(t);this.updateRecordTotals(a.today,t),e&&(a.today.label=`📅 ${e} (結算)`),a.dailyHistory.unshift(JSON.parse(JSON.stringify(a.today))),a.dailyHistory.length>14&&a.dailyHistory.pop(),a.daySeconds=0,a.currentDay+=1;const n=s||this.getTodayDateString();a.currentDateStr=n,a.today=this.createEmptyRecord("DAY",a.currentDay,`📅 ${n} (今日)`,t.player.cash,this.calculateCompanyNetWorth(t));const r=e?new Date(e):new Date(Date.now()-864e5),i=new Date(n);this.getWeekString(r)!==this.getWeekString(i)&&this.closeWeek(t),this.getMonthString(r)!==this.getMonthString(i)&&this.closeMonth(t)}static closeWeek(t){const e=this.ensureFinancialState(t);this.updateRecordTotals(e.thisWeek,t),e.weeklyHistory.unshift(JSON.parse(JSON.stringify(e.thisWeek))),e.weeklyHistory.length>8&&e.weeklyHistory.pop(),e.currentWeek+=1;const s=e.currentWeek;e.thisWeek=this.createEmptyRecord("WEEK",s,`📅 本周 (${this.getWeekString()})`,t.player.cash,this.calculateCompanyNetWorth(t))}static closeMonth(t){const e=this.ensureFinancialState(t);this.updateRecordTotals(e.thisMonth,t),e.monthlyHistory.unshift(JSON.parse(JSON.stringify(e.thisMonth))),e.monthlyHistory.length>6&&e.monthlyHistory.pop(),e.currentMonth+=1;const s=e.currentMonth;e.thisMonth=this.createEmptyRecord("MONTH",s,`📅 本月 (${this.getMonthString()})`,t.player.cash,this.calculateCompanyNetWorth(t))}static updateRecordTotals(t,e){t.revenue.totalRevenue=t.revenue.waferSales+t.revenue.nreFees+t.revenue.subsidies,t.expenses.totalExpenses=t.expenses.depreciation+t.expenses.maintenance+t.expenses.utilities+t.expenses.payroll+t.expenses.scraps+t.expenses.capex;const s=t.expenses.depreciation+t.expenses.maintenance+t.expenses.utilities+t.expenses.scraps;t.grossProfit=t.revenue.totalRevenue-s,t.grossMarginPct=t.revenue.totalRevenue>0?Number((t.grossProfit/t.revenue.totalRevenue*100).toFixed(1)):0;const a=s+t.expenses.payroll;t.netProfit=t.revenue.totalRevenue-a,t.netMarginPct=t.revenue.totalRevenue>0?Number((t.netProfit/t.revenue.totalRevenue*100).toFixed(1)):0,t.endingCash=e.player.cash,t.endingNetWorth=this.calculateCompanyNetWorth(e)}static ensureFinancialState(t){return(!t.financialState||!t.financialState.today)&&(t.financialState=this.initFinancialState(t.player.cash,this.calculateCompanyNetWorth(t))),t.financialState.currentDateStr||(t.financialState.currentDateStr=this.getTodayDateString()),t.financialState}static generateCFOAdvisory(t,e){const s=t.revenue.totalRevenue,a=t.grossMarginPct,n=e.player.cash;return s===0?{rating:"WARNING",title:"💤 產線待命中 — 週期營收缺口警示",advice:"本週期尚未認列任何晶圓出貨尾款或 NRE 光罩開發款，但固定水電與工程師薪資持續流出。請立即前往【合約公告板】承接高毛利訂單！",metrics:"毛利率: 0.0% | 產能營收: NT$ 0"}:n<1e7?{rating:"CRITICAL",title:"🚨 流動資金偏低 — 嚴控資本開支",advice:"現金儲備低於安全水位！建議暫緩購買高價新機台，優先全力推進在製晶圓批次出貨，或檢查機台磨損避免意外炸機造成大修支出！",metrics:`流動現金: NT$ ${Math.round(n).toLocaleString()}（建議最低安全門檻: NT$ 20,000,000）`}:a>=53?{rating:"EXCELLENT",title:"🌟 傳奇毛利率 — 達到台積電 53% 卓越標竿！",advice:"恭喜！本週期毛利率高達 "+a+"%，超越全球半導體龍頭 53.0% 標竿！製程良率優異且 NRE 溢價充沛。建議積極將獲利轉入 CapEx 擴大產能，搶佔次世代製程領導地位！",metrics:`當期毛利率: ${a}%（超越全球龍頭標竿 53.0% 達成！）`}:a>=35?{rating:"GOOD",title:"⚖️ 獲利穩健 — 符合晶圓代工常態",advice:"收支結構健康，毛利率維持在良好的 35% ~ 50% 區間。建議透過 🛡️ TPM 在線保養維持零故障，並優化員工排班減少夜班過勞，進一步釋放產能。",metrics:`當期毛利率: ${a}%（符合產業健康標準 35% ~ 45%）`}:{rating:"WARNING",title:"⚠️ 毛利受壓 — 成本與耗損偏高",advice:"本週期毛利率偏低，主要受限於機台維修頻繁、折舊沉重或報廢損失。建議檢查機台配對狀態與工程師職級，減少晶圓報廢，拉升合格晶粒產出比率。",metrics:`當期毛利率: ${a}%（低於產業安全水準 35.0%）`}}}g(A,"DAY_SECONDS",86400),g(A,"DAYS_PER_WEEK",7),g(A,"DAYS_PER_MONTH",30);class N{static createDefaultSave(t="矽島先進半導體",e="張創辦人",s="avatar_1"){const a=Date.now();return{schemaVersion:2,savedAt:a,lastOnlineTimestamp:a,player:{companyName:t,ceoName:e,avatarId:s,cash:5e7,foundryTier:1,popularity:100,unlockedK1:"BASE",unlockedCleanroomClass:"Class 10000",totalOrdersFulfilled:0,totalWafersDelivered:0,rdInvestedCash:0,tutorialCompleted:!1},unlockedFeatures:{cmp:!1,agv:!1,oht:!1,shrOht:!1,mesAutoDispatch:!1,mixAndMatchLitho:!1},facility:{cleanroomPhase:1,bayGridSize:{width:10,height:10},yellowRoomTiles:[{x:3,y:1},{x:4,y:1},{x:5,y:1},{x:6,y:1},{x:7,y:1},{x:3,y:2},{x:4,y:2},{x:5,y:2},{x:6,y:2},{x:7,y:2},{x:3,y:3},{x:4,y:3},{x:5,y:3},{x:6,y:3},{x:7,y:3}]},machines:[{id:"mach_film_1",modelId:"film_furnace",name:"熱氧化爐 (Thermal Oxidation)",category:"FILM",tier:1,gridX:1,gridY:2,wear:0,status:"IDLE",assignedEngineerId:null},{id:"mach_track_1",modelId:"track_clean",name:"手動旋塗熱板台 (Manual Track)",category:"TRACK",tier:1,gridX:4,gridY:2,wear:0,status:"IDLE",assignedEngineerId:null},{id:"mach_litho_1",modelId:"litho_contact",name:"接觸式微影機 (Contact Aligner)",category:"LITHO",tier:1,gridX:6,gridY:2,wear:0,status:"IDLE",assignedEngineerId:"staff_1",pairedTrackIds:["mach_track_1"]},{id:"mach_etch_1",modelId:"etch_plasma",name:"電漿乾式蝕刻機 (Dry Plasma Etcher)",category:"ETCH",tier:1,gridX:6,gridY:6,wear:0,status:"IDLE",assignedEngineerId:null},{id:"mach_diff_1",modelId:"diff_furnace",name:"擴散退火爐 (Diffusion Furnace)",category:"DIFF",tier:1,gridX:2,gridY:6,wear:0,status:"IDLE",assignedEngineerId:null}],staff:[{id:"staff_1",name:"Alex Miller",rank:"Skilled Worker",moduleSpecialty:"LITHO",fatigue:10,shiftMode:"THREE_SHIFT",workShift:"DAY",assignedMachineId:"mach_litho_1",salary:6e4}],activeOrders:[],activeLots:[],rollingYieldHistory:[],clawbackDebt:0,questState:{lastDateStr:new Date().toISOString().split("T")[0],dailyQuests:[],allDailyClaimed:!1,weeklyCompletedCount:0,weeklyTarget:15,weeklyClaimed:!1},achievements:_.getInitialAchievements(),gameTime:0,financialState:A.initFinancialState(5e7,7e7)}}static getUserProfiles(){try{const t=localStorage.getItem(this.REGISTRY_KEY);if(t){const e=JSON.parse(t);if(Array.isArray(e)&&e.length>0)return e}}catch(t){console.warn("讀取使用者目錄失敗:",t)}return this.initializeDefaultProfile()}static initializeDefaultProfile(){const t=localStorage.getItem(this.STORAGE_KEY_V2);let e="張創辦人",s="矽島先進半導體",a=1,n=5e7,r=Date.now();if(t)try{const l=JSON.parse(t);l.player&&(e=l.player.ceoName||e,s=l.player.companyName||s,a=l.player.foundryTier||a,n=l.player.cash||n,r=l.savedAt||r)}catch{}const i={id:"usr_default",name:e,companyName:s,foundryTier:a,cash:n,createdAt:r,lastPlayedAt:Date.now(),storageKey:this.STORAGE_KEY_V2},o=[i];try{localStorage.setItem(this.REGISTRY_KEY,JSON.stringify(o)),localStorage.setItem(this.ACTIVE_USER_ID_KEY,i.id)}catch{}return o}static getActiveUserProfile(){const t=this.getUserProfiles(),e=localStorage.getItem(this.ACTIVE_USER_ID_KEY),s=t.find(n=>n.id===e);if(s)return s;const a=t[0]||this.initializeDefaultProfile()[0];return localStorage.setItem(this.ACTIVE_USER_ID_KEY,a.id),a}static createUser(t,e){const s=t.trim()||`執行長 ${Math.floor(Math.random()*900+100)}`,a=(e==null?void 0:e.trim())||`${s}半導體`,n=`usr_${Date.now().toString(36)}_${Math.random().toString(36).substring(2,6)}`,r=`SILICON_TYCOON_SAVE_${n}`,i={id:n,name:s,companyName:a,foundryTier:1,cash:5e7,createdAt:Date.now(),lastPlayedAt:Date.now(),storageKey:r},o=this.createDefaultSave(a,s);o.userId=n,localStorage.setItem(r,JSON.stringify(o));const l=this.getUserProfiles();return l.push(i),localStorage.setItem(this.REGISTRY_KEY,JSON.stringify(l)),localStorage.setItem(this.ACTIVE_USER_ID_KEY,n),i}static renameUser(t,e){const s=e.trim();if(!s)return!1;const a=this.getUserProfiles(),n=a.find(i=>i.id===t);if(!n)return!1;n.name=s,localStorage.setItem(this.REGISTRY_KEY,JSON.stringify(a));const r=localStorage.getItem(n.storageKey);if(r)try{const i=JSON.parse(r);i.player&&(i.player.ceoName=s,localStorage.setItem(n.storageKey,JSON.stringify(i)))}catch{}return!0}static deleteUser(t){const e=this.getUserProfiles();if(e.length<=1)return{success:!1,message:"至少需要保留一個玩家存檔，無法全部刪除！"};const s=e.findIndex(r=>r.id===t);if(s===-1)return{success:!1,message:"找不到該玩家存檔！"};const a=e[s];return localStorage.removeItem(a.storageKey),e.splice(s,1),localStorage.setItem(this.REGISTRY_KEY,JSON.stringify(e)),localStorage.getItem(this.ACTIVE_USER_ID_KEY)===t&&localStorage.setItem(this.ACTIVE_USER_ID_KEY,e[0].id),{success:!0}}static switchActiveUser(t){return this.getUserProfiles().find(a=>a.id===t)?(localStorage.setItem(this.ACTIVE_USER_ID_KEY,t),this.loadFromLocalStorage()):null}static factoryResetAllData(){try{const t=[];for(let e=0;e<localStorage.length;e++){const s=localStorage.key(e);s&&s.toLowerCase().startsWith("silicon_tycoon")&&t.push(s)}for(const e of t)localStorage.removeItem(e)}catch(t){console.warn("清空存檔時發生例外:",t),localStorage.clear()}}static saveToLocalStorage(t){try{t.savedAt=Date.now(),t.lastOnlineTimestamp=Date.now();const e=this.getActiveUserProfile(),s=t.userId&&t.userId===e.id?e.storageKey:e.storageKey||this.STORAGE_KEY_V2,a=JSON.stringify(t);localStorage.setItem(s,a);const n=this.getUserProfiles(),r=n.find(i=>i.id===e.id);return r&&(r.cash=t.player.cash,r.foundryTier=t.player.foundryTier,r.companyName=t.player.companyName,r.name=t.player.ceoName,r.lastPlayedAt=Date.now(),localStorage.setItem(this.REGISTRY_KEY,JSON.stringify(n))),!0}catch(e){return console.error("LocalStorage 存檔失敗:",e),!1}}static loadFromLocalStorage(){try{const t=this.getActiveUserProfile();let e=localStorage.getItem(t.storageKey);if(!e&&t.id==="usr_default"&&(e=localStorage.getItem(this.STORAGE_KEY_V2)),e){const n=JSON.parse(e);if(n.schemaVersion===2)return n.staff&&(n.staff=this.normalizeStaffData(n.staff)),n.facility||(n.facility={cleanroomPhase:1,bayGridSize:{width:10,height:10}}),(!n.facility.yellowRoomTiles||n.facility.yellowRoomTiles.length===0)&&(n.facility.yellowRoomTiles=[{x:3,y:1},{x:4,y:1},{x:5,y:1},{x:6,y:1},{x:7,y:1},{x:3,y:2},{x:4,y:2},{x:5,y:2},{x:6,y:2},{x:7,y:2},{x:3,y:3},{x:4,y:3},{x:5,y:3},{x:6,y:3},{x:7,y:3}]),(!n.facility.bayGridSize||n.facility.bayGridSize.width<10)&&(n.facility.bayGridSize={width:10,height:10}),n.userId=t.id,n.financialState=A.ensureFinancialState(n),n.player&&(n.player.totalOrdersFulfilled===void 0&&(n.player.totalOrdersFulfilled=0),n.player.totalWafersDelivered===void 0&&(n.player.totalWafersDelivered=0),n.player.rdInvestedCash===void 0&&(n.player.rdInvestedCash=0)),n}const s=localStorage.getItem(this.STORAGE_KEY_V1);if(s){const n=JSON.parse(s);if(n.schemaVersion===1){console.warn("偵測到舊版 SaveGameV1 存檔，執行自動升級至 SaveGameV2...");const r=this.migrateSaveV1toV2(n);return r.userId=t.id,r.financialState=A.ensureFinancialState(r),this.saveToLocalStorage(r),r}}const a=this.createDefaultSave(t.companyName,t.name);return a.userId=t.id,this.saveToLocalStorage(a),a}catch(t){return console.error("LocalStorage 讀檔失敗:",t),null}}static normalizeStaffData(t){return t.map((e,s)=>{const a=/[\u4e00-\u9fa5]/.test(e.name);let n=e.name;if(a||!n){const r=this.ENGLISH_FIRST_NAMES[s%this.ENGLISH_FIRST_NAMES.length],i=this.ENGLISH_LAST_NAMES[s%this.ENGLISH_LAST_NAMES.length];n=`${r} ${i}`}return{...e,name:n,workShift:e.workShift||(s%3===0?"DAY":s%3===1?"SWING":"NIGHT")}})}static migrateSaveV1toV2(t){var n;const e=new Date().toISOString().split("T")[0],s=t.machines.map(r=>({...r,pairedTrackIds:r.category==="LITHO"?[]:void 0})),a=t.activeOrders.map(r=>({...r,urgencyMultiplier:r.urgencyMultiplier??1,layerAllocations:[]}));return{schemaVersion:2,savedAt:t.savedAt??Date.now(),lastOnlineTimestamp:t.lastOnlineTimestamp??Date.now(),player:{...t.player},unlockedFeatures:{cmp:t.unlockedFeatures.cmp??!1,agv:t.unlockedFeatures.agv??!1,oht:t.unlockedFeatures.oht??!1,mesAutoDispatch:t.unlockedFeatures.mesAutoDispatch??!1,mixAndMatchLitho:!1},facility:{cleanroomPhase:((n=t.facility)==null?void 0:n.cleanroomPhase)??1,bayGridSize:{width:10,height:10},yellowRoomTiles:[{x:3,y:1},{x:4,y:1},{x:5,y:1},{x:6,y:1},{x:7,y:1},{x:3,y:2},{x:4,y:2},{x:5,y:2},{x:6,y:2},{x:7,y:2},{x:3,y:3},{x:4,y:3},{x:5,y:3},{x:6,y:3},{x:7,y:3}]},machines:s,staff:this.normalizeStaffData(t.staff??[]),activeOrders:a,activeLots:t.activeLots??[],rollingYieldHistory:t.rollingYieldHistory??[],clawbackDebt:t.clawbackDebt??0,questState:{lastDateStr:e,dailyQuests:[],allDailyClaimed:!1,weeklyCompletedCount:0,weeklyTarget:15,weeklyClaimed:!1},achievements:_.getInitialAchievements(),gameTime:t.gameTime??0}}static exportSaveToJson(t){return JSON.stringify(t,null,2)}static importSaveFromJson(t){try{const e=JSON.parse(t);return e.schemaVersion===2?{success:!0,state:e}:e.schemaVersion===1?{success:!0,state:this.migrateSaveV1toV2(e)}:{success:!1,error:"不相容的存檔格式版本！"}}catch(e){return{success:!1,error:`JSON 解析失敗: ${e.message}`}}}static calculateOfflineProgress(t,e){const s=Math.max(0,Math.floor((e-t.lastOnlineTimestamp)/1e3)),a=Math.min(14400,s),n={offlineDurationSeconds:a,lotsProcessed:0,wafersDelivered:0,revenueEarned:0,salaryPaid:0,utilityPaid:0,maintenanceExpense:0,debtRepaid:0,breakdownCount:0,explosionCount:0,tpmProtectedCount:0,netProfit:0};if(a<60)return n;const r=Math.floor(a/300),i=new Map(t.staff.map(m=>[m.id,m]));let o=0;for(const m of t.machines){const b=m.assignedEngineerId?i.get(m.assignedEngineerId):null;if(B.checkTPMConditions(m,b).isTPMActive)o++,m.wear=Math.min(5,m.wear),m.status="IDLE";else{const y=r*.4;m.wear=Math.min(100,m.wear+y),m.wear>=60&&Math.random()<.3&&(n.breakdownCount++,B.checkExplosionRisk(m,b).hasRisk&&Math.random()<.25?(n.explosionCount++,n.maintenanceExpense+=2e5*m.tier,m.status="EXPLODED"):(n.maintenanceExpense+=5e4*m.tier,m.status="MAINTENANCE"))}}n.tpmProtectedCount=o;const l=a/3600,d=t.staff.reduce((m,b)=>m+b.salary,0)/720,c=t.machines.length*15e3/720;if(n.salaryPaid=Math.round(d*l),n.utilityPaid=Math.round(c*l),t.unlockedFeatures.mesAutoDispatch&&t.activeOrders.length>0){const m=t.activeOrders.find(b=>b.status==="ACTIVE");if(m&&n.explosionCount===0){const b=Math.min(Math.floor(a/180),10);if(b>0){n.lotsProcessed=b;const x=b*5;n.wafersDelivered=x;const y=Math.round(x*100*m.unitPrice);n.revenueEarned=y;for(let T=0;T<b;T++)t.rollingYieldHistory.push(.92)}}}const p=n.revenueEarned,h=n.salaryPaid+n.utilityPaid+n.maintenanceExpense,u=p-h;if(u>0&&t.clawbackDebt>0){const m=Math.min(t.clawbackDebt,Math.round(u*.25));n.debtRepaid=m,t.clawbackDebt-=m}return n.netProfit=p-h-n.debtRepaid,t.player.cash=Math.max(0,t.player.cash+n.netProfit),t.gameTime+=a,t.lastOnlineTimestamp=e,t.savedAt=e,n}}g(N,"STORAGE_KEY_V2","SILICON_TYCOON_SAVE_V2"),g(N,"STORAGE_KEY_V1","SILICON_TYCOON_SAVE_V1"),g(N,"REGISTRY_KEY","SILICON_TYCOON_USERS_REGISTRY"),g(N,"ACTIVE_USER_ID_KEY","SILICON_TYCOON_ACTIVE_USER_ID"),g(N,"ENGLISH_FIRST_NAMES",["Alex","David","Sarah","Kevin","Emily","Michael","Jessica","James","Daniel","Rachel","Robert","Brian","Olivia","William","Sophia","Thomas"]),g(N,"ENGLISH_LAST_NAMES",["Miller","Chen","Smith","Williams","Johnson","Taylor","Davis","Wilson","Anderson","White","Harris","Martin","Clark","Lewis","Walker","Hall"]);class U{static getNodeSpec(t){return this.PRICING_TABLE.slice().reverse().find(s=>t<=s.nodeNm)||this.PRICING_TABLE[0]}static calculateUpfrontNRE(t,e,s=1){const a=this.getNodeSpec(t);return Math.round(a.baseNRE*e*s)}static calculateTrustMultiplier(t){if(t===null||isNaN(t))return 1;const e=.7+t*.5;return Math.max(.75,Math.min(1.25,Number(e.toFixed(3))))}static calculateUnitPrice(t,e,s,a){const n=this.getNodeSpec(t),r=1+(e-1)*.08,i=n.basePrice*r*s*a;return Number(i.toFixed(2))}static settleOrderPayout(t,e,s,a,n=0,r=0){const i=Math.max(0,Math.round(e*t.unitPrice-n));let o=0,l=r;if(l>0&&i>0){const p=a.reduce((u,m)=>u+m.salary,0)*1.5,h=s.cash+i;if(h>p){const u=h-p,m=Math.min(u*.25,i*.25);o=Math.min(l,Math.round(m)),l-=o}}const d=i-o;return{grossPayout:i,netPayout:d,debtDeducted:o,remainingDebt:l}}static calculateOverdueClawback(t,e,s=!1){const a=e-t.deadlineGameTime;return a<=0?{clawbackRatio:0,clawbackAmount:0,isCancelled:!1}:s&&a<=86400?{clawbackRatio:.1,clawbackAmount:Math.round(t.nrePaid*.1),isCancelled:!1}:a<=28800?{clawbackRatio:.3,clawbackAmount:Math.round(t.nrePaid*.3),isCancelled:!1}:a<=86400?{clawbackRatio:.7,clawbackAmount:Math.round(t.nrePaid*.7),isCancelled:!1}:{clawbackRatio:1,clawbackAmount:t.nrePaid,isCancelled:!0}}static generateContractBoard(t,e,s){const a=[],n=["聯發通訊","蘋果核心","輝達智能","高通晶創","超微運算","台積晶心","瑞昱音訊","博通網通"],r=this.PRICING_TABLE.filter(o=>o.minTier<=t),i=this.calculateTrustMultiplier(e);for(let o=0;o<6;o++){const l=r[Math.floor(Math.random()*r.length)],d=n[(o+Math.floor(Math.random()*5))%n.length],c=l.minTier<=2?3:5,p=l.minTier<=2?5:l.minTier<=4?12:24,h=Math.floor(Math.random()*(p-c+1))+c,u=[3,5,10,25][Math.floor(Math.random()*4)],m=l.nodeNm>=1e3?500:2e3,b=u*m,x=[1,1,1,1.2,1.5],y=x[Math.floor(Math.random()*x.length)],T=this.calculateUpfrontNRE(l.nodeNm,h,y),k=this.calculateUnitPrice(l.nodeNm,h,y,i),v=Math.round(h*30*u*.8/y+180),C=s+v;a.push({id:`ORD-${Date.now().toString(36).toUpperCase()}-${o}`,clientName:d,nodeNm:l.nodeNm,layerCount:h,totalDies:b,goodDiesDelivered:0,nrePaid:T,unitPrice:k,urgencyMultiplier:y,deadlineGameTime:C,status:"ACTIVE"})}return a}}g(U,"PRICING_TABLE",[{nodeNm:1e4,basePrice:2,baseNRE:8e4,minTier:1},{nodeNm:3e3,basePrice:4,baseNRE:18e4,minTier:1},{nodeNm:1e3,basePrice:6,baseNRE:4e5,minTier:2},{nodeNm:350,basePrice:10,baseNRE:9e5,minTier:3},{nodeNm:180,basePrice:18,baseNRE:2e6,minTier:3},{nodeNm:90,basePrice:40,baseNRE:55e5,minTier:4},{nodeNm:45,basePrice:80,baseNRE:15e6,minTier:4},{nodeNm:28,basePrice:200,baseNRE:45e6,minTier:5},{nodeNm:7,basePrice:600,baseNRE:16e7,minTier:6},{nodeNm:2,basePrice:1500,baseNRE:45e7,minTier:6}]);class R{static getTierConfig(t){return this.TIER_CONFIGS[t]||this.TIER_CONFIGS[1]}static getProgressionStatus(t){const e=t.player.foundryTier||1,s=e>=this.MAX_TIER,a=e+1,n=s?null:this.getTierConfig(a),r=t.player.totalOrdersFulfilled||0,i=t.player.totalWafersDelivered||0,o=t.player.rdInvestedCash||0;if(s||!n)return{currentTier:e,maxTier:this.MAX_TIER,isMaxTier:!0,nextTierConfig:null,ordersCompleted:r,ordersTarget:r,ordersMet:!0,ordersPct:100,wafersDelivered:i,wafersTarget:i,wafersMet:!0,wafersPct:100,fundsInvested:o,fundsTarget:o,fundsMet:!0,fundsPct:100,canAdvance:!1,overallPct:100};const l=n.reqOrders,d=n.reqWafers,c=n.reqResearchFunds,p=r>=l,h=i>=d,u=o>=c,m=Math.min(100,Math.round(r/Math.max(1,l)*100)),b=Math.min(100,Math.round(i/Math.max(1,d)*100)),x=Math.min(100,Math.round(o/Math.max(1,c)*100)),y=Math.round((m+b+x)/3),T=p&&h&&u;return{currentTier:e,maxTier:this.MAX_TIER,isMaxTier:!1,nextTierConfig:n,ordersCompleted:r,ordersTarget:l,ordersMet:p,ordersPct:m,wafersDelivered:i,wafersTarget:d,wafersMet:h,wafersPct:b,fundsInvested:o,fundsTarget:c,fundsMet:u,fundsPct:x,canAdvance:T,overallPct:y}}static investRDCapital(t,e){const s=this.getProgressionStatus(t);if(s.isMaxTier||!s.nextTierConfig)return{success:!1,invested:0,message:"晶圓廠已達最高科技世代，無需再注資！"};const a=s.fundsTarget-s.fundsInvested;if(a<=0)return{success:!1,invested:0,message:"本世代研發資金已全數募足，請達成代工訂單與晶圓量產目標以晉升！"};const n=Math.max(0,Math.min(e,a,t.player.cash));return n<=0?{success:!1,invested:0,message:"廠房資金不足，無法撥款注資！"}:(t.player.cash-=n,t.player.rdInvestedCash=(t.player.rdInvestedCash||0)+n,A.recordCapEx(t,n),{success:!0,invested:n,message:`成功撥款注資 NT$ ${n.toLocaleString()} 注入次世代製程研發！`})}static advanceFoundryTier(t){const e=this.getProgressionStatus(t);if(e.isMaxTier||!e.nextTierConfig)return{success:!1,newTier:t.player.foundryTier,message:"已達最高科技世代！"};if(!e.canAdvance){const a=[];return e.ordersMet||a.push(`還需交付 ${e.ordersTarget-e.ordersCompleted} 筆訂單`),e.wafersMet||a.push(`還需生產 ${e.wafersTarget-e.wafersDelivered} 片晶圓`),e.fundsMet||a.push(`還需研發注資 NT$ ${(e.fundsTarget-e.fundsInvested).toLocaleString()}`),{success:!1,newTier:t.player.foundryTier,message:`尚未達成晉升條件：${a.join("、")}`}}const s=e.nextTierConfig.tier;if(t.player.foundryTier=s,t.player.rdInvestedCash=0,t.player.popularity=Math.min(100,t.player.popularity+5),e.nextTierConfig.unlockedCleanroomClass&&(t.player.unlockedCleanroomClass=e.nextTierConfig.unlockedCleanroomClass),e.nextTierConfig.unlockedFeatureKeys)for(const a of e.nextTierConfig.unlockedFeatureKeys)t.unlockedFeatures[a]=!0;return _.checkAchievements(t),{success:!0,newTier:s,message:`🎉 狂賀！製程微縮重大突破！晶圓廠成功晉升至【Tier ${s} ${e.nextTierConfig.name}】！已解鎖次世代機台採購與合約！`}}}g(R,"MAX_TIER",6),g(R,"TIER_CONFIGS",{1:{tier:1,name:"微米微影啟蒙時代",subtitle:"5µm ~ 3µm 微米成熟製程",eraCode:"ERA_1_MICRON",minCDNm:3e3,unlockedCleanroomClass:"Class 10,000",description:"半導體萌芽初創期，以接觸式與等倍投影曝光為核心，邁出晶圓製造的第一步。",scienceHistory:"使用汞燈紫外光混光與手工旋塗光阻，光罩物理貼合或反射鏡投影，極限線寬約 3 微米。",reqOrders:0,reqWafers:0,reqResearchFunds:0,unlockedModelIds:["litho_contact","litho_projection","track_manual","film_evap","film_sputter","etch_wet_barrel","diff_box","diff_tube_manual"]},2:{tier:2,name:"亞微米步進縮小時代",subtitle:"1.2µm ~ 800nm (G-Line 436nm)",eraCode:"ERA_2_SUBMICRON",minCDNm:800,unlockedCleanroomClass:"Class 1,000",description:"引入 4:1 縮小透鏡與步進曝光技術，晶圓製造邁入百萬顆電晶體之 1 微米世代。",scienceHistory:"採用高壓汞燈 g-line (436nm) 搭配光學鏡頭群，突破接觸式光罩刮傷瓶頸，全面提升良率。",reqOrders:3,reqWafers:100,reqResearchFunds:15e6,unlockedModelIds:["litho_gline","track_single","film_pecvd","etch_rie","diff_auto_horiz"]},3:{tier:3,name:"次微米紫外深耕時代",subtitle:"500nm ~ 350nm (I-Line & CMP)",eraCode:"ERA_3_DEEPUV_STEP",minCDNm:350,unlockedCleanroomClass:"Class 100",description:"推進至 i-line 紫外光，雙軌 Track 連線作業，並解鎖化學機械研磨 (CMP) 平坦化神技。",scienceHistory:"採用 365nm i-line 高強度紫外光搭配 NA=0.50 鏡頭，CMP 平坦化技術解決多層金屬互連景深問題。",reqOrders:8,reqWafers:350,reqResearchFunds:5e7,unlockedModelIds:["litho_iline","track_dual","film_hdp_cvd","etch_merie","diff_vertical","cmp_manual","cmp_standard"],unlockedFeatureKeys:["cmp"]},4:{tier:4,name:"深紫外 DUV 跨越時代",subtitle:"250nm ~ 90nm (KrF/ArF & MES 自動化)",eraCode:"ERA_4_DUV_EXCIMER",minCDNm:90,unlockedCleanroomClass:"Class 10",description:"準分子雷射掃描曝光與化學增幅型光阻 (CAR)，產線導入 MES 智慧派工無人化管理。",scienceHistory:"248nm KrF 與 193nm ArF 準分子雷射結合動態掃描 (Step-and-Scan)，大幅擴大曝光視場與精準度。",reqOrders:18,reqWafers:1e3,reqResearchFunds:18e7,unlockedModelIds:["litho_krf","litho_arfdry","track_clean","film_ald_thermal","etch_icp_advanced","diff_lpcvd_rapid","cmp_auto"],unlockedFeatureKeys:["mesAutoDispatch"]},5:{tier:5,name:"浸潤式微影顛峰時代",subtitle:"65nm ~ 7nm (ArFi 193nm 水折射)",eraCode:"ERA_5_IMMERSION_PEAK",minCDNm:7,unlockedCleanroomClass:"Class 1",description:"林本堅博士浸潤式水折射微影革命，搭配雙工件台磁浮掃描與多重曝光 (SAQP)，極限微縮至 7nm。",scienceHistory:"鏡頭與晶圓間注入超純水 (n=1.44)，將等效 NA 推升至 1.35，打破物理極限，領先全球晶圓代工市場。",reqOrders:35,reqWafers:3e3,reqResearchFunds:6e8,unlockedModelIds:["litho_arfi","film_ald_plasma","etch_ale_atomic","diff_rtp_laser","cmp_atomic"],unlockedFeatureKeys:["mixAndMatchLitho"]},6:{tier:6,name:"埃米 EUV 矽島霸權時代",subtitle:"5nm ~ 2nm 以下 (High-NA EUV 埃米時代)",eraCode:"ERA_6_HIGH_NA_EUV",minCDNm:2,unlockedCleanroomClass:"Class 1 (ISO 3)",description:"13.5nm 極紫外光與 0.55 NA 變形鏡頭次世代巨獸，單次曝光推進 2nm，傲視全球的半導體科技霸主！",scienceHistory:"以二氧化碳雷射高頻擊打錫滴激發電漿產生 13.5nm 極紫外光，全機超高真空運行，登頂世界半導體工業之巔。",reqOrders:60,reqWafers:8e3,reqResearchFunds:25e8,unlockedModelIds:["litho_euv","litho_highna","track_advanced"]}});class ye{constructor(t,e){g(this,"container");g(this,"callbacks");const s=document.getElementById(t);if(!s)throw new Error(`找不到 HUD 容器: #${t}`);this.container=s,this.callbacks=e}render(t){var k,E,v,C,O,F,w,P,H,Y,V,Q,oe,le,de,ce,pe,ue,he,me;const e=t.player,s=t.unlockedFeatures.cmp,a=t.activeLots.some(S=>S.status==="PROCESSING")||t.machines.some(S=>S.status==="PROCESSING"),n=t.rollingYieldHistory.length>0?t.rollingYieldHistory.slice(-5).reduce((S,M)=>S+M,0)/Math.min(5,t.rollingYieldHistory.length):null,r=U.calculateTrustMultiplier(n),i=R.getProgressionStatus(t),o=((k=t.financialState)==null?void 0:k.currentDateStr)||A.getTodayDateString(),l=["日","一","二","三","四","五","六"][new Date().getDay()],d=D.calculateFactoryWorkload(t.machines,t.staff,t.activeLots,t.unlockedFeatures,s);let c="#10b981";d.workloadPercent>85?c="#ef4444":d.workloadPercent>=70&&(c="#f59e0b");const p=f.isAudioMuted(),h=t.questState.dailyQuests.some(S=>S.completed&&!S.claimed),u=t.achievements.some(S=>S.unlocked&&!S.claimed),m=h||u;this.container.innerHTML=`
      ...
      <div class="flex items-center gap-4 flex-shrink-0 whitespace-nowrap">
        ...
        <button id="btn-hud-yield" class="text-center relative group cursor-pointer hover:bg-slate-800/80 px-2 py-1 rounded-lg transition-colors border border-transparent hover:border-cyan-500/30" title="點擊檢視 25 晶粒蒙地卡羅良率晶圓圖 (Wafer Map)">
          ...
          <div class="text-sm font-bold font-mono whitespace-nowrap ${a?n&&n>=.9?"text-emerald-400":"text-amber-400":"text-slate-400"}">
        ...
        <div class="flex items-center gap-2">
          <div>
            ...
            <div class="w-20 h-2 bg-slate-800 rounded-full overflow-hidden border border-slate-700/60">
              <div style="width: ${Math.min(100,d.workloadPercent)}%; background-color: ${c};" class="h-full transition-all duration-300"></div>
            </div>
          </div>

          ${d.workloadPercent>85?`<button id="btn-advisory-alert" class="w-7 h-7 rounded-full bg-red-600/90 text-white font-black text-xs flex items-center justify-center border-2 border-red-400 pulse-alert shadow-lg cursor-pointer hover:bg-red-500 flex-shrink-0" title="產線超載嚴重！點擊查看瓶頸診斷">
                  !
                </button>`:""}
        </div>
      </div>
      ...
      <div class="flex items-center gap-2 flex-shrink-0 whitespace-nowrap">
        ...
        <!-- 3. 科技樹研發突破 (次世代機台解鎖) -->
        <button id="btn-techtree" class="btn-sci-fi relative text-xs font-bold py-1.5 px-3 bg-cyan-950/50 border-cyan-500/60 text-cyan-300 hover:text-white ${i.canAdvance?"border-emerald-400 text-emerald-300 ring-2 ring-emerald-500/40 animate-pulse":""}" title="檢視半導體製程科技樹 (目前: Tier ${e.foundryTier})">
          🔬 研發 (T${e.foundryTier})
        ...
        <div class="relative inline-block">
          <button id="btn-top-more" class="btn-sci-fi text-xs font-bold py-1.5 px-3 bg-slate-800/90 hover:bg-slate-700 border-slate-600 text-slate-200 hover:text-white flex items-center gap-1.5 cursor-pointer relative" title="更多系統與管理功能">
            ...
            ${m?'<span class="absolute -top-1 -right-1 w-2.5 h-2.5 rounded-full bg-amber-400 ring-2 ring-slate-900 animate-pulse"></span>':""}
          </button>
          ...
          <div id="top-dropdown-menu" class="hidden absolute right-0 mt-2 w-64 rounded-xl glass-panel bg-slate-950/98 border border-slate-700 shadow-2xl py-2 z-50 text-xs text-slate-200 backdrop-blur-xl animate-fadeIn">
            ...
            <button id="menu-item-hr" class="w-full px-4 py-2.5 text-left hover:bg-slate-800/80 flex items-center justify-between transition-colors cursor-pointer">
              ...
              <span class="text-[10px] text-slate-400 font-mono">${t.staff.length} 人</span>
            </button>
            ...
            <button id="menu-item-quests" class="w-full px-4 py-2.5 text-left hover:bg-slate-800/80 flex items-center justify-between transition-colors cursor-pointer">
              ...
              ${h?'<span class="px-1.5 py-0.5 rounded bg-amber-500/20 text-amber-300 font-mono text-[10px] border border-amber-500/30">待領取</span>':""}
            </button>
            ...
            <button id="menu-item-achievements" class="w-full px-4 py-2.5 text-left hover:bg-slate-800/80 flex items-center justify-between transition-colors cursor-pointer">
              ...
              ${u?'<span class="px-1.5 py-0.5 rounded bg-emerald-500/20 text-emerald-300 font-mono text-[10px] border border-emerald-500/30">可解鎖</span>':""}
            </button>
            ...
            <button id="menu-item-toggle-mes" class="w-full px-4 py-2.5 text-left hover:bg-slate-800/80 flex items-center justify-between transition-colors cursor-pointer">
              ...
              <span class="text-[10px] font-bold font-mono px-1.5 py-0.5 rounded ${t.unlockedFeatures.mesAutoDispatch?"bg-emerald-950 text-emerald-300 border border-emerald-500/40":"bg-slate-900 text-slate-400 border border-slate-700"}">
                ${t.unlockedFeatures.mesAutoDispatch?"🟢 已開啟":"⚪ 已停用"}
              </span>
            </button>
            ...
            <button id="menu-item-sound" class="w-full px-4 py-2 text-left hover:bg-slate-800/80 flex items-center justify-between transition-colors cursor-pointer">
              <span class="flex items-center gap-2.5"><span>${p?"🔇":"🔊"}</span><span>遊戲音效開關</span></span>
              <span class="text-[10px] text-slate-400 font-mono">${p?"靜音":"開啟"}</span>
            </button>
    ...
    `,(E=document.getElementById("btn-contracts"))==null||E.addEventListener("click",S=>{S.stopPropagation(),f.playClick(),this.callbacks.onOpenContracts()}),(v=document.getElementById("btn-store"))==null||v.addEventListener("click",S=>{S.stopPropagation(),f.playClick(),this.callbacks.onOpenStore()}),(C=document.getElementById("btn-techtree"))==null||C.addEventListener("click",S=>{var M,$;S.stopPropagation(),f.playClick(),($=(M=this.callbacks).onOpenTechTree)==null||$.call(M)}),(O=document.getElementById("btn-planner"))==null||O.addEventListener("click",S=>{var M,$;S.stopPropagation(),f.playClick(),($=(M=this.callbacks).onOpenPlanner)==null||$.call(M)}),(F=document.getElementById("btn-finance"))==null||F.addEventListener("click",S=>{var M,$;S.stopPropagation(),f.playClick(),($=(M=this.callbacks).onOpenFinance)==null||$.call(M)}),(w=document.getElementById("btn-hud-cash"))==null||w.addEventListener("click",S=>{var M,$;S.stopPropagation(),f.playClick(),($=(M=this.callbacks).onOpenFinance)==null||$.call(M)}),(P=document.getElementById("btn-hud-yield"))==null||P.addEventListener("click",S=>{var M,$;S.stopPropagation(),f.playClick(),($=(M=this.callbacks).onOpenWaferMap)==null||$.call(M)}),(H=document.getElementById("btn-advisory-alert"))==null||H.addEventListener("click",S=>{S.stopPropagation(),f.playClick(),this.callbacks.onOpenAdvisory()}),(Y=document.getElementById("btn-hud-profile-avatar"))==null||Y.addEventListener("click",S=>{var M,$;S.stopPropagation(),f.playClick(),($=(M=this.callbacks).onOpenLogin)==null||$.call(M)}),(V=document.getElementById("btn-hud-switch-user"))==null||V.addEventListener("click",S=>{var M,$;S.stopPropagation(),f.playClick(),($=(M=this.callbacks).onOpenLogin)==null||$.call(M)});const b=document.getElementById("btn-top-more"),x=document.getElementById("top-dropdown-menu");b==null||b.addEventListener("click",S=>{S.stopPropagation(),f.playClick(),x==null||x.classList.toggle("hidden")});const y=()=>{x&&!x.classList.contains("hidden")&&x.classList.add("hidden")},T=S=>{x&&!x.contains(S.target)&&S.target!==b&&!(b!=null&&b.contains(S.target))&&y()};document.addEventListener("click",T),(Q=document.getElementById("menu-item-hr"))==null||Q.addEventListener("click",S=>{S.stopPropagation(),y(),f.playClick(),this.callbacks.onOpenHR()}),(oe=document.getElementById("menu-item-quests"))==null||oe.addEventListener("click",S=>{S.stopPropagation(),y(),f.playClick(),this.callbacks.onOpenQuests()}),(le=document.getElementById("menu-item-achievements"))==null||le.addEventListener("click",S=>{S.stopPropagation(),y(),f.playClick(),this.callbacks.onOpenAchievements()}),(de=document.getElementById("menu-item-toggle-mes"))==null||de.addEventListener("click",S=>{S.stopPropagation(),f.playClick();const M=!t.unlockedFeatures.mesAutoDispatch;t.unlockedFeatures.mesAutoDispatch=M,this.callbacks.onToggleMES(M),this.render(t)}),(ce=document.getElementById("menu-item-switch-user"))==null||ce.addEventListener("click",S=>{var M,$;S.stopPropagation(),y(),f.playClick(),($=(M=this.callbacks).onOpenLogin)==null||$.call(M)}),(pe=document.getElementById("menu-item-save"))==null||pe.addEventListener("click",S=>{S.stopPropagation(),y(),f.playClick(),this.callbacks.onOpenSaveModal()}),(ue=document.getElementById("menu-item-tutorial"))==null||ue.addEventListener("click",S=>{var M,$;S.stopPropagation(),y(),f.playClick(),($=(M=this.callbacks).onOpenTutorial)==null||$.call(M)}),(he=document.getElementById("menu-item-sound"))==null||he.addEventListener("click",S=>{S.stopPropagation(),f.toggleMute(),f.playClick(),this.render(t)}),(me=document.getElementById("menu-item-factory-reset"))==null||me.addEventListener("click",S=>{var M,$;S.stopPropagation(),y(),f.playClick(),($=(M=this.callbacks).onOpenFactoryReset)==null||$.call(M)})}}class ie{static show(t,e){const s=document.getElementById("modal-container");if(!s)return;let a="avatar_1";const n=()=>{var r,i,o;s.innerHTML=`
      ...
      `,(r=document.getElementById("btn-random-company"))==null||r.addEventListener("click",()=>{f.playClick();const l=this.RANDOM_COMPANIES[Math.floor(Math.random()*this.RANDOM_COMPANIES.length)],d=document.getElementById("setup-company-name");d&&(d.value=l)}),(i=document.getElementById("btn-random-ceo"))==null||i.addEventListener("click",()=>{f.playClick();const l=this.RANDOM_CEOS[Math.floor(Math.random()*this.RANDOM_CEOS.length)],d=document.getElementById("setup-ceo-name");d&&(d.value=l)}),document.querySelectorAll(".avatar-card").forEach(l=>{l.addEventListener("click",d=>{f.playClick();const c=d.currentTarget.getAttribute("data-avatar-id");c&&(a=c,n())})}),(o=document.getElementById("btn-submit-foundry"))==null||o.addEventListener("click",()=>{const l=document.getElementById("setup-company-name"),d=document.getElementById("setup-ceo-name"),c=(l==null?void 0:l.value.trim())||"矽島先進積體電路",p=(d==null?void 0:d.value.trim())||"張創辦人";t.player.companyName=c,t.player.ceoName=p,t.player.avatarId=a,f.playSuccess(),s.innerHTML="",e(t.player)})};n()}}g(ie,"RANDOM_COMPANIES",["矽島先進積體電路","台積微系統","聯華微電科技","世界微晶圓","美光矽島半導體","瑞昱微系統","聯詠積體科技","旺宏微晶科技"]),g(ie,"RANDOM_CEOS",["張忠謨","劉德音","魏哲家","曹興成","黃仁勳","蘇姿丰","蔡力行","梁孟松"]);class ve{static show(t,e,s){var h,u,m,b,x;const a=document.getElementById("modal-container");if(!a)return;const n=t.unlockedFeatures.cmp,r=D.diagnoseBottleneck(t.machines,t.staff,t.activeLots,t.unlockedFeatures,n),{workloadPercent:i,throughputs:o}=D.calculateFactoryWorkload(t.machines,t.staff,t.activeLots,t.unlockedFeatures,n);let l="bg-red-950 text-red-400 border-red-500/50",d="⚠️";r.category==="MAINTENANCE"?(l="bg-amber-950 text-amber-400 border-amber-500/50",d="🔧"):r.category==="LOGISTICS"?(l="bg-cyan-950 text-cyan-400 border-cyan-500/50",d="🚛"):r.category==="LAYOUT"&&(l="bg-purple-950 text-purple-400 border-purple-500/50",d="📐");const c=y=>{y.key==="Escape"&&(a.innerHTML="",window.removeEventListener("keydown",c))};window.addEventListener("keydown",c);const p=()=>{f.playClick(),a.innerHTML="",window.removeEventListener("keydown",c)};a.innerHTML=`
    ...
    `,(h=document.getElementById("btn-close-advisory"))==null||h.addEventListener("click",p),(u=document.getElementById("btn-advisory-ok"))==null||u.addEventListener("click",p),(m=document.getElementById("modal-backdrop-advisory"))==null||m.addEventListener("click",y=>{y.target===y.currentTarget&&p()}),(b=document.getElementById("btn-advisory-store"))==null||b.addEventListener("click",()=>{p(),e&&e()}),(x=document.getElementById("btn-advisory-hr"))==null||x.addEventListener("click",()=>{p(),s&&s()})}}class G{static refreshDailyQuests(t,e,s,a){if(t.lastDateStr===a&&t.dailyQuests.length===3)return t;const n=e.foundryTier,r=[0,6e4,18e4,45e4,12e5,35e5,12e6][n]??6e4,i=[],o=n===1?5:n===2?15:n===3?30:n===4?60:100;i.push({id:`quest_produce_${a}`,title:"穩定投片交付產出",description:`完成出貨累計 ${o} 片合格晶圓至客戶端。`,tier:n,currentValue:0,targetValue:o,rewardCash:r,rewardPopularity:3,completed:!1,claimed:!1}),n>=3&&s.cmp?i.push({id:`quest_cmp_operation_${a}`,title:"平坦化製程精進",description:"成功執行 5 次 CMP 化學機械平坦化拋光研磨。",tier:n,currentValue:0,targetValue:5,rewardCash:Math.round(r*1.2),rewardPopularity:4,completed:!1,claimed:!1}):i.push({id:`quest_maintain_fab_${a}`,title:"廠務設備巡檢維護",description:"指派工程師對機台進行保養或維持機台健康度在 90% 以上。",tier:n,currentValue:0,targetValue:2,rewardCash:r,rewardPopularity:3,completed:!1,claimed:!1});const l=n<=2?2:3;return i.push({id:`quest_order_fulfill_${a}`,title:"光罩合約履約達成",description:`順利交貨並履約 ${l} 筆晶圓製造合約，取得全額尾款。`,tier:n,currentValue:0,targetValue:l,rewardCash:Math.round(r*1.5),rewardPopularity:5,completed:!1,claimed:!1}),{lastDateStr:a,dailyQuests:i,allDailyClaimed:!1,weeklyCompletedCount:t.weeklyCompletedCount??0,weeklyTarget:15,weeklyClaimed:t.weeklyClaimed??!1}}static onWaferDelivered(t,e){for(const s of t.dailyQuests)s.id.startsWith("quest_produce")&&!s.completed&&(s.currentValue+=e,s.currentValue>=s.targetValue&&(s.currentValue=s.targetValue,s.completed=!0))}static onOrderFulfilled(t){for(const e of t.dailyQuests)e.id.startsWith("quest_order_fulfill")&&!e.completed&&(e.currentValue+=1,e.currentValue>=e.targetValue&&(e.currentValue=e.targetValue,e.completed=!0))}static onMachineMaintained(t){for(const e of t.dailyQuests)e.id.startsWith("quest_maintain_fab")&&!e.completed&&(e.currentValue+=1,e.currentValue>=e.targetValue&&(e.currentValue=e.targetValue,e.completed=!0))}static onCmpProcessed(t){for(const e of t.dailyQuests)e.id.startsWith("quest_cmp_operation")&&!e.completed&&(e.currentValue+=1,e.currentValue>=e.targetValue&&(e.currentValue=e.targetValue,e.completed=!0))}static isAllDailyCompleted(t){return t.dailyQuests.length!==3?!1:t.dailyQuests.every(e=>e.completed)}static claimSingleQuest(t,e){const s=t.dailyQuests.find(a=>a.id===e);return s?s.completed?s.claimed?{success:!1,cash:0,popularity:0,message:"該任務獎勵已領取"}:(s.claimed=!0,{success:!0,cash:s.rewardCash,popularity:s.rewardPopularity,message:`領取成功！獲得獎勵金 NT$ ${s.rewardCash.toLocaleString()} 與商譽 +${s.rewardPopularity}！`}):{success:!1,cash:0,popularity:0,message:"該任務尚未達成目標"}:{success:!1,cash:0,popularity:0,message:"找不到該任務"}}static claimDailyAllClear(t,e){if(!this.isAllDailyCompleted(t))return{success:!1,cash:0,popularity:0,message:"尚有每日任務未完成，無法領取全勤特獎"};if(t.allDailyClaimed)return{success:!1,cash:0,popularity:0,message:"今日全勤特獎已經領取過囉"};t.allDailyClaimed=!0,t.weeklyCompletedCount=Math.min(21,(t.weeklyCompletedCount??0)+3);const s=[0,15e4,45e4,12e5,3e6,8e6,25e6][e]??15e4,a=10;return{success:!0,cash:s,popularity:a,message:`🎉 達成今日 3/3 全勤！獲得全勤特獎 NT$ ${s.toLocaleString()}、商譽 +${a}，每週任務進度累計 +3！`}}static claimWeeklyBounty(t,e){if(t.weeklyCompletedCount<t.weeklyTarget)return{success:!1,cash:0,popularity:0,message:`每週任務尚未達標！目前進度 ${t.weeklyCompletedCount}/${t.weeklyTarget}`};if(t.weeklyClaimed)return{success:!1,cash:0,popularity:0,message:"本週龍頭週大獎已領取過囉"};t.weeklyClaimed=!0;const s=[0,1e6,3e6,8e6,2e7,6e7,2e8][e]??1e6,a=30;return{success:!0,cash:s,popularity:a,message:`🏆 榮膺半導體龍頭週大獎！領取巨額扶持金 NT$ ${s.toLocaleString()} 與商譽 +${a}！全廠客戶信任度提升！`}}}class we{static show(t,e){const s=document.getElementById("modal-container");if(!s)return;const a=()=>{var l,d,c,p,h;const n=t.questState,r=G.isAllDailyCompleted(n);s.innerHTML=`
      ...
      `;const i=()=>{f.playClick(),s.innerHTML="",window.removeEventListener("keydown",o)},o=u=>{u.key==="Escape"&&i()};window.addEventListener("keydown",o),(l=document.getElementById("btn-close-quests"))==null||l.addEventListener("click",i),(d=document.getElementById("btn-back-quests"))==null||d.addEventListener("click",i),(c=document.getElementById("modal-backdrop-quest"))==null||c.addEventListener("click",u=>{u.target===document.getElementById("modal-backdrop-quest")&&i()}),document.querySelectorAll(".btn-claim-quest").forEach(u=>{u.addEventListener("click",m=>{const b=m.currentTarget.getAttribute("data-id");if(b){const x=G.claimSingleQuest(t.questState,b);x.success&&(t.player.cash+=x.cash,A.recordSubsidy(t,x.cash),t.player.popularity+=x.popularity,f.playCoin(),a(),e())}})}),(p=document.getElementById("btn-claim-all-daily"))==null||p.addEventListener("click",()=>{const u=G.claimDailyAllClear(t.questState,t.player.foundryTier);u.success&&(t.player.cash+=u.cash,A.recordSubsidy(t,u.cash),t.player.popularity+=u.popularity,f.playSuccess(),a(),e())}),(h=document.getElementById("btn-claim-weekly"))==null||h.addEventListener("click",()=>{const u=G.claimWeeklyBounty(t.questState,t.player.foundryTier);u.success&&(t.player.cash+=u.cash,A.recordSubsidy(t,u.cash),t.player.popularity+=u.popularity,f.playSuccess(),a(),e())})};a()}}class fe{static show(t,e){const s=document.getElementById("modal-container");if(!s)return;_.checkAchievements(t);const a=i=>{i.key==="Escape"&&(s.innerHTML="",window.removeEventListener("keydown",a))};window.addEventListener("keydown",a);const n=()=>{f.playClick(),s.innerHTML="",window.removeEventListener("keydown",a)},r=()=>{var c,p,h;const i=t.achievements,o=i.filter(u=>u.category===this.activeCategory),l=i.filter(u=>u.unlocked).length,d=[{key:"onboarding",label:"新手入門",icon:"🚀"},{key:"process",label:"製程突破",icon:"🔬"},{key:"operation",label:"廠務卓越",icon:"🛡️"},{key:"yield",label:"品質良率",icon:"💎"}];s.innerHTML=`
      ...
      `,(c=document.getElementById("btn-close-achievements"))==null||c.addEventListener("click",n),(p=document.getElementById("btn-return-achievements"))==null||p.addEventListener("click",n),(h=document.getElementById("modal-backdrop-achievements"))==null||h.addEventListener("click",u=>{u.target===u.currentTarget&&n()}),document.querySelectorAll(".btn-tab").forEach(u=>{u.addEventListener("click",m=>{f.playClick();const b=m.currentTarget.getAttribute("data-cat");b&&(this.activeCategory=b,r())})}),document.querySelectorAll(".btn-claim-ach").forEach(u=>{u.addEventListener("click",m=>{const b=m.currentTarget.getAttribute("data-id");if(b){const x=_.claimReward(t.achievements,b);x.success&&(t.player.cash+=x.cash,A.recordSubsidy(t,x.cash),f.playCoin(),r(),e())}})})};r()}}g(fe,"activeCategory","onboarding");class ne{static calculateRollingYieldIndex(t){if(!t||t.length===0)return null;const e=t.slice(-5),a=e.reduce((n,r)=>n+r,0)/e.length;return Number(a.toFixed(4))}static calculateLayerYield(t=1,e=0,s=0){let a=.985*t*(1-e)+s;return Math.max(.7,Math.min(.999,a))}static calculateFinalLotYield(t,e=0){if(t.status==="SCRAPPED")return 0;let s=1;for(let a=0;a<t.totalLayers;a++)s*=this.calculateLayerYield(1,e,0);return s*=t.yieldMultiplier||1,Number(Math.max(0,Math.min(1,s)).toFixed(4))}static generateWaferMap(t){const e=[],n=Math.sqrt(8);for(let r=0;r<5;r++)for(let i=0;i<5;i++){const o=r*5+i,l=Math.sqrt((r-2)**2+(i-2)**2),d=l/n,c=1.1-d*.4,p=Math.min(.99,t*c),h=Math.random()<p;e.push({index:o,row:r,col:i,distanceFromCenter:Number(l.toFixed(2)),passed:h,defectType:h?void 0:d>.6?"OPTICAL_DEFOCUS":"PARTICLE"})}for(let r=0;r<e.length;r++)if(!e[r].passed&&Math.random()<.4){const i=e.filter(o=>Math.abs(o.row-e[r].row)<=1&&Math.abs(o.col-e[r].col)<=1&&o.index!==e[r].index);if(i.length>0){const o=i[Math.floor(Math.random()*i.length)];o.passed=!1,o.defectType="CLUSTER"}}return e}}class X{static show(t,e,s){var i;const a=document.getElementById("modal-container");if(!a)return;this.currentLot=e||(t.activeLots.length>0?t.activeLots[0]:null);const n=!!((i=this.currentLot)!=null&&i.hasYellowRoomViolation),r=n?0:this.currentLot?this.currentLot.yieldMultiplier:t.rollingYieldHistory.length>0?t.rollingYieldHistory.reduce((o,l)=>o+l,0)/t.rollingYieldHistory.length:.92;if(n||r===0){this.dies=ne.generateWaferMap(0);for(const o of this.dies)o.passed=!1,o.defectType="CLUSTER"}else this.dies=ne.generateWaferMap(r);this.selectedDie=this.dies[12]||this.dies[0],this.render(a,t,s)}static render(t,e,s){var p,h;const a=this.dies.filter(u=>u.passed).length,n=this.dies.length-a,r=(a/this.dies.length*100).toFixed(1),i=this.dies.filter(u=>u.defectType==="CLUSTER").length,o=this.dies.filter(u=>u.defectType==="PARTICLE").length,l=this.dies.filter(u=>u.defectType==="OPTICAL_DEFOCUS").length,d=e.activeLots.some(u=>u.status==="PROCESSING")||e.machines.some(u=>u.status==="PROCESSING"),c=e.rollingYieldHistory.length>0?(e.rollingYieldHistory.reduce((u,m)=>u+m,0)/e.rollingYieldHistory.length*100).toFixed(1)+"%":"N/A";t.innerHTML=`
        ...
        <div class="modal-content glass-panel glass-panel-glow max-w-3xl max-h-[90vh] flex flex-col text-slate-100 p-0 overflow-hidden animate-fadeIn">
          ...
          <div class="p-6 overflow-y-auto flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 items-center text-xs">
            ...
            <div class="flex flex-col items-center justify-center space-y-3">
              <div class="relative w-64 h-64 sm:w-72 sm:h-72 rounded-full bg-gradient-to-tr from-slate-900 via-slate-800 to-cyan-950 border-4 border-cyan-500/30 shadow-2xl p-6 flex items-center justify-center group">
                ...
                <div class="grid grid-cols-5 gap-2 w-full h-full relative z-10 p-2">
                  ${this.dies.map(u=>{var y;const m=((y=this.selectedDie)==null?void 0:y.index)===u.index;let b="bg-emerald-500 hover:bg-emerald-400 border-emerald-300/80 shadow-[0_0_8px_rgba(16,185,129,0.5)]",x="✓";return u.passed||(u.defectType==="CLUSTER"?(b="bg-red-600 hover:bg-red-500 border-red-400 shadow-[0_0_10px_rgba(239,68,68,0.7)]",x="✕"):u.defectType==="OPTICAL_DEFOCUS"?(b="bg-amber-500 hover:bg-amber-400 border-amber-300 shadow-[0_0_8px_rgba(245,158,11,0.6)]",x="⚠"):(b="bg-purple-600 hover:bg-purple-500 border-purple-400 shadow-[0_0_8px_rgba(168,85,247,0.6)]",x="●")),`
                      <button
                        class="btn-wafer-die rounded-md border text-xs font-bold text-white transition-all transform hover:scale-110 flex items-center justify-center font-mono ${b} ${m?"ring-2 ring-white scale-105":""}"
                        data-index="${u.index}"
            ...
            <div class="space-y-4">
              ...
              ${(p=this.currentLot)!=null&&p.hasYellowRoomViolation||Number(r)===0?`
                  ...
                  <div class="space-y-1.5 font-mono text-[11px] p-2.5 rounded-lg bg-slate-950/70 border border-slate-800/80">
                    ...
                    `:`
                      <div class="pt-1.5 border-t border-slate-800 text-[10px] text-slate-300">
                        ...
                        ${(h=this.currentLot)!=null&&h.hasYellowRoomViolation?"【致命白光曝曬污染】微影設備未設置於黃光專區，環境可見光破壞感光光阻化學鍵，全片晶粒完全報廢！":this.selectedDie.defectType==="CLUSTER"?"【區域群聚缺陷】微影光阻殘留或化學腐蝕液擴散，波及相鄰相連晶粒！":this.selectedDie.defectType==="OPTICAL_DEFOCUS"?"【邊緣聚焦離焦】晶圓邊緣物理翹曲與數值孔徑 NA 聚焦裕度不足導致線寬失真！":"【微影落塵污染】無塵室空氣中微粒穿透光阻，導致金屬互連斷路！"}
                      </div>
                    `}
                  </div>
                `:`
      ...
      <div id="modal-backdrop-layer" class="modal-backdrop">
        <div class="modal-content glass-panel glass-panel-glow max-w-4xl text-slate-100 flex flex-col max-h-[90vh]">
          ...
          <div class="modal-body flex-1 overflow-y-auto pr-1 space-y-2.5 my-2">
            ${this.localAllocations.map(d=>{const c=i.get(d.assignedMachineModelId)??99999,p=c>d.targetCD,h=d.layerIndex<=3;return`
                <div class="p-3 rounded-xl bg-slate-900/80 border ${p?"border-red-500/60 bg-red-950/20":"border-slate-800 hover:border-slate-700"} flex flex-col md:flex-row md:items-center justify-between gap-3 transition-all">
                  ...
                  <div class="flex-1 max-w-sm">
                    <select data-layer="${d.layerIndex}" class="sel-layer-machine w-full px-2.5 py-1.5 rounded-lg bg-slate-950 border border-slate-700 text-xs text-slate-200 focus:border-indigo-500 focus:outline-none">
                      ${n.map(u=>{const m=i.get(u.modelId)??9999,b=u.modelId===d.assignedMachineModelId;return`
    ...
    `,this.bindEvents(t,e,s)}static bindEvents(t,e,s){var i,o,l,d,c;const a=()=>{f.playClick(),t.innerHTML="",window.removeEventListener("keydown",n)},n=p=>{p.key==="Escape"&&a()};window.addEventListener("keydown",n),(i=document.getElementById("btn-close-layer-modal"))==null||i.addEventListener("click",a),(o=document.getElementById("btn-cancel-layer-alloc"))==null||o.addEventListener("click",a),(l=document.getElementById("modal-backdrop-layer"))==null||l.addEventListener("click",p=>{p.target===document.getElementById("modal-backdrop-layer")&&a()}),t.querySelectorAll(".sel-layer-machine").forEach(p=>{p.addEventListener("change",h=>{const u=h.target,m=Number(u.dataset.layer),b=u.value,x=this.localAllocations.find(y=>y.layerIndex===m);x&&(x.assignedMachineModelId=b,f.playClick(),this.render(t,e,s))})}),(d=document.getElementById("btn-auto-fill-alloc"))==null||d.addEventListener("click",()=>{this.currentOrder&&(f.playCoinChime(),this.localAllocations=D.autoFillBestEconomyAllocation(this.currentOrder,e.machines),this.render(t,e,s))}),(c=document.getElementById("btn-save-layer-alloc"))==null||c.addEventListener("click",()=>{this.currentOrder&&(this.currentOrder.layerAllocations=JSON.parse(JSON.stringify(this.localAllocations)),f.playFanfare(),t.innerHTML="",s())})}}g(te,"currentOrder",null),g(te,"localAllocations",[]);class J{static show(t,e){const s=document.getElementById("modal-container");s&&((this.marketOrders.length===0||t.gameTime-this.lastRefreshTime>60)&&this.refreshMarketOrders(t),this.render(s,t,e))}static refreshMarketOrders(t){const e=t.rollingYieldHistory.length>0?t.rollingYieldHistory.reduce((s,a)=>s+a,0)/t.rollingYieldHistory.length:null;this.marketOrders=U.generateContractBoard(t.player.foundryTier,e,t.gameTime),this.lastRefreshTime=t.gameTime}static render(t,e,s){const a=e.rollingYieldHistory.length>0?e.rollingYieldHistory.reduce((i,o)=>i+o,0)/e.rollingYieldHistory.length:null,n=U.calculateTrustMultiplier(a),r=this.getBestLithoCD(e);t.innerHTML=`
    ...
    `}static bindEvents(t,e,s){var r,i,o,l,d,c;const a=()=>{f.playClick(),t.innerHTML="",window.removeEventListener("keydown",n)},n=p=>{p.key==="Escape"&&a()};window.addEventListener("keydown",n),(r=document.getElementById("btn-close-contract"))==null||r.addEventListener("click",a),(i=document.getElementById("btn-back-contract"))==null||i.addEventListener("click",a),(o=document.getElementById("modal-backdrop-contract"))==null||o.addEventListener("click",p=>{p.target===document.getElementById("modal-backdrop-contract")&&a()}),(l=document.getElementById("tab-market"))==null||l.addEventListener("click",()=>{f.playClick(),this.currentTab="MARKET",this.render(t,e,s)}),(d=document.getElementById("tab-active"))==null||d.addEventListener("click",()=>{f.playClick(),this.currentTab="ACTIVE",this.render(t,e,s)}),(c=document.getElementById("btn-refresh-market"))==null||c.addEventListener("click",()=>{f.playClick(),this.refreshMarketOrders(e),this.render(t,e,s)}),t.querySelectorAll(".btn-accept-order").forEach(p=>{p.addEventListener("click",h=>{const u=parseInt(h.currentTarget.getAttribute("data-index")||"0",10),m=this.marketOrders[u];if(!m)return;f.playCoinChime(),e.player.cash+=m.nrePaid,A.recordNREFee(e,m.nrePaid),e.activeOrders.push(m);const b=Math.max(1,Math.min(3,Math.ceil(m.totalDies/1e3)));for(let x=0;x<b;x++){const y={lotId:`LOT-${Date.now().toString(36).toUpperCase().slice(-4)}-${x+1}`,orderId:m.id,waferCount:Math.ceil(m.totalDies/b/(m.nodeNm>=1e3?500:2e3)),currentStation:"FILM",currentLayer:1,totalLayers:m.layerCount,qTimeDeadline:null,yieldMultiplier:1,status:"PROCESSING",stationProgressSeconds:0,stationRequiredSeconds:D.getStationRequiredSeconds("FILM")};e.activeLots.push(y)}this.marketOrders.splice(u,1),_.checkAchievements(e),s(),this.currentTab="ACTIVE",this.render(t,e,s)})}),t.querySelectorAll(".btn-settle-order").forEach(p=>{p.addEventListener("click",h=>{const u=h.currentTarget.getAttribute("data-order-id"),m=e.activeOrders.findIndex(E=>E.id===u);if(m===-1)return;const b=e.activeOrders[m],x=b.goodDiesDelivered>0?b.goodDiesDelivered:b.totalDies*.95,y=U.settleOrderPayout(b,x,e.player,e.staff,0,e.clawbackDebt);e.player.cash+=y.netPayout,A.recordWaferSales(e,y.netPayout),e.clawbackDebt=y.remainingDebt;const k=e.activeLots.filter(E=>E.orderId===b.id).reduce((E,v)=>E+(v.waferCount||25),0)||25;e.player.totalOrdersFulfilled=(e.player.totalOrdersFulfilled||0)+1,e.player.totalWafersDelivered=(e.player.totalWafersDelivered||0)+k,e.activeOrders.splice(m,1),e.activeLots=e.activeLots.filter(E=>E.orderId!==b.id),f.playFanfare(),_.checkAchievements(e),s(),this.render(t,e,s)})}),t.querySelectorAll(".btn-inspect-lot").forEach(p=>{p.addEventListener("click",h=>{const u=h.currentTarget.getAttribute("data-lot-id"),m=e.activeLots.find(b=>b.lotId===u);f.playClick(),X.show(e,m,()=>{this.render(t,e,s),s()})})}),t.querySelectorAll(".btn-layer-allocation").forEach(p=>{p.addEventListener("click",h=>{const u=h.currentTarget.getAttribute("data-order-id"),m=e.activeOrders.find(b=>b.id===u);m&&(f.playClick(),te.show(e,m,()=>{this.render(t,e,s),s()}))})})}static getBestLithoCD(t){const e=t.machines.filter(a=>a.category==="LITHO"&&a.status!=="EXPLODED");if(e.length===0)return 999999;let s=999999;for(const a of e){const n=W.OPTICAL_CATALOG[a.modelId];n&&n.baseRayleighLimitNm<s&&(s=n.baseRayleighLimitNm)}return s}}g(J,"marketOrders",[]),g(J,"lastRefreshTime",0),g(J,"currentTab","MARKET");class re{static show(t,e){const s=document.getElementById("modal-container");if(!s)return;const a=t.player.foundryTier||1;this.selectedViewTier=Math.min(R.MAX_TIER,a+1),this.render(s,t,e)}static render(t,e,s){var o,l;const a=R.getProgressionStatus(e),n=R.getTierConfig(a.currentTier),r=this.selectedViewTier||Math.min(R.MAX_TIER,a.currentTier+1),i=R.getTierConfig(r);t.innerHTML=`
        ...
        <div class="modal-content glass-panel glass-panel-glow max-w-5xl max-h-[92vh] flex flex-col text-slate-100 p-0 overflow-hidden animate-scaleUp">
          ...
          <div class="px-6 py-4 border-b border-slate-800/80 bg-slate-950/70 overflow-x-auto flex-shrink-0">
            <div class="flex items-center justify-between min-w-[720px] gap-2 relative">
              ...
              ${Array.from({length:R.MAX_TIER},(d,c)=>c+1).map(d=>{const c=R.getTierConfig(d),p=d<a.currentTier,h=d===a.currentTier,u=d===a.currentTier+1,m=d===r;let b="border-slate-700 bg-slate-900 text-slate-500",x="未解鎖",y="bg-slate-800 text-slate-500 border-slate-700";return p?(b="border-emerald-500/80 bg-emerald-950/60 text-emerald-400 shadow-lg shadow-emerald-950/50",x="已突破",y="bg-emerald-950/80 text-emerald-300 border-emerald-500/40"):h?(b="border-cyan-400 bg-cyan-950/80 text-cyan-300 ring-4 ring-cyan-500/20 shadow-lg shadow-cyan-950/60",x="當前世代",y="bg-cyan-900/80 text-cyan-200 border-cyan-400/50"):u&&(b="border-amber-400/90 bg-amber-950/70 text-amber-300 ring-2 ring-amber-500/30 pulse-alert",x=`研發中 ${a.overallPct}%`,y="bg-amber-950/80 text-amber-300 border-amber-500/40"),`
                  <button
                    ...
                    data-tier="${d}"
                    title="點擊檢視 Tier ${d} ${c.name} 詳細製程規格"
                  >
          ...
          <div class="modal-body p-6 overflow-y-auto flex-1 space-y-6">
            ...
            <div class="space-y-3">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                ${i.unlockedModelIds.map(d=>{const c=j.STORE_CATALOG.find(p=>p.modelId===d);return c?`
    ...
    `,this.bindEvents(t,e,s)}static renderAMHSTab(t){return`
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ${[{feature:"manual",name:"人工卡匣徒步搬運 (Manual Handling)",tier:1,price:0,speed:"1.0 格/秒",assetPath:L.characters.tech_cleanroom.path,isPurchased:!0,isUnlocked:!0,canAfford:!0,description:"無塵衣技術員手持晶圓盒穿梭各站手動交接。搬運速度慢，人員走動產生微塵，交接等待時間較長。",scienceNote:"半導體萌芽期仰賴人員手動搬運卡匣，每小時人員走動產生之微塵顆粒達數萬顆，對良率是巨大隱憂。",benefits:["基礎徒步搬運","無設備採購支出"]},{feature:"agv",name:"AGV 磁導激光無人自走車 (Automated Guided Vehicle)",tier:1,price:8e6,speed:"2.5 格/秒",assetPath:L.characters.agv_carrier.path,isPurchased:!!t.unlockedFeatures.agv,isUnlocked:t.player.foundryTier>=1,canAfford:t.player.cash>=8e6,description:"地面自主導航輪式無人載具，依循地面雷射激光自主穿梭於各站機台之間。自動對位上下料，大幅降低人員進出無塵室落塵。",scienceNote:"AGV 採用光學雷達 (LiDAR) 與磁帶導引，實現無塵室地面自動化運輸，有效平滑各站排隊緩衝並消弭交接震動。",benefits:["解鎖地面無人自走車自主巡航","消弭人工搬運落塵提升良率","達成自動化物料搬運 AMHS 里程碑"]},{feature:"oht",name:"OHT 高速天軌懸吊天車 (Overhead Hoist Transport)",tier:2,price:35e6,speed:"5.0 格/秒",assetPath:L.characters.oht_shuttle.path,isPurchased:!!t.unlockedFeatures.oht,isUnlocked:t.player.foundryTier>=2,canAfford:t.player.cash>=35e6,description:"天花板立體閉迴路天軌懸吊天車系統，晶圓 FOUP 完全在空中高速飛行傳送。徹底解耦地面人車交通，是現代晶圓廠的核心骨幹！",scienceNote:"現代 300mm 超級晶圓廠的神經中樞。透過空中立體懸吊軌道直接降下垂直機械爪 (Hoist) 對位 Load Port，站點傳送時間縮短 70%！",benefits:["解鎖天花板空中天軌高速巡航","站間交接時間縮短 70%","徹底消除地面交織塞車瓶頸"]},{feature:"shrOht",name:"SHR 超急件綠波磁浮天車 (Super Hot Run OHT)",tier:4,price:12e7,speed:"8.0 格/秒",assetPath:L.characters.oht_shuttle.path,isPurchased:!!t.unlockedFeatures.shrOht,isUnlocked:t.player.foundryTier>=4,canAfford:t.player.cash>=12e7,description:"旗艦級超急件動態調度系統！改裝超導磁浮提速馬達，天車空中巡航提速 2.5 倍，並在天軌享有超急件綠波路權 (翠綠色科技特效)！",scienceNote:"Super Hot Run (SHR) 為晶圓代工廠為戰略客戶特批之綠波急件協議，所有天軌道岔與機台排程優先強占，極速交件！",benefits:["天車飛行速度大幅激增 2.5 倍","空中天車呈現綠波磁浮特效 (Emerald Glow)","大幅壓制 Q-Time 逾期報廢風險"]}].map(s=>`
...
${c}`)})}),t.querySelectorAll(".btn-buy-amhs").forEach(l=>{l.addEventListener("click",d=>{const c=d.currentTarget.getAttribute("data-feature"),p=parseInt(d.currentTarget.getAttribute("data-price")||"0",10),h=d.currentTarget.getAttribute("data-name")||"";if(e.player.cash<p){alert("流動資金不足，無法採購此運送設備！");return}confirm(`確定要投資 NT$ ${p.toLocaleString()} 採購並升級【${h}】嗎？`)&&(e.player.cash-=p,A.recordCapEx(e,p),c==="agv"?e.unlockedFeatures.agv=!0:c==="oht"?e.unlockedFeatures.oht=!0:c==="shrOht"&&(e.unlockedFeatures.shrOht=!0),N.saveToLocalStorage(e),_.checkAchievements(e),f.playFanfare(),s(),this.render(t,e,s))})})}}g(j,"activeCategory","LITHO"),g(j,"STORE_CATALOG",[{modelId:"litho_contact",name:"Contact Aligner (接觸式微影機)",category:"LITHO",tier:1,price:25e5,throughputWpm:10,rayleighLimitNm:3007,description:"半導體萌芽期主力，光罩物理緊貼晶圓表面進行紫外曝光，維修容易。",scienceNote:"利用汞燈紫外混光 (436nm) 貼合曝光。因光罩直接碰觸晶圓表面，容易刮傷光罩與產生落塵，極限線寬約 3µm。",assetPath:L.machines.litho_contact.path},{modelId:"litho_projection",name:"1x Projection Aligner (1:1 投影曝光機)",category:"LITHO",tier:1,price:6e6,throughputWpm:15,rayleighLimitNm:1798,description:"反射鏡等倍投影微影，光罩懸空不接觸晶圓，徹底終結光罩刮傷磨損。",scienceNote:"Perkin-Elmer 經典反射光學系統，以凹面鏡聚焦達成 1:1 無接觸曝光，大幅提升光罩壽命與開局良率。",assetPath:L.machines.litho_projection.path},{modelId:"litho_gline",name:"G-Line Stepper (步進縮小曝光機)",category:"LITHO",tier:2,price:18e6,throughputWpm:25,rayleighLimitNm:997,description:"4:1 縮小投影透鏡，逐區步進曝光（Step-and-Repeat），進入 1µm 時代。",scienceNote:"高壓汞燈 g-line (436nm) 搭配數值孔徑 NA=0.35 之複合縮小透鏡，將光罩圖案縮小 4 倍投射，突破微米大關。",assetPath:L.machines.litho_gline.path},{modelId:"litho_iline",name:"I-Line Stepper (高壓汞燈微影機)",category:"LITHO",tier:3,price:35e6,throughputWpm:55,rayleighLimitNm:584,description:"次微米時代霸主，波長 365nm，支援精密對準與多層金屬互連製程。",scienceNote:"採用更短波長之高強度汞燈 i-line (365nm) 與 NA=0.50 鏡頭，成功壓制繞射效應，可清晰成像至 500nm。",assetPath:L.machines.litho_iline.path},{modelId:"litho_krf",name:"KrF DUV Scanner (準分子雷射微影機)",category:"LITHO",tier:4,price:85e6,throughputWpm:120,rayleighLimitNm:283,description:"深紫外光 (DUV) 準分子雷射，邁入動態連續掃描曝光 (Step-and-Scan)。",scienceNote:"248nm 氟化氪 (KrF) 準分子雷射光源，必須搭配化學增幅光阻 (CAR) 放大光化學反應，支援 0.25µm 製程。",assetPath:L.machines.litho_krf.path},{modelId:"litho_arfdry",name:"ArF Dry Scanner (氟化氬乾式微影機)",category:"LITHO",tier:4,price:18e7,throughputWpm:120,rayleighLimitNm:182,description:"193nm 紫外雷射，將大氣乾式微影發揮至極致，跨越次百奈米門檻。",scienceNote:"利用 193nm 氟化氬雷射與高折射石英透鏡群，是半導體製程縮小至 90nm/65nm 的核心關鍵機台。",assetPath:L.machines.litho_arfdry.path},{modelId:"litho_arfi",name:"ArFi Immersion TWINSCAN (浸潤式微影機)",category:"LITHO",tier:5,price:45e7,throughputWpm:260,rayleighLimitNm:114,description:"鏡頭與晶圓間注入超純水折射光線，雙工件台磁浮掃描，大氣產速最快！",scienceNote:"林本堅博士提出之革命性技術：利用水之折射率 n=1.44 巧妙將等效數值孔徑提升至 NA=1.35，多重曝光下推進至 7nm！",assetPath:L.machines.litho_arfi.path},{modelId:"litho_euv",name:"EUV Scanner (極紫外光微影巨獸)",category:"LITHO",tier:6,price:25e8,throughputWpm:180,rayleighLimitNm:33,description:"13.5nm 極紫外光，全真空反射鏡系統，單次曝光推進 7nm/5nm/3nm！",scienceNote:"以高功率二氧化碳雷射轟擊融熔錫滴激發電漿，產生 13.5nm EUV 光子，全機在超高真空運行，受抽真空限制產能為 180 片/分。",assetPath:L.machines.litho_euv.path},{modelId:"litho_highna",name:"High-NA EUV (高數值孔徑次世代巨獸)",category:"LITHO",tier:6,price:6e9,throughputWpm:180,rayleighLimitNm:20,description:"0.55 NA 變形數值孔徑透鏡，埃米世代霸主，稱霸矽島之終極神兵。",scienceNote:"採用變形鏡頭 (Anamorphic Optics)，X/Y 軸非對稱倍率，單次曝光極限線寬可達 20nm 以下，引領 2nm 埃米時代。",assetPath:L.machines.litho_highna.path},{modelId:"track_manual",name:"手動旋塗熱板台 (Manual Spin & Bake)",category:"TRACK",tier:1,price:8e5,throughputWpm:6,description:"⚠️ 開局先天產能瓶頸！人工滴膠手動離心旋塗與熱板預烤，產能僅 6 片/分。",scienceNote:"利用真空吸盤固定晶圓，手動注射光阻後以 3000 RPM 高速旋轉甩出均勻薄膜，再由人員夾入熱板烘烤。",assetPath:L.machines.track_manual.path},{modelId:"track_single",name:"單軌自動塗膠顯影機 (Single Track)",category:"TRACK",tier:2,price:45e5,throughputWpm:16,description:"初步自動化旋轉塗膠與自動烘烤模組，大幅減少人工操作失誤。",scienceNote:"機械手臂自動傳送晶圓至旋塗杯，自動注膠均勻成膜，並整合冷卻板 (Chill Plate) 精確控制膜厚。",assetPath:L.machines.track_single.path},{modelId:"track_dual",name:"雙軌連線 Track (Dual Track)",category:"TRACK",tier:3,price:12e6,throughputWpm:35,description:"雙獨立機械臂分開處理塗膠與顯影，有效提升次微米連線吞吐量。",scienceNote:"將塗膠旋塗單元 (Coater) 與顯影槽 (Developer) 實體隔離，避免顯影鹼液氣體污染光阻，保障微影良率。",assetPath:L.machines.track_dual.path},{modelId:"track_clean",name:"多工位精密 Clean Track",category:"TRACK",tier:4,price:3e7,throughputWpm:75,description:"多旋塗室並聯，高速熱板陣列，建議為先進微影機配備 2 台以上！",scienceNote:"配置多組 Coater/Developer 模組與快速溫控熱板，支援化學增幅光阻嚴苛的曝光後烘烤 (PEB) 溫度控制。",assetPath:L.machines.track_clean.path},{modelId:"track_advanced",name:"先進極限分子級 Track",category:"TRACK",tier:6,price:25e7,throughputWpm:160,description:"分子級膜厚控制，完美適配 EUV 超薄金屬氧化物光阻 (MOR)。",scienceNote:"具備超微量旋塗技術與化學氣相沉積底膜 (Underlayer)，將光阻粗糙度 (LWR) 降至分子級極限。",assetPath:L.machines.track_advanced.path},{modelId:"film_furnace",name:"高溫熱氧化爐管 (Horizontal Furnace)",category:"FILM",tier:1,price:18e5,throughputWpm:12,description:"利用 1000°C 高溫水汽使矽表面長出堅硬均勻的二氧化矽 (SiO2) 絕緣保護層。",scienceNote:"利用高純度氧氣或水蒸氣在高溫下與矽晶圓反應：Si + O2 -> SiO2，生長厚度均勻的高品質絕緣氧化層。",assetPath:L.machines.film_furnace.path},{modelId:"film_pecvd",name:"電漿增強化學氣相沉積機 (PECVD / ALD)",category:"FILM",tier:4,price:25e6,throughputWpm:110,description:"利用電漿在低溫下快速沉積氮化矽、金屬介電質，並支援原子層沉積 (ALD)。",scienceNote:"以射頻電漿解離前驅氣體，可在較低溫度 (300°C) 下沉積薄膜，避免破壞底層已摻雜之電晶體結構。",assetPath:L.machines.film_pecvd.path},{modelId:"etch_wet",name:"濕式酸槽清洗台 (Wet Chemical Bench)",category:"ETCH",tier:1,price:15e5,throughputWpm:12,description:"利用氫氟酸 (HF) 與化學酸液浸泡溶解未受光阻保護之薄膜，等向性腐蝕。",scienceNote:"化學濕法腐蝕屬於等向性蝕刻 (Isotropic)，容易產生側向掏空 (Undercut)，適合 3µm 以上粗線寬。",assetPath:L.machines.etch_wet.path},{modelId:"etch_plasma",name:"電漿乾式蝕刻機 (RIE / ICP-RIE)",category:"ETCH",tier:3,price:28e6,throughputWpm:50,description:"以高能反應離子轟擊進行垂直非等向性蝕刻，線條邊緣垂直銳利！",scienceNote:"反應性離子蝕刻 (RIE) 結合物理離子轟擊與化學自由基反應，具備極高垂直各向異性 (Anisotropic)，是次微米微影的關鍵搭檔。",assetPath:L.machines.etch_plasma.path},{modelId:"diff_furnace",name:"熱擴散摻雜爐管 (Thermal Diffusion)",category:"DIFF",tier:1,price:2e6,throughputWpm:10,description:"將磷或硼蒸氣高溫擴散滲透進矽晶格中，形成 N 型與 P 型半導體通道。",scienceNote:"利用高溫晶格熱運動使雜質原子由高濃度向低濃度擴散，控溫容易但橫向擴散量大。",assetPath:L.machines.diff_furnace.path},{modelId:"diff_implanter",name:"大束流離子佈植機 (Ion Implanter)",category:"DIFF",tier:2,price:15e6,throughputWpm:20,description:"將雜質原子電離成高能離子束，如子彈般精確轟擊打入矽晶圓特定深度。",scienceNote:"高壓電場加速磷/砷/硼離子束，可獨立精確控制植入劑量與深度，無橫向擴散失真，是現代電晶體的核心技術。",assetPath:L.machines.diff_implanter.path},{modelId:"cmp_polisher",name:"化學機械平坦化研磨機 (CMP Polisher)",category:"CMP",tier:3,price:2e7,throughputWpm:40,description:"化學研磨液搭配高速研磨墊，將晶圓表面磨至分子級平坦，解鎖多層金屬佈線！",scienceNote:"利用研磨液 (Slurry) 的化學腐蝕軟化與奈米磨料的機械研磨，實現全晶圓奈米級全域平坦化 (Global Planarization)。",assetPath:L.machines.cmp_polisher.path}]);class z{static show(t,e){const s=document.getElementById("modal-container");s&&(this.candidates.length===0&&this.generateCandidates(t.player.foundryTier),this.render(s,t,e))}static generateCandidates(t){const e=["LITHO","TRACK","FILM","ETCH","DIFF","CMP"];this.candidates=[];for(let s=0;s<4;s++){const a=this.FIRST_NAMES[Math.floor(Math.random()*this.FIRST_NAMES.length)],n=this.LAST_NAMES[Math.floor(Math.random()*this.LAST_NAMES.length)],r=e[Math.floor(Math.random()*e.length)];let i="Young Specialist",o=2e4,l=45e3,d="專精基礎機台操作，磨損累積 -10%，微影 k1 -0.01。適合操作 Tier 1~2。";const c=Math.random();t>=5&&c>.6?(i="Fellow",o=5e5,l=35e4,d="頂級半導體物理泰斗，磨損累積 -80%，微影 k1 -0.06，良率 +15%，可抵銷先進製程視窗損失！"):t>=3&&c>.4?(i="Senior Engineer",o=12e4,l=15e4,d="多年產線調機權威，磨損累積 -50%，微影 k1 -0.04，良率 +10%。適合操作 Tier 3~5。"):t>=2&&c>.3&&(i="Skilled Worker",o=5e4,l=75e3,d="熟練製程技師，磨損累積 -25%，微影 k1 -0.02，良率 +5%。適合操作 Tier 1~3。"),this.candidates.push({id:`CAN-${Date.now().toString(36).slice(-4)}-${s}`,name:`${a} ${n}`,rank:i,moduleSpecialty:r,signingBonus:o,salary:l,description:d})}}static render(t,e,s){var r;const a=e.staff.reduce((i,o)=>i+o.salary,0),n=((r=e.staff[0])==null?void 0:r.shiftMode)||"THREE_SHIFT";t.innerHTML=`
    ...
    `}static bindEvents(t,e,s){var r,i,o,l,d,c,p,h,u,m,b;const a=()=>{f.playClick(),t.innerHTML="",window.removeEventListener("keydown",n)},n=x=>{x.key==="Escape"&&a()};window.addEventListener("keydown",n),(r=document.getElementById("btn-close-hr"))==null||r.addEventListener("click",a),(i=document.getElementById("btn-back-hr"))==null||i.addEventListener("click",a),(o=document.getElementById("modal-backdrop-hr"))==null||o.addEventListener("click",x=>{x.target===document.getElementById("modal-backdrop-hr")&&a()}),(l=document.getElementById("tab-staff"))==null||l.addEventListener("click",()=>{f.playClick(),this.activeTab="STAFF",this.render(t,e,s)}),(d=document.getElementById("tab-schedule"))==null||d.addEventListener("click",()=>{f.playClick(),this.activeTab="SCHEDULE",this.render(t,e,s)}),(c=document.getElementById("tab-market"))==null||c.addEventListener("click",()=>{f.playClick(),this.activeTab="MARKET",this.render(t,e,s)}),(p=document.getElementById("btn-preset-balanced"))==null||p.addEventListener("click",()=>{f.playClick();const x=["DAY","SWING","NIGHT"];e.staff.forEach((y,T)=>{y.workShift=x[T%3]}),s(),this.render(t,e,s)}),(h=document.getElementById("btn-preset-day-only"))==null||h.addEventListener("click",()=>{f.playClick(),e.staff.forEach(x=>{x.workShift="DAY"}),s(),this.render(t,e,s)}),(u=document.getElementById("btn-preset-tpm-opt"))==null||u.addEventListener("click",()=>{f.playClick();const x=["DAY","SWING","NIGHT"];let y=0;e.staff.forEach(T=>{T.fatigue>=70?T.workShift="OFF":(T.workShift=x[y%3],y++)}),s(),this.render(t,e,s)}),t.querySelectorAll(".btn-shift-select").forEach(x=>{x.addEventListener("click",y=>{const T=y.currentTarget,k=T.getAttribute("data-staff-id"),E=T.getAttribute("data-shift"),v=e.staff.find(C=>C.id===k);!v||!E||(v.workShift=E,f.playClick(),s(),this.render(t,e,s))})}),(m=document.getElementById("btn-refresh-candidates"))==null||m.addEventListener("click",()=>{f.playClick(),this.generateCandidates(e.player.foundryTier),this.render(t,e,s)}),(b=document.getElementById("btn-toggle-shift"))==null||b.addEventListener("click",()=>{var T;f.playClick();const y=(((T=e.staff[0])==null?void 0:T.shiftMode)||"THREE_SHIFT")==="THREE_SHIFT"?"TWO_SHIFT":"THREE_SHIFT";e.staff.forEach(k=>{k.shiftMode=y,y==="TWO_SHIFT"?k.salary=Math.round(k.salary*.67):k.salary=Math.round(k.salary/.67)}),s(),this.render(t,e,s)}),t.querySelectorAll(".btn-hire-candidate").forEach(x=>{x.addEventListener("click",y=>{var C;const T=parseInt(y.currentTarget.getAttribute("data-index")||"0",10),k=this.candidates[T];if(!k)return;if(e.player.cash<k.signingBonus){alert("資金不足，無法支付簽約獎金！");return}e.player.cash-=k.signingBonus,A.recordSigningBonus(e,k.signingBonus),f.playCoinChime();const E=((C=e.staff[0])==null?void 0:C.shiftMode)||"THREE_SHIFT",v={id:`STF-${Date.now().toString(36).toUpperCase().slice(-5)}`,name:k.name,rank:k.rank,moduleSpecialty:k.moduleSpecialty,fatigue:20,shiftMode:E,workShift:"DAY",assignedMachineId:null,salary:k.salary};e.staff.push(v),this.candidates.splice(T,1),_.checkAchievements(e),s(),this.activeTab="STAFF",this.render(t,e,s)})}),t.querySelectorAll(".select-machine").forEach(x=>{x.addEventListener("change",y=>{const T=y.currentTarget.getAttribute("data-staff-id"),k=y.currentTarget.value||null,E=e.staff.find(v=>v.id===T);if(E){if(k){const v=e.staff.find(C=>C.assignedMachineId===k&&C.id!==T);v&&(v.assignedMachineId=null)}E.assignedMachineId=k,e.machines.forEach(v=>{v.id===k?v.assignedEngineerId=E.id:v.assignedEngineerId===E.id&&(v.assignedEngineerId=null)}),f.playClick(),_.checkAchievements(e),s(),this.render(t,e,s)}})}),t.querySelectorAll(".btn-fire-staff").forEach(x=>{x.addEventListener("click",y=>{const T=y.currentTarget.getAttribute("data-staff-id"),k=e.staff.findIndex(v=>v.id===T);if(k===-1)return;const E=e.staff[k];if(confirm(`確定要資遣工程師【${E.name}】嗎？`)){if(E.assignedMachineId){const v=e.machines.find(C=>C.id===E.assignedMachineId);v&&(v.assignedEngineerId=null)}e.staff.splice(k,1),f.playClick(),s(),this.render(t,e,s)}})})}}g(z,"activeTab","STAFF"),g(z,"candidates",[]),g(z,"FIRST_NAMES",["Alex","David","Sarah","Kevin","Emily","Michael","Jessica","James","Daniel","Rachel","Robert","Brian","Olivia","William","Sophia","Thomas","Emma","Chris","Grace","Eric","Lucas","Chloe","Nathan","Hannah"]),g(z,"LAST_NAMES",["Miller","Chen","Smith","Williams","Johnson","Taylor","Davis","Wilson","Anderson","White","Harris","Martin","Clark","Lewis","Walker","Hall","Young","Allen","King","Wright","Scott","Torres","Nguyen","Hill"]);class se{static getSpeedMultiplier(){return this.speedMultiplier}static init(t,e,s){const a=new URLSearchParams(window.location.search);(a.get("dev")==="true"||a.get("admin")==="foundry")&&this.toggle(t,e,s),window.addEventListener("keydown",r=>{r.ctrlKey&&r.shiftKey&&r.code==="KeyD"&&(r.preventDefault(),this.toggle(t,e,s))})}static toggle(t,e,s){this.isVisible=!this.isVisible;const a=document.getElementById("dev-console");if(a){if(!this.isVisible){a.innerHTML="";return}f.playClick(),this.render(a,t,e,s)}}static render(t,e,s,a){var n,r,i,o;t.innerHTML=`
    ...
    `,this.bindEvents(t,e,s,r.btnPrimaryAction)}static bindEvents(t,e,s,a){var i,o,l,d,c;const n=()=>{f.playClick(),t.innerHTML="",K.markCompleted(e),s()};(i=document.getElementById("btn-close-tutorial"))==null||i.addEventListener("click",n),(o=document.getElementById("btn-skip-tutorial-all"))==null||o.addEventListener("click",n);const r=t.querySelector(".modal-backdrop");r==null||r.addEventListener("click",p=>{p.target===r&&n()}),(l=document.getElementById("btn-tutorial-prev"))==null||l.addEventListener("click",()=>{f.playClick(),this.currentStep=Math.max(0,this.currentStep-1),this.render(t,e,s)}),(d=document.getElementById("btn-tutorial-skip-production"))==null||d.addEventListener("click",()=>{if(f.playFanfare(),e.activeLots.length>0)for(const p of e.activeLots)p.currentStation="DIFF",p.status="COMPLETED",p.yieldMultiplier=.96;else{const p=e.activeOrders.length>0?e.activeOrders[0].id:"starter_demo";e.activeLots.push({lotId:`LOT-${Date.now().toString().slice(-4)}`,orderId:p,waferCount:25,currentStation:"DIFF",currentLayer:3,totalLayers:3,qTimeDeadline:null,yieldMultiplier:.95,status:"COMPLETED"})}s(),this.currentStep=3,this.render(t,e,s)}),(c=document.getElementById("btn-tutorial-action"))==null||c.addEventListener("click",()=>{f.playClick(),a==="next"?(this.currentStep=Math.min(this.totalSteps-1,this.currentStep+1),this.render(t,e,s)):a==="open_contract"?(t.innerHTML="",J.show(e,()=>s())):a==="open_wafer_map"?(t.innerHTML="",X.show(e,null,()=>s())):a==="finish"&&(K.markCompleted(e),f.playFanfare(),t.innerHTML="",s())})}};g(K,"currentStep",0),g(K,"totalSteps",5);let q=K;class be{static show(t,e){const s=document.getElementById("modal-container");s&&(A.ensureFinancialState(t),this.render(s,t,e))}static render(t,e,s){const a=A.ensureFinancialState(e);let n=a.today,r=a.dailyHistory,i="日收支分析",l=`現實同步: 📅 ${a.currentDateStr||A.getTodayDateString()} (今日進行中)`;this.activeTab==="WEEK"?(n=a.thisWeek,r=a.weeklyHistory,i="周收支分析",l=`現實同步: 📅 本周累計 (${A.getWeekString()})`):this.activeTab==="MONTH"&&(n=a.thisMonth,r=a.monthlyHistory,i="月收支分析",l=`現實同步: 📅 本月累計 (${A.getMonthString()})`);const d=A.generateCFOAdvisory(n,e),c=A.calculateCompanyNetWorth(e);t.innerHTML=`
    ...
    `,this.bindEvents(t,e,s)}static renderHistoryBars(t){if(t.length===0)return'<div class="text-center w-full py-10 text-slate-500 text-xs font-mono">暫無足夠歷史數據，產線持續運轉中...</div>';const e=Math.max(...t.map(s=>Math.max(s.revenue.totalRevenue,s.expenses.totalExpenses,Math.abs(s.netProfit))),1e5);return t.map((s,a)=>{const n=a===t.length-1,r=Math.min(100,Math.max(4,Math.round(s.revenue.totalRevenue/e*100))),i=Math.min(100,Math.max(4,Math.round(s.expenses.totalExpenses/e*100))),o=Math.min(100,Math.max(4,Math.round(Math.abs(s.netProfit)/e*100)));return`
      ...
      `}).join("")}static bindEvents(t,e,s){var r,i,o,l,d,c;const a=()=>{f.playClick(),t.innerHTML="",window.removeEventListener("keydown",n)},n=p=>{p.key==="Escape"&&a()};window.addEventListener("keydown",n),(r=document.getElementById("btn-close-finance"))==null||r.addEventListener("click",a),(i=document.getElementById("btn-back-finance"))==null||i.addEventListener("click",a),(o=document.getElementById("modal-backdrop-finance"))==null||o.addEventListener("click",p=>{p.target===document.getElementById("modal-backdrop-finance")&&a()}),(l=document.getElementById("tab-finance-day"))==null||l.addEventListener("click",()=>{f.playClick(),this.activeTab="DAY",this.render(t,e,s)}),(d=document.getElementById("tab-finance-week"))==null||d.addEventListener("click",()=>{f.playClick(),this.activeTab="WEEK",this.render(t,e,s)}),(c=document.getElementById("tab-finance-month"))==null||c.addEventListener("click",()=>{f.playClick(),this.activeTab="MONTH",this.render(t,e,s)})}}g(be,"activeTab","DAY");class Z{static show(t,e,s=!0){const a=document.getElementById("modal-container");if(!a)return;const n=N.getActiveUserProfile();this.selectedUserId=n.id,this.isEditingName=!1,this.isCreatingUser=!1,this.render(a,t,e,s)}static render(t,e,s,a){const n=N.getUserProfiles();!this.selectedUserId&&n.length>0&&(this.selectedUserId=n[0].id);const r=n.find(i=>i.id===this.selectedUserId)||n[0];t.innerHTML=`
    ...
    `,this.bindEvents(t,e,s,a)}static bindEvents(t,e,s,a){var i,o,l,d,c,p,h,u,m,b,x,y;const n=()=>{f.playClick(),t.innerHTML="",window.removeEventListener("keydown",r)},r=T=>{T.key==="Escape"&&a&&n()};window.addEventListener("keydown",r),a&&((i=document.getElementById("btn-close-login"))==null||i.addEventListener("click",n),(o=document.getElementById("btn-cancel-login"))==null||o.addEventListener("click",n),(l=document.getElementById("modal-backdrop-login"))==null||l.addEventListener("click",T=>{T.target===document.getElementById("modal-backdrop-login")&&n()})),t.querySelectorAll(".user-profile-item").forEach(T=>{T.addEventListener("click",k=>{const E=k.currentTarget.getAttribute("data-user-id");E&&(f.playClick(),this.selectedUserId=E,this.isEditingName=!1,this.isCreatingUser=!1,this.render(t,e,s,a))})}),(d=document.getElementById("btn-create-user-toggle"))==null||d.addEventListener("click",()=>{f.playClick(),this.isCreatingUser=!this.isCreatingUser,this.isEditingName=!1,this.render(t,e,s,a)}),(c=document.getElementById("btn-cancel-create"))==null||c.addEventListener("click",()=>{f.playClick(),this.isCreatingUser=!1,this.render(t,e,s,a)}),(p=document.getElementById("btn-confirm-create"))==null||p.addEventListener("click",()=>{const T=document.getElementById("input-new-username"),k=document.getElementById("input-new-company"),E=(T==null?void 0:T.value.trim())||"",v=(k==null?void 0:k.value.trim())||void 0;if(!E){alert("請輸入執行長姓名！");return}f.playCoinChime();const C=N.createUser(E,v);this.selectedUserId=C.id,this.isCreatingUser=!1,this.render(t,e,s,a)}),(h=document.getElementById("btn-rename-user-toggle"))==null||h.addEventListener("click",()=>{this.selectedUserId&&(f.playClick(),this.isEditingName=!this.isEditingName,this.isCreatingUser=!1,this.render(t,e,s,a))}),(u=document.getElementById("btn-cancel-rename"))==null||u.addEventListener("click",()=>{f.playClick(),this.isEditingName=!1,this.render(t,e,s,a)}),(m=document.getElementById("btn-confirm-rename"))==null||m.addEventListener("click",()=>{if(!this.selectedUserId)return;const T=document.getElementById("input-rename-username"),k=T==null?void 0:T.value.trim();if(!k){alert("名稱不能為空！");return}f.playClick(),N.renameUser(this.selectedUserId,k),this.isEditingName=!1,this.render(t,e,s,a)}),(b=document.getElementById("btn-delete-user"))==null||b.addEventListener("click",()=>{if(!this.selectedUserId)return;const T=N.getUserProfiles(),k=T.find(v=>v.id===this.selectedUserId);if(!k)return;if(T.length<=1){alert("這是唯一的玩家存檔，無法刪除！");return}if(!confirm(`確定要徹底刪除玩家【${k.name}】（${k.companyName}）的存檔嗎？此動作不可逆！`))return;f.playClick();const E=N.deleteUser(this.selectedUserId);if(!E.success){alert(E.message||"刪除失敗");return}this.selectedUserId=N.getActiveUserProfile().id,this.render(t,e,s,a)}),(x=document.getElementById("btn-factory-reset-login"))==null||x.addEventListener("click",()=>{f.playClick(),confirm(`⚠️ 警告：整機資料重置將徹底清除本裝置上的所有玩家帳號、廠房進度、財務紀錄與暫存設定，無法復原！

確定要刪除裝置全部資料使玩家能從零開始重新體驗嗎？`)&&(N.factoryResetAllData(),alert("整機資料已全數清除！即將重新啟動遊戲。"),window.location.reload())}),(y=document.getElementById("btn-confirm-play"))==null||y.addEventListener("click",()=>{if(!this.selectedUserId)return;f.playCoinChime();const T=N.switchActiveUser(this.selectedUserId);if(!T){alert("載入該存檔失敗，將進入預設存檔！");return}n(),s(T)})}}g(Z,"selectedUserId",null),g(Z,"isEditingName",!1),g(Z,"isCreatingUser",!1);class Te{constructor(t,e,s,a,n){g(this,"topHUD");g(this,"state");g(this,"onStateUpdated");g(this,"onUserSwitched");g(this,"onTogglePlanner");g(this,"isPlannerActive",!1);g(this,"currentPlannerTool","MOVE_MACHINE");this.state=t,this.onStateUpdated=s,this.onUserSwitched=a,this.onTogglePlanner=n,this.topHUD=new ye("top-hud",{onOpenContracts:()=>this.openContracts(),onOpenStore:()=>this.openStore(),onOpenHR:()=>this.openHR(),onOpenQuests:()=>this.openQuests(),onOpenAchievements:()=>this.openAchievements(),onOpenAdvisory:()=>this.openAdvisory(),onToggleMES:r=>this.onStateUpdated(),onOpenSaveModal:()=>this.openSaveModal(),onOpenWaferMap:()=>this.openWaferMap(),onOpenTutorial:()=>this.openTutorial(),onOpenFinance:()=>this.openFinancialReport(),onOpenLogin:()=>this.openUserLogin(),onOpenPlanner:()=>this.togglePlannerMode(),onOpenTechTree:()=>this.openTechTree(),onOpenFactoryReset:()=>this.openFactoryResetConfirmation()}),se.init(t,e,s),!t.player.companyName||t.player.companyName==="矽島先進半導體"?ie.show(t,()=>{this.render(),this.onStateUpdated(),q.isCompleted(this.state)||this.openTutorial()}):q.isCompleted(this.state)||setTimeout(()=>this.openTutorial(),400),this.render()}render(){this.topHUD.render(this.state),this.renderOrderStatusWidget()}renderOrderStatusWidget(){var T,k,E;const t=document.getElementById("hud-widgets");if(!t)return;if(this.state.activeOrders.length===0){t.innerHTML=`
      ...
      `,(T=document.getElementById("hud-order-status-bar"))==null||T.addEventListener("click",()=>{f.playClick(),this.openContracts()});return}const e=this.state.activeOrders[0],s=this.state.activeLots.filter(v=>v.orderId===e.id),a=s.find(v=>v.status==="PROCESSING")||s[0],n=e.goodDiesDelivered,r=e.totalDies,i=Math.min(100,Math.round(n/Math.max(1,r)*100)),o=a?a.currentLayer:1,l=a?a.totalLayers:e.layerCount||10,d=a?a.currentStation:"FILM",c=a?a.litSubStep:void 0;let p=d;d==="LIT"&&(c==="COAT"||c==="DEVELOP"?p="TRACK":p="LITHO");const h=this.state.machines.find(v=>v.category===p);let u="";if(a&&a.qTimeDeadline){const v=Math.max(0,Math.round(a.qTimeDeadline-this.state.gameTime));u=`
      ...
      `}const m=this.state.unlockedFeatures.cmp,b=[{key:"FILM",name:"薄膜沉積",en:"FILM",icon:"🧪",match:(v,C)=>v==="FILM"},{key:"TRACK_COAT",name:"光阻塗膠",en:"TRACK",icon:"🌀",match:(v,C)=>v==="LIT"&&C==="COAT"},{key:"LITHO",name:"微影曝光",en:"LITHO",icon:"🔬",match:(v,C)=>v==="LIT"&&C==="EXPOSE"},{key:"TRACK_DEV",name:"顯影烘烤",en:"DEVELOP",icon:"♨️",match:(v,C)=>v==="LIT"&&C==="DEVELOP"},{key:"ETCH",name:"電漿蝕刻",en:"ETCH",icon:"⚡",match:(v,C)=>v==="ETCH"},{key:"DIFF",name:"高溫擴散",en:"DIFF",icon:"🔥",match:(v,C)=>v==="DIFF"}];m&&b.push({key:"CMP",name:"平坦化研磨",en:"CMP",icon:"💎",match:v=>v==="CMP"});let x=-1;a&&a.status==="PROCESSING"&&(x=b.findIndex(v=>v.match(a.currentStation,a.litSubStep)));const y=e.goodDiesDelivered>=e.totalDies||s.length>0&&s.every(v=>v.status==="COMPLETED");t.innerHTML=`
      <div id="hud-order-status-bar" class="hud-order-bar cursor-pointer" title="點擊檢視訂單詳情與批次資訊">
        ...
        <div class="flex items-center gap-1.5 w-full overflow-x-auto pt-1">
          ${b.map((v,C)=>{let O="step-waiting",F="待加工",w="text-slate-500";if(y)O="step-completed",F="✓ 完工",w="text-emerald-400";else if(C<x)O="step-completed",F="✓ 完工",w="text-emerald-400";else if(C===x){const V=(a==null?void 0:a.stationProgressSeconds)||0,Q=(a==null?void 0:a.stationRequiredSeconds)||10;O="step-active",F=`⚡ ${V}/${Q}s`,w="text-cyan-300 font-bold"}const P=v.key.startsWith("TRACK")?"TRACK":v.key==="LITHO"?"LITHO":v.key,H=this.state.machines.find(V=>V.category===P),Y=(H==null?void 0:H.status)==="EXPLODED";return`
              <div class="pipeline-step ${O} ${Y?"border-red-500/80 bg-red-950/30":""}" title="${v.name} (${v.en})${H?" - "+H.name:""}">
    ...
    `,(e=document.getElementById("btn-planner-move"))==null||e.addEventListener("click",r=>{r.stopPropagation(),f.playClick(),this.setPlannerTool("MOVE_MACHINE")}),(s=document.getElementById("btn-planner-yellow"))==null||s.addEventListener("click",r=>{r.stopPropagation(),f.playClick(),this.setPlannerTool("PAINT_YELLOW")}),(a=document.getElementById("btn-planner-white"))==null||a.addEventListener("click",r=>{r.stopPropagation(),f.playClick(),this.setPlannerTool("PAINT_WHITE")}),(n=document.getElementById("btn-planner-exit"))==null||n.addEventListener("click",r=>{r.stopPropagation(),f.playClick(),this.togglePlannerMode(!1),this.onStateUpdated()})}openContracts(){J.show(this.state,()=>{this.render(),this.onStateUpdated()})}openStore(){j.show(this.state,()=>{this.render(),this.onStateUpdated()})}openHR(){z.show(this.state,()=>{this.render(),this.onStateUpdated()})}openQuests(){we.show(this.state,()=>{this.render(),this.onStateUpdated()})}openAchievements(){fe.show(this.state,()=>{this.render(),this.onStateUpdated()})}openAdvisory(){ve.show(this.state,()=>{this.openStore()},()=>{this.openHR()})}openWaferMap(t){X.show(this.state,t,()=>{this.render(),this.onStateUpdated()})}openLayerAllocation(t){te.show(this.state,t,()=>{this.render(),this.onStateUpdated()})}updateState(t){this.state=t,this.render()}openFinancialReport(){be.show(this.state,()=>{this.render(),this.onStateUpdated()})}openTechTree(){re.show(this.state,()=>{this.render(),this.onStateUpdated()})}openUserLogin(){Z.show(this.state,t=>{var e;this.state=t,(e=this.onUserSwitched)==null||e.call(this,t),this.render(),this.onStateUpdated(),q.isCompleted(t)||setTimeout(()=>this.openTutorial(),400)})}openTutorial(t){q.show(this.state,()=>{this.render(),this.onStateUpdated()},t)}openSaveModal(){var a,n,r,i,o,l;const t=document.getElementById("modal-container");if(!t)return;const e=d=>{d.key==="Escape"&&(t.innerHTML="",window.removeEventListener("keydown",e))};window.addEventListener("keydown",e);const s=()=>{f.playClick(),t.innerHTML="",window.removeEventListener("keydown",e)};t.innerHTML=`
    ...
    `,(a=document.getElementById("btn-close-save-modal"))==null||a.addEventListener("click",s),(n=document.getElementById("btn-return-save"))==null||n.addEventListener("click",s),(r=document.getElementById("modal-backdrop-save"))==null||r.addEventListener("click",d=>{d.target===d.currentTarget&&s()}),(i=document.getElementById("btn-export-save"))==null||i.addEventListener("click",()=>{f.playClick();const d=N.exportSaveToJson(this.state),c=new Blob([d],{type:"application/json"}),p=URL.createObjectURL(c),h=document.createElement("a");h.href=p,h.download=`silicon_tycoon_save_${Date.now()}.json`,h.click(),URL.revokeObjectURL(p)}),(o=document.getElementById("btn-import-save"))==null||o.addEventListener("click",()=>{var d;(d=document.getElementById("file-import-save"))==null||d.click()}),(l=document.getElementById("file-import-save"))==null||l.addEventListener("change",d=>{var p;const c=(p=d.target.files)==null?void 0:p[0];if(c){const h=new FileReader;h.onload=u=>{var x;const m=(x=u.target)==null?void 0:x.result,b=N.importSaveFromJson(m);b.success&&b.state?(N.saveToLocalStorage(b.state),alert("存檔匯入成功！即將重新載入遊戲。"),window.location.reload()):alert(`匯入失敗: ${b.error}`)},h.readAsText(c)}})}showNotice(t){const e=document.createElement("div");e.className="fixed top-20 left-1/2 -translate-x-1/2 z-50 px-4 py-2 rounded-lg bg-slate-900/95 border border-cyan-500/50 text-cyan-200 text-xs font-medium shadow-2xl animate-bounce",e.innerText=t,document.body.appendChild(e),setTimeout(()=>e.remove(),2500)}openFactoryResetConfirmation(){var a,n,r;const t=document.getElementById("modal-container");if(!t)return;f.playClick();const e=()=>{t.innerHTML="",window.removeEventListener("keydown",s)},s=i=>{i.key==="Escape"&&e()};window.addEventListener("keydown",s),t.innerHTML=`
    ...
    `,(a=document.getElementById("btn-cancel-factory-reset"))==null||a.addEventListener("click",e),(n=document.getElementById("modal-backdrop-reset"))==null||n.addEventListener("click",i=>{i.target===document.getElementById("modal-backdrop-reset")&&e()}),(r=document.getElementById("btn-confirm-factory-reset"))==null||r.addEventListener("click",()=>{f.playClick(),N.factoryResetAllData(),alert("全機資料已全數清空！即將重新整理進入全新遊戲。"),window.location.reload()})}}class ke{static show(t,e,s){const a=document.getElementById("modal-container");a&&this.render(a,t,e,s)}static render(t,e,s,a){const n=L.machines[e.modelId],r=(n==null?void 0:n.path)||"./assets/machines/litho_contact.png",i=j.STORE_CATALOG.find(w=>w.modelId===e.modelId),o=i?Math.round(i.price*.15):3e5,l=i?Math.round(i.price*.4):8e5,d=Math.round(e.wear),c=s.staff.find(w=>w.id===e.assignedEngineerId);let p=!1,h=!1;c&&(p=B.checkTPMConditions(e,c).isTPMActive,h=B.checkExplosionRisk(e,c).hasRisk);let u=null,m=null;if(e.category==="LITHO"){const w=W.OPTICAL_CATALOG[e.modelId];if(w){const P=W.calculateEffectiveK1(s.player.unlockedK1,e.wear,c||null);u={effectiveK1:P.effectiveK1,formula:`Base(${P.k1Tech.toFixed(2)}) + 磨損(+${P.deltaWear.toFixed(3)}) - 調校(-${P.deltaEngineer.toFixed(2)}) + 疲勞(+${P.deltaFatigue.toFixed(2)})`},m=Math.round(P.effectiveK1*(w.wavelengthNm/w.numericalAperture))}}const b=e.category==="LITHO",x=s.machines.filter(w=>w.category==="TRACK"&&w.status!=="EXPLODED"),y=e.pairedTrackIds||[],T=D.BASE_THROUGHPUT_BY_TIER.LIT[e.tier]||10;let k=0;for(const w of y){const P=s.machines.find(H=>H.id===w);P&&(k+=D.BASE_THROUGHPUT_BY_TIER.TRACK[P.tier]||6)}const E=b&&(y.length===0||k<T),v=s.activeLots.filter(w=>w.status!=="PROCESSING"?!1:e.category==="TRACK"?w.currentStation==="LIT"&&(w.litSubStep==="COAT"||w.litSubStep==="DEVELOP"):e.category==="LITHO"?w.currentStation==="LIT"&&w.litSubStep==="EXPOSE":w.currentStation===e.category),C=v.length>0,O=D.isMachineInYellowRoom(e,s.facility.yellowRoomTiles),F=e.category==="LITHO"||e.category==="TRACK";t.innerHTML=`
      <div id="modal-backdrop-machine" class="modal-backdrop">
        <div class="modal-content glass-panel glass-panel-glow max-w-2xl max-h-[90vh] flex flex-col text-slate-100 p-0 overflow-hidden animate-fadeIn">
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                <div class="flex items-center gap-2">
                  ...
                  <span class="px-2 py-0.5 rounded text-[10px] font-mono ${C||e.status==="PROCESSING"?"bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 animate-pulse":e.status==="MAINTENANCE"?"bg-amber-500/20 text-amber-300 border border-amber-500/30":e.status==="EXPLODED"?"bg-red-600 text-white font-bold animate-bounce":"bg-slate-800 text-slate-300"}">
                    ${C?"⚡ 加工中 (PROCESSING)":e.status}
                  </span>
                </div>
                <div class="text-xs text-slate-400 font-mono mt-0.5">
          ...
          <div class="modal-body p-6 overflow-y-auto flex-1 space-y-4 text-xs">
            ...
            <div class="p-3.5 rounded-xl bg-slate-900/80 border ${C?"border-cyan-500/40 bg-cyan-950/20":"border-slate-800"} space-y-2">
              <div class="flex items-center justify-between">
                <span class="font-bold text-white flex items-center gap-1.5">
                  <span>⚙️</span>
                  <span>生產加工狀態 (Production Status)</span>
                </span>
                <span class="font-mono text-xs ${C?"text-cyan-300 font-bold animate-pulse":"text-slate-400"}">
                  ${C?"⚡ 正在加工批次":"待命中 (Ready / IDLE)"}
                </span>
              </div>
              ${C?`
            ...
            ${b?`
              <div class="p-3.5 rounded-xl bg-slate-900/80 border ${E?"border-amber-500/40":"border-slate-800"} space-y-3">
                <div class="flex items-center justify-between">
                  <span class="font-bold text-white flex items-center gap-1.5">
                    <span>🌀</span>
                ...
                `:`
                  <div class="space-y-1.5 max-h-36 overflow-y-auto pr-1">
                    ${x.map(w=>{const P=y.includes(w.id),H=D.BASE_THROUGHPUT_BY_TIER.TRACK[w.tier]||6;return`
    ...
    `,this.bindEvents(t,e,s,a)}static bindEvents(t,e,s,a){var i,o,l,d,c,p;const n=()=>{f.playClick(),t.innerHTML="",window.removeEventListener("keydown",r)},r=h=>{h.key==="Escape"&&n()};window.addEventListener("keydown",r),(i=document.getElementById("btn-close-machine-panel"))==null||i.addEventListener("click",n),(o=document.getElementById("btn-back-machine"))==null||o.addEventListener("click",n),(l=document.getElementById("modal-backdrop-machine"))==null||l.addEventListener("click",h=>{h.target===document.getElementById("modal-backdrop-machine")&&n()}),t.querySelectorAll(".chk-paired-track").forEach(h=>{h.addEventListener("change",()=>{f.playClick();const u=[];t.querySelectorAll(".chk-paired-track:checked").forEach(m=>{const b=m.getAttribute("data-track-id");b&&u.push(b)}),e.pairedTrackIds=u,a(),this.render(t,e,s,a)})}),(d=document.getElementById("select-station-engineer"))==null||d.addEventListener("change",h=>{f.playClick();const u=h.target.value||null;if(e.assignedEngineerId){const m=s.staff.find(b=>b.id===e.assignedEngineerId);m&&(m.assignedMachineId=null)}if(e.assignedEngineerId=u,u){const m=s.staff.find(b=>b.id===u);if(m){if(m.assignedMachineId){const b=s.machines.find(x=>x.id===m.assignedMachineId);b&&(b.assignedEngineerId=null)}m.assignedMachineId=e.id}}a(),this.render(t,e,s,a)}),(c=document.getElementById("btn-machine-overhaul"))==null||c.addEventListener("click",()=>{const h=j.STORE_CATALOG.find(m=>m.modelId===e.modelId),u=h?Math.round(h.price*.15):3e5;if(s.player.cash<u){alert("資金不足，無法執行大修！");return}s.player.cash-=u,A.recordMaintenance(s,u),e.wear=0,e.status="IDLE",f.playClick(),a(),this.render(t,e,s,a)}),(p=document.getElementById("btn-machine-decommission"))==null||p.addEventListener("click",()=>{const h=j.STORE_CATALOG.find(b=>b.modelId===e.modelId),u=h?Math.round(h.price*.4):8e5;if(!confirm(`確定要將設備【${e.name}】除役報廢嗎？回收變賣金額 NT$ ${u.toLocaleString()}`))return;if(e.assignedEngineerId){const b=s.staff.find(x=>x.id===e.assignedEngineerId);b&&(b.assignedMachineId=null)}const m=s.machines.findIndex(b=>b.id===e.id);m!==-1&&s.machines.splice(m,1),s.player.cash+=u,f.playCoinChime(),t.innerHTML="",a()})}}class Se{constructor(){g(this,"state",N.loadFromLocalStorage()||N.createDefaultSave());g(this,"phaserGame");g(this,"cleanroomScene");g(this,"uiManager");g(this,"autoSaveTimer",0);console.log("🚀 正在啟動 Silicon Tycoon: Foundry Master 矽島霸權...");const t=Date.now();if(this.state.lastOnlineTimestamp&&t-this.state.lastOnlineTimestamp>60*1e3){const a=N.calculateOfflineProgress(this.state,t);console.log("離線營運結算戰報:",a)}const e=new Date().toISOString().split("T")[0];this.state.questState=G.refreshDailyQuests(this.state.questState,this.state.player,this.state.unlockedFeatures,e),_.checkAchievements(this.state);const s={type:Phaser.AUTO,parent:"game-container",width:window.innerWidth,height:window.innerHeight,backgroundColor:"#070b14",render:{antialias:!0,pixelArt:!1},scale:{mode:Phaser.Scale.RESIZE,autoCenter:Phaser.Scale.CENTER_BOTH}};this.phaserGame=new Phaser.Game(s),this.cleanroomScene=new ee,this.phaserGame.scene.add(ee.KEY,this.cleanroomScene,!0,{saveGame:this.state,onMachineClick:a=>this.handleMachineClick(a),onStateUpdate:()=>this.onStateChanged()}),this.uiManager=new Te(this.state,a=>{console.log(`開發者調整遊戲速度至: ${a}x`)},()=>{this.onStateChanged()},a=>{this.state=a,this.cleanroomScene.updateState(this.state),this.uiManager.updateState(this.state),this.onStateChanged()},(a,n)=>{this.cleanroomScene.setPlannerMode(a,n)}),setInterval(()=>this.simulationTick(),1e3)}simulationTick(){const t=se.getSpeedMultiplier();for(let s=0;s<t;s++){this.state.gameTime+=1,A.tickSimulation(this.state,1);const a=new Map(this.state.staff.map(i=>[i.id,i]));for(const i of this.state.machines){if(i.status==="EXPLODED")continue;const o=i.assignedEngineerId?a.get(i.assignedEngineerId):null,l=B.updateMachineHealth(i,o,1);i.wear=l.newWear,l.breakdownOccurred&&(i.status=l.isExploded?"EXPLODED":"MAINTENANCE")}for(const i of this.state.staff)if(i.workShift==="OFF")i.fatigue=Math.max(0,i.fatigue-.25);else{const o=i.shiftMode==="TWO_SHIFT"?.05:.02,l=i.workShift==="NIGHT"?1.5:1;i.fatigue=Math.min(100,i.fatigue+o*l)}const n=new Set;for(const i of this.state.activeLots)i.status==="PROCESSING"&&(i.currentStation==="LIT"?i.litSubStep==="COAT"||i.litSubStep==="DEVELOP"?n.add("TRACK"):n.add("LITHO"):n.add(i.currentStation));for(const i of this.state.machines)i.status==="EXPLODED"||i.status==="MAINTENANCE"||(n.has(i.category)?i.status="PROCESSING":i.status="IDLE");const r=[];for(const i of this.state.activeLots)if(i.status==="PROCESSING"&&(i.stationProgressSeconds===void 0&&(i.stationProgressSeconds=0),i.stationRequiredSeconds||(i.stationRequiredSeconds=D.getStationRequiredSeconds(i.currentStation,i.litSubStep)),i.stationProgressSeconds+=1,i.stationProgressSeconds>=i.stationRequiredSeconds)){i.stationProgressSeconds=0;const o=this.state.activeOrders.find(c=>c.id===i.orderId),l=o?o.nodeNm:1e4,d=D.advanceLotStation(i,this.state.unlockedFeatures.cmp,l,this.state.player.unlockedCleanroomClass,this.state.gameTime,this.state.machines,this.state.facility.yellowRoomTiles);if(i.stationRequiredSeconds=D.getStationRequiredSeconds(i.currentStation,i.litSubStep),d.isLotCompleted&&(i.status="COMPLETED",o)){const c=this.state.activeLots.filter(u=>u.orderId===o.id),p=Math.round(o.totalDies/Math.max(1,c.length)*i.yieldMultiplier);o.goodDiesDelivered=Math.min(o.totalDies,o.goodDiesDelivered+p),this.state.rollingYieldHistory.push(Number(i.yieldMultiplier.toFixed(3))),this.state.rollingYieldHistory.length>5&&this.state.rollingYieldHistory.shift(),G.onWaferDelivered(this.state.questState,p>0?i.waferCount:0),c.every(u=>u.status==="COMPLETED")&&!r.includes(o)&&r.push(o)}}if(this.state.unlockedFeatures.mesAutoDispatch&&r.length>0)for(const i of r){const o=U.settleOrderPayout(i,i.goodDiesDelivered,this.state.player,this.state.staff,0,this.state.clawbackDebt);this.state.player.cash+=o.netPayout,A.recordWaferSales(this.state,o.netPayout),this.state.clawbackDebt=o.remainingDebt,this.state.player.popularity=Math.min(100,this.state.player.popularity+1);const d=this.state.activeLots.filter(c=>c.orderId===i.id).reduce((c,p)=>c+(p.waferCount||25),0)||25;this.state.player.totalOrdersFulfilled=(this.state.player.totalOrdersFulfilled||0)+1,this.state.player.totalWafersDelivered=(this.state.player.totalWafersDelivered||0)+d,G.onOrderFulfilled(this.state.questState),this.state.activeOrders=this.state.activeOrders.filter(c=>c.id!==i.id),this.state.activeLots=this.state.activeLots.filter(c=>c.orderId!==i.id)}}_.checkAchievements(this.state).newlyUnlocked.length>0&&this.uiManager.render(),this.autoSaveTimer+=1,this.autoSaveTimer>=10&&(this.autoSaveTimer=0,N.saveToLocalStorage(this.state)),this.uiManager.render(),this.cleanroomScene.updateState(this.state)}handleMachineClick(t){ke.show(t,this.state,()=>this.onStateChanged())}onStateChanged(){N.saveToLocalStorage(this.state),this.cleanroomScene.updateState(this.state),this.uiManager.render()}}window.addEventListener("DOMContentLoaded",()=>{new Se});
