var ae=Object.defineProperty;var ie=(I,t,e)=>t in I?ae(I,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):I[t]=e;var g=(I,t,e)=>ie(I,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function e(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(a){if(a.ep)return;a.ep=!0;const i=e(a);fetch(a.href,i)}})();class O{static getRequiredRankWeight(t){return t<=2?1:t<=4?2:t===5?3:4}static checkTPMConditions(t,e){if(!e)return{isTPMActive:!1,reason:"未指派工程師進駐"};if(e.moduleSpecialty!==t.category)return{isTPMActive:!1,reason:`專長不符！該機台為 ${t.category}，工程師專精為 ${e.moduleSpecialty}`};const s=this.getRequiredRankWeight(t.tier),a=this.RANK_WEIGHT[e.rank];return a<s?{isTPMActive:!1,reason:`職等不足！機台需等級 ${s}，該工程師為 ${e.rank} (等級 ${a})`}:e.workShift==="OFF"?{isTPMActive:!1,reason:"該工程師目前處於排休狀態 (OFF)，機台暫無在線工程師值班"}:e.fatigue>=50?{isTPMActive:!1,reason:`工程師疲勞度過高 (${e.fatigue} >= 50)，在線預防保養中斷`}:e.shiftMode!=="THREE_SHIFT"?{isTPMActive:!1,reason:"非三班輪調制（超時兩班制疲勞將持續爬升，無法達成 24H 永久零故障保障）"}:{isTPMActive:!0,reason:"🛡️ 滿足專長相符、資歷合規、在線值勤且低疲勞，享有 24 小時不停機零故障保障！"}}static checkExplosionRisk(t,e){if(!e)return{hasRisk:!1,rankDiff:0};const s=this.getRequiredRankWeight(t.tier),a=this.RANK_WEIGHT[e.rank],i=s-a;return{hasRisk:i>=2,rankDiff:i}}static updateMachineHealth(t,e,s=1){const{isTPMActive:a}=this.checkTPMConditions(t,e);if(a){const h=Math.min(t.wear,5),c=100-h;return{newWear:h,healthPercent:c,isTPMActive:!0,breakdownOccurred:!1,isExploded:!1}}let r=Math.min(100,t.wear+.005*s);const n=100-r,o=(r/100)**2*.05*(s/60),l=Math.random()<o;let d=!1;if(l&&e){const h=this.getRequiredRankWeight(t.tier),c=this.RANK_WEIGHT[e.rank];h-c>=2&&Math.random()<.25&&(d=!0)}return{newWear:Number(r.toFixed(2)),healthPercent:Number(n.toFixed(2)),isTPMActive:!1,breakdownOccurred:l,isExploded:d}}static calculateOverhaulCost(t){return Math.round(t*.15)}}g(O,"RANK_WEIGHT",{"Young Specialist":1,"Skilled Worker":2,"Senior Engineer":3,Fellow:4});class F{static calculateEffectiveK1(t,e,s){let a=.8;switch(t){case"BASE":a=.8;break;case"CAR":a=.65;break;case"OPC":a=.5;break;case"PSM":a=.38;break;case"SAQP":a=.28;break}const r=Math.max(0,Math.min(100,e))/100*.05;let n=0,o=0;if(s&&s.moduleSpecialty==="LITHO")if(s.fatigue>=80)n=0,o=.03;else switch(s.rank){case"Young Specialist":n=.01;break;case"Skilled Worker":n=.02;break;case"Senior Engineer":n=.04;break;case"Fellow":n=.06;break}let l=a+r-n+o;return l=Math.max(t==="SAQP"?.15:.25,Math.min(.95,l)),{effectiveK1:Number(l.toFixed(3)),k1Tech:a,deltaWear:Number(r.toFixed(3)),deltaEngineer:Number(n.toFixed(3)),deltaFatigue:Number(o.toFixed(3))}}static calculateEffectiveCD(t,e,s,a){const i=this.OPTICAL_CATALOG[t];if(!i)return 999999;const{effectiveK1:r}=this.calculateEffectiveK1(e,s,a),n=r*(i.wavelengthNm/i.numericalAperture);return Math.round(n)}static validateResolution(t,e,s,a,i){if(!this.OPTICAL_CATALOG[t])return{canResolve:!1,effectiveCD:999999,effectiveK1:.8,reason:"未知的微影機台型號"};const{effectiveK1:n}=this.calculateEffectiveK1(s,a,i),o=this.calculateEffectiveCD(t,s,a,i);return o>e?{canResolve:!1,effectiveCD:o,effectiveK1:n,reason:`光學解析度不足！當前極限 CD 為 ${o}nm，無法解析目標 ${e}nm 製程（磨損或人員疲勞導致 k1 劣化至 ${n}）。`}:{canResolve:!0,effectiveCD:o,effectiveK1:n}}static getProcessWindowPenalty(t){if(t>=.38)return 0;const e=(.38-t)*.5;return Math.max(0,Math.min(.25,e))}}g(F,"OPTICAL_CATALOG",{litho_contact:{modelId:"litho_contact",name:"Contact Aligner (接觸式微影機)",wavelengthNm:436,numericalAperture:.116,baseRayleighLimitNm:3007,unlockTier:1,baseCost:25e5,baseMttrSec:10},litho_projection:{modelId:"litho_projection",name:"1x Projection Aligner (1:1 投影微影機)",wavelengthNm:436,numericalAperture:.194,baseRayleighLimitNm:1798,unlockTier:1,baseCost:6e6,baseMttrSec:15},litho_gline:{modelId:"litho_gline",name:"G-Line Stepper (步進縮小曝光機)",wavelengthNm:436,numericalAperture:.35,baseRayleighLimitNm:997,unlockTier:2,baseCost:18e6,baseMttrSec:20},litho_iline:{modelId:"litho_iline",name:"I-Line Stepper (高壓汞燈微影機)",wavelengthNm:365,numericalAperture:.5,baseRayleighLimitNm:584,unlockTier:3,baseCost:35e6,baseMttrSec:30},litho_krf:{modelId:"litho_krf",name:"KrF DUV Scanner (準分子雷射掃描機)",wavelengthNm:248,numericalAperture:.7,baseRayleighLimitNm:283,unlockTier:4,baseCost:85e6,baseMttrSec:40},litho_arfdry:{modelId:"litho_arfdry",name:"ArF Dry Scanner (氟化氬乾式微影機)",wavelengthNm:193,numericalAperture:.85,baseRayleighLimitNm:182,unlockTier:4,baseCost:18e7,baseMttrSec:50},litho_arfi:{modelId:"litho_arfi",name:"ArFi Immersion TWINSCAN (雙工件台浸潤微影機)",wavelengthNm:193,numericalAperture:1.35,baseRayleighLimitNm:114,unlockTier:5,baseCost:45e7,baseMttrSec:60},litho_euv:{modelId:"litho_euv",name:"EUV Scanner (極紫外真空微影機)",wavelengthNm:13.5,numericalAperture:.33,baseRayleighLimitNm:33,unlockTier:6,baseCost:25e8,baseMttrSec:90},litho_highna:{modelId:"litho_highna",name:"High-NA EUV Scanner (變形高數值孔徑微影機)",wavelengthNm:13.5,numericalAperture:.55,baseRayleighLimitNm:20,unlockTier:6,baseCost:6e9,baseMttrSec:120}});class N{static isTileInYellowRoom(t,e,s){return s&&s.length>0?s.some(a=>a.x===t&&a.y===e):e<=3&&t>=3&&t<=7}static isMachineInYellowRoom(t,e){return this.isTileInYellowRoom(t.gridX,t.gridY,e)}static getStationRequiredSeconds(t,e,s,a){let i=this.BASE_STATION_DURATION_SEC[t]||10;return t==="LIT"&&e&&(i=this.LIT_SUBSTEP_DURATION_SEC[e]||10),s&&(i-=Math.min(2,(s.tier-1)*.5),s.wear>50&&(i+=Math.round((s.wear-50)/50*3))),a&&s&&a.moduleSpecialty===s.category&&a.fatigue<80&&(i=Math.max(4,Math.round(i*.85))),Math.max(4,Math.round(i))}static getStationSequence(t){return t?["FILM","LIT","ETCH","DIFF","CMP"]:["FILM","LIT","ETCH","DIFF"]}static calculateEffectiveQTimeSec(t,e,s,a){let i=45;t==="LIT"&&e==="ETCH"?i=45:t==="ETCH"&&e==="DIFF"?i=60:t==="CMP"&&(i=45);let r=1;a.includes("1000")&&!a.includes("10000")?r=1.15:a.includes("100")&&!a.includes("1000")?r=1.3:a.includes("1")&&!a.includes("10")&&(r=1.5);let n=1;return s>=1e3?n=1.5:s<=28&&(n=.8),Math.round(i*r*n)}static checkQTimeStatus(t,e,s=5e4){if(!t.qTimeDeadline)return{isOverdue:!1,overdueSeconds:0,isFatal:!1,canRework:!1,reworkCost:0,penaltyYieldRatio:1,urgencyLevel:"SAFE",remainingSeconds:999};const a=t.qTimeDeadline-e,i=t.currentStation==="ETCH";if(a>15)return{isOverdue:!1,overdueSeconds:0,isFatal:!1,canRework:!1,reworkCost:0,penaltyYieldRatio:1,urgencyLevel:"SAFE",remainingSeconds:a};if(a>0)return{isOverdue:!1,overdueSeconds:0,isFatal:!1,canRework:!1,reworkCost:0,penaltyYieldRatio:1,urgencyLevel:"WARNING",remainingSeconds:a};const r=Math.abs(a);return r<=15?{isOverdue:!0,overdueSeconds:r,isFatal:!1,canRework:!1,reworkCost:0,penaltyYieldRatio:.65,urgencyLevel:"CRITICAL",remainingSeconds:0}:i?{isOverdue:!0,overdueSeconds:r,isFatal:!0,canRework:!0,reworkCost:s,penaltyYieldRatio:0,urgencyLevel:"EXPIRED",remainingSeconds:0}:{isOverdue:!0,overdueSeconds:r,isFatal:!0,canRework:!1,reworkCost:0,penaltyYieldRatio:0,urgencyLevel:"EXPIRED",remainingSeconds:0}}static executeReworkLot(t,e){return t.currentStation="LIT",t.litSubStep="COAT",t.qTimeDeadline=null,t.status="PROCESSING",t.yieldMultiplier=Math.max(.85,t.yieldMultiplier*.95),{success:!0,message:`成功救回批次 ${t.lotId}！耗費溶劑費 NT$ ${e.toLocaleString()}，已退回黃光塗膠站重新加工。`}}static advanceLotStation(t,e,s,a,i,r,n){const o=this.getStationSequence(e);if(r&&n&&t.currentStation==="LIT"){const d=r.find(c=>c.category==="LITHO"),h=r.find(c=>c.category==="TRACK");(t.litSubStep==="EXPOSE"&&d&&!this.isMachineInYellowRoom(d,n)||(t.litSubStep==="COAT"||t.litSubStep==="DEVELOP")&&h&&!this.isMachineInYellowRoom(h,n))&&(t.yieldMultiplier=0,t.hasYellowRoomViolation=!0)}if(t.currentStation==="LIT"){if(!t.litSubStep||t.litSubStep==="COAT")return t.litSubStep="EXPOSE",t.qTimeDeadline=null,{nextStation:"LIT",nextSubStep:"EXPOSE",isLayerCompleted:!1,isLotCompleted:!1};if(t.litSubStep==="EXPOSE")return t.litSubStep="DEVELOP",t.qTimeDeadline=null,{nextStation:"LIT",nextSubStep:"DEVELOP",isLayerCompleted:!1,isLotCompleted:!1};if(t.litSubStep==="DEVELOP"){t.currentStation="ETCH",t.litSubStep=void 0;const d=this.calculateEffectiveQTimeSec("LIT","ETCH",s,a);return t.qTimeDeadline=i+d,{nextStation:"ETCH",isLayerCompleted:!1,isLotCompleted:!1}}}const l=o.indexOf(t.currentStation);if(l>=0&&l<o.length-1){const d=o[l+1];if(t.currentStation=d,d==="LIT"&&(t.litSubStep="COAT"),t.currentStation==="DIFF"){const h=this.calculateEffectiveQTimeSec("ETCH","DIFF",s,a);t.qTimeDeadline=i+h}else t.qTimeDeadline=null;return{nextStation:d,isLayerCompleted:!1,isLotCompleted:!1}}return t.currentLayer<t.totalLayers?(t.currentLayer+=1,t.currentStation="FILM",t.litSubStep=void 0,t.qTimeDeadline=null,{nextStation:"FILM",isLayerCompleted:!0,isLotCompleted:!1}):(t.status="COMPLETED",t.qTimeDeadline=null,{nextStation:t.currentStation,isLayerCompleted:!0,isLotCompleted:!0})}static calculateStationThroughputs(t,e,s){var l;const a=["FILM","TRACK","LIT","ETCH","DIFF","CMP"],i={FILM:{station:"FILM",totalCapacity:0,machineCount:0,isChokePoint:!1},TRACK:{station:"TRACK",totalCapacity:0,machineCount:0,isChokePoint:!1},LIT:{station:"LIT",totalCapacity:0,machineCount:0,isChokePoint:!1},ETCH:{station:"ETCH",totalCapacity:0,machineCount:0,isChokePoint:!1},DIFF:{station:"DIFF",totalCapacity:0,machineCount:0,isChokePoint:!1},CMP:{station:"CMP",totalCapacity:0,machineCount:0,isChokePoint:!1}},r=new Map;for(const d of e)r.set(d.id,d);for(const d of t){if(d.status==="EXPLODED")continue;let h=d.category;d.category==="LITHO"&&(h="LIT");const c=((l=this.BASE_THROUGHPUT_BY_TIER[h])==null?void 0:l[d.tier])??10,u=1-d.wear/100*.3;let p=1;if(d.assignedEngineerId&&r.has(d.assignedEngineerId)){const b=r.get(d.assignedEngineerId);b.moduleSpecialty===d.category&&b.fatigue<80&&(p=1.2)}h==="LIT"&&d.pairedTrackIds&&d.pairedTrackIds.length>=2&&(p+=.05);const m=c*u*p;i[h].totalCapacity+=m,i[h].machineCount+=1}let n=1/0,o="TRACK";for(const d of a)d==="CMP"&&!s||i[d].totalCapacity<n&&(n=i[d].totalCapacity,o=d);return n<1/0&&o&&(i[o].isChokePoint=!0),i}static calculateLogisticsFactor(t,e,s){let a=.5;t.oht?a=1.2:t.agv&&(a=.85);let i=5;if(e.length>=2){let o=0,l=0;for(let d=0;d<e.length-1;d++){const h=Math.abs(e[d].gridX-e[d+1].gridX)+Math.abs(e[d].gridY-e[d+1].gridY);o+=h,l++}i=l>0?o/l:5}const r=Math.max(.6,Math.min(1.1,6/Math.max(2,i))),n=Math.min(.2,s*.02);return Number((a*r*(1-n)).toFixed(2))}static calculateFactoryWorkload(t,e,s,a,i){const r=this.calculateStationThroughputs(t,e,i),n=this.calculateLogisticsFactor(a,t,s.length),o=["FILM","TRACK","LIT","ETCH","DIFF"];i&&o.push("CMP");let l=1/0;for(const p of o){const m=r[p].totalCapacity;m<l&&(l=m)}const d=Math.max(1,l*n);let h=0;for(const p of s)(p.status==="PROCESSING"||p.status==="WAITING_QTIME"||p.status==="TRANSPORTING")&&(h+=p.waferCount);const c=Math.min(150,Math.round(h/d*100));let u="SMOOTH";return c>85?u="OVERLOADED":c>=70&&(u="HEAVY"),{workloadPercent:c,maxCapacityWafersPerMin:Math.round(d),totalDemandWafers:h,statusLevel:u,throughputs:r}}static diagnoseBottleneck(t,e,s,a,i){var p;const{workloadPercent:r,throughputs:n}=this.calculateFactoryWorkload(t,e,s,a,i),o=t.find(m=>m.wear>=70);if(o){const m=o.category==="LITHO"?"LIT":o.category;return{category:"MAINTENANCE",title:"機台嚴重老化致效能衰退",stationName:o.category,description:`【${o.name}】磨損度高達 ${o.wear}%，抽真空與加工速率嚴重衰退超過 20%！`,recommendation:"請立即指派工程師對該機台執行「就地大修（Overhaul）」或保養，恢復 100% 原始效能。",workloadPercent:r,chokePointThroughput:Math.round(((p=n[m])==null?void 0:p.totalCapacity)??10)}}const l=n.TRACK.totalCapacity,d=n.LIT.totalCapacity;if(l<d&&l<40)return{category:"CAPACITY",title:"塗膠顯影 (Track) 先天物理產能瓶頸",stationName:"TRACK",description:`LITHO 曝光機正在空轉等待！【Track 塗膠顯影站】產能僅 ${Math.round(l)} 片/分，是產線最大卡點！`,recommendation:"光阻旋塗與烘烤受熱擴散物理限制，建議增購第 2 台 Track 機台或將其並聯綁定至微影機以分流消化產能！",workloadPercent:r,chokePointThroughput:Math.round(l)};let h="FILM",c=1/0;const u=["FILM","TRACK","LIT","ETCH","DIFF"];i&&u.push("CMP");for(const m of u)n[m].totalCapacity<c&&(c=n[m].totalCapacity,h=m);return c<=15?{category:"CAPACITY",title:"關鍵製程站點設備數量不足",stationName:h,description:`【${h} 站】產能僅 ${Math.round(c)} 片/分，遠低於其他站點，晶圓在門口嚴重堆積！`,recommendation:`建議前往商城增購第 2 台 ${h} 設備進行分流，或將現有機台升級為更高階型號。`,workloadPercent:r,chokePointThroughput:Math.round(c)}:!a.agv&&!a.oht&&s.length>=2?{category:"LOGISTICS",title:"人工手持搬運效率偏低",stationName:"AMHS 物流",description:"當前仍為「技術員手持晶圓盒步行搬運」，走動搬運耗時佔據了整個製程週期的 40% 以上！",recommendation:"投片量已超越人工負荷極限！強烈建議研發解鎖「地面 AGV 自走車」或「天花板 OHT 天軌」。",workloadPercent:r,chokePointThroughput:Math.round(c)}:{category:"LAYOUT",title:"機台動線規劃待最佳化",stationName:"廠房佈局",description:"前後站點相隔較遠，搬運載具在走道往返耗時過多，拉長了晶圓整體的傳送等待時間。",recommendation:"建議在廠房編輯模式中將相鄰製程機台（如 Track 與 Litho、Etch 與 Diff）就近排列，縮短傳送時間。",workloadPercent:r,chokePointThroughput:Math.round(c)}}static autoFillBestEconomyAllocation(t,e){const s=e.filter(o=>o.category==="LITHO");if(s.length===0)return[];const a=[...s].sort((o,l)=>{var c,u;const d=((c=F.OPTICAL_CATALOG[o.modelId])==null?void 0:c.baseRayleighLimitNm)??9999,h=((u=F.OPTICAL_CATALOG[l.modelId])==null?void 0:u.baseRayleighLimitNm)??9999;return d-h}),i=a[0],r=a[a.length-1],n=[];for(let o=1;o<=t.layerCount;o++){let l=o<=3,d=l?t.nodeNm:Math.max(t.nodeNm*2.5,350),h=l?i.modelId:r.modelId;n.push({layerIndex:o,layerType:l?"關鍵層 (Critical Layer)":"繞線層 (Metal Interconnect)",targetCD:Math.round(d),assignedMachineModelId:h})}return n}}g(N,"BASE_STATION_DURATION_SEC",{FILM:10,LIT:27,ETCH:12,DIFF:16,CMP:10}),g(N,"LIT_SUBSTEP_DURATION_SEC",{COAT:7,EXPOSE:12,DEVELOP:8}),g(N,"BASE_THROUGHPUT_BY_TIER",{LIT:{1:10,2:25,3:55,4:120,5:260,6:180},TRACK:{1:6,2:16,3:35,4:75,5:140,6:160},FILM:{1:12,2:24,3:50,4:110,5:220,6:200},ETCH:{1:12,2:24,3:50,4:110,5:220,6:200},DIFF:{1:10,2:20,3:45,4:100,5:200,6:180},CMP:{1:0,2:0,3:40,4:90,5:180,6:160}});const $={machines:{litho_contact:{path:"./assets/machines/litho_contact.png",label:"Contact Aligner",tier:1},litho_projection:{path:"./assets/machines/litho_projection.png",label:"1x Projection Aligner",tier:1},litho_gline:{path:"./assets/machines/litho_gline.png",label:"G-Line Stepper",tier:2},litho_iline:{path:"./assets/machines/litho_iline.png",label:"I-Line Stepper",tier:3},litho_krf:{path:"./assets/machines/litho_krf.png",label:"KrF DUV Scanner",tier:4},litho_arfdry:{path:"./assets/machines/litho_arfdry.png",label:"ArF Dry Scanner",tier:4},litho_arfi:{path:"./assets/machines/litho_arfi.png",label:"ArFi Immersion TWINSCAN",tier:5},litho_euv:{path:"./assets/machines/litho_euv.png",label:"EUV Scanner (無標誌 2.5D 旗艦)",tier:6},litho_highna:{path:"./assets/machines/litho_highna.png",label:"High-NA EUV Scanner",tier:6},track_manual:{path:"./assets/machines/track_manual.png",label:"手動旋塗熱板台",tier:1},track_single:{path:"./assets/machines/track_clean.png",label:"單軌自動塗膠顯影機",tier:2},track_dual:{path:"./assets/machines/track_dual.png",label:"雙軌連線 Track",tier:3},track_clean:{path:"./assets/machines/track_clean.png",label:"多工位精密 Clean Track",tier:4},track_advanced:{path:"./assets/machines/track_advanced.png",label:"先進極限分子級 Track",tier:6},etch_wet:{path:"./assets/machines/etch_wet.png",label:"濕式酸槽清洗台",tier:1},etch_plasma:{path:"./assets/machines/etch_plasma.png",label:"電漿乾式蝕刻機 (RIE)",tier:3},film_furnace:{path:"./assets/machines/film_furnace.png",label:"高溫熱氧化爐管",tier:1},film_pecvd:{path:"./assets/machines/film_pecvd.png",label:"電漿化學沉積 / ALD 機",tier:4},diff_furnace:{path:"./assets/machines/diff_furnace.png",label:"熱擴散高溫爐管",tier:1},diff_implanter:{path:"./assets/machines/diff_implanter.png",label:"大束流離子佈植機",tier:2},cmp_polisher:{path:"./assets/machines/cmp_polisher.png",label:"化學機械平坦化研磨機",tier:3}},characters:{tech_cleanroom:{path:"./assets/characters/tech_cleanroom.png",label:"Cleanroom Technician"},agv_carrier:{path:"./assets/characters/agv_carrier.png",label:"AGV Wafer Carrier"},oht_shuttle:{path:"./assets/characters/oht_shuttle.png",label:"OHT Sky-Rail Shuttle"}}};class f{static getContext(){if(this.isMuted)return null;if(!this.audioCtx){const t=window.AudioContext||window.webkitAudioContext;t&&(this.audioCtx=new t)}return this.audioCtx&&this.audioCtx.state==="suspended"&&this.audioCtx.resume(),this.audioCtx}static toggleMute(){return this.isMuted=!this.isMuted,this.isMuted}static isAudioMuted(){return this.isMuted}static playClick(){const t=this.getContext();if(!t)return;const e=t.createOscillator(),s=t.createGain(),a=t.currentTime;e.type="sine",e.frequency.setValueAtTime(800,a),e.frequency.exponentialRampToValueAtTime(1200,a+.04),s.gain.setValueAtTime(.15,a),s.gain.exponentialRampToValueAtTime(.001,a+.04),e.connect(s),s.connect(t.destination),e.start(a),e.stop(a+.04)}static playCoin(){const t=this.getContext();if(!t)return;const e=t.currentTime,s=t.createOscillator(),a=t.createOscillator(),i=t.createGain();s.type="sine",s.frequency.setValueAtTime(987.77,e),s.frequency.setValueAtTime(1318.51,e+.08),a.type="triangle",a.frequency.setValueAtTime(1975.53,e+.08),i.gain.setValueAtTime(.2,e),i.gain.exponentialRampToValueAtTime(.001,e+.28),s.connect(i),a.connect(i),i.connect(t.destination),s.start(e),s.stop(e+.28),a.start(e+.08),a.stop(e+.28)}static playCoinChime(){this.playCoin()}static playSuccess(){const t=this.getContext();if(!t)return;const e=t.currentTime;[523.25,659.25,783.99,1046.5].forEach((a,i)=>{const r=t.createOscillator(),n=t.createGain(),o=e+i*.08;r.type="triangle",r.frequency.setValueAtTime(a,o),n.gain.setValueAtTime(.2,o),n.gain.exponentialRampToValueAtTime(.001,o+.35),r.connect(n),n.connect(t.destination),r.start(o),r.stop(o+.35)})}static playFanfare(){this.playSuccess()}static playWarning(){const t=this.getContext();if(!t)return;const e=t.currentTime,s=t.createOscillator(),a=t.createGain();s.type="sawtooth",s.frequency.setValueAtTime(440,e),s.frequency.setValueAtTime(554.37,e+.1),a.gain.setValueAtTime(.12,e),a.gain.exponentialRampToValueAtTime(.001,e+.25),s.connect(a),a.connect(t.destination),s.start(e),s.stop(e+.25)}static playCriticalAlarm(){const t=this.getContext();if(!t)return;const e=t.currentTime,s=t.createOscillator(),a=t.createGain();s.type="sawtooth",s.frequency.setValueAtTime(600,e),s.frequency.linearRampToValueAtTime(950,e+.18),s.frequency.linearRampToValueAtTime(600,e+.36),a.gain.setValueAtTime(.18,e),a.gain.exponentialRampToValueAtTime(.001,e+.4),s.connect(a),a.connect(t.destination),s.start(e),s.stop(e+.4)}static playExplosion(){const t=this.getContext();if(!t)return;const e=t.currentTime,s=t.sampleRate*.6,a=t.createBuffer(1,s,t.sampleRate),i=a.getChannelData(0);for(let l=0;l<s;l++)i[l]=Math.random()*2-1;const r=t.createBufferSource();r.buffer=a;const n=t.createBiquadFilter();n.type="lowpass",n.frequency.setValueAtTime(800,e),n.frequency.exponentialRampToValueAtTime(40,e+.6);const o=t.createGain();o.gain.setValueAtTime(.4,e),o.gain.exponentialRampToValueAtTime(.001,e+.6),r.connect(n),n.connect(o),o.connect(t.destination),r.start(e),r.stop(e+.6)}static playRework(){const t=this.getContext();if(!t)return;const e=t.currentTime,s=t.sampleRate*.4,a=t.createBuffer(1,s,t.sampleRate),i=a.getChannelData(0);for(let l=0;l<s;l++)i[l]=Math.random()*2-1;const r=t.createBufferSource();r.buffer=a;const n=t.createBiquadFilter();n.type="bandpass",n.frequency.setValueAtTime(1200,e),n.frequency.exponentialRampToValueAtTime(300,e+.4),n.Q.value=3;const o=t.createGain();o.gain.setValueAtTime(.2,e),o.gain.exponentialRampToValueAtTime(.001,e+.4),r.connect(n),n.connect(o),o.connect(t.destination),r.start(e),r.stop(e+.4)}static playAlarm(){this.playWarning()}static playDing(){this.playCoin()}}g(f,"audioCtx",null),g(f,"isMuted",!1);const z=class z extends Phaser.Scene{constructor(){super({key:z.KEY});g(this,"saveGame");g(this,"tileWidth",200);g(this,"tileHeight",100);g(this,"isPlannerMode",!1);g(this,"plannerTool","NONE");g(this,"movingMachineId",null);g(this,"pointerDownMachineId",null);g(this,"plannerIndicatorGraphics");g(this,"selectionRingGraphics");g(this,"onStateUpdateCallback");g(this,"floorGraphics");g(this,"railGraphics");g(this,"machineMap",new Map);g(this,"technicians",[]);g(this,"ohtShuttles",[]);g(this,"agvCarriers",[]);g(this,"isDragging",!1);g(this,"dragStartX",0);g(this,"dragStartY",0);g(this,"totalDragDistance",0);g(this,"dragThreshold",6);g(this,"onMachineClickCallback")}init(e){this.saveGame=e.saveGame,this.onMachineClickCallback=e.onMachineClick,this.onStateUpdateCallback=e.onStateUpdate}preload(){this.load.on("complete",()=>{this.refreshMachineSprites()}),this.load.on("loaderror",e=>{console.warn("⚠️ 貼圖載入失敗:",e==null?void 0:e.key,e==null?void 0:e.url)});for(const[e,s]of Object.entries($.machines))this.textures.exists(e)||this.load.image(e,s.path);for(const[e,s]of Object.entries($.characters))!this.textures.exists(e)&&s.path&&this.load.image(e,s.path)}refreshMachineSprites(){for(const e of this.saveGame.machines){const s=this.machineMap.get(e.id);if(s&&!s.sprite&&this.textures.exists(e.modelId)){s.fallback&&(s.fallback.destroy(),s.fallback=void 0);const a=this.add.image(0,-35,e.modelId),i=this.tileWidth*.95;a.setDisplaySize(i,i),s.container.addAt(a,1),s.sprite=a}}}create(){this.floorGraphics=this.add.graphics(),this.selectionRingGraphics=this.add.graphics(),this.selectionRingGraphics.setDepth(45),this.plannerIndicatorGraphics=this.add.graphics(),this.plannerIndicatorGraphics.setDepth(48),this.railGraphics=this.add.graphics(),this.renderFloor(),this.renderOHTRails(),this.renderMachines(),this.spawnTechnicians(),this.spawnAGVCarriers(),this.spawnOHTShuttles(),this.cameras.main.centerOn(0,300),this.cameras.main.setZoom(.85),this.setupCameraControls(),this.scale.on("resize",this.onResize,this)}toScreen(e,s){const a=(e-s)*(this.tileWidth/2),i=(e+s)*(this.tileHeight/2);return{x:a,y:i}}toGrid(e,s){const a=Math.floor(e/this.tileWidth+s/this.tileHeight+.5),i=Math.floor(s/this.tileHeight-e/this.tileWidth+.5);return{gridX:a,gridY:i}}renderFloor(){this.floorGraphics.clear();const e=this.saveGame.facility.bayGridSize,s=this.saveGame.facility.yellowRoomTiles||[];for(let a=0;a<e.width;a++)for(let i=0;i<e.height;i++){const{x:r,y:n}=this.toScreen(a,i),o=s.length>0?s.some(u=>u.x===a&&u.y===i):i<=3&&a>=3&&a<=7,l={x:r,y:n-this.tileHeight/2},d={x:r+this.tileWidth/2,y:n},h={x:r,y:n+this.tileHeight/2},c={x:r-this.tileWidth/2,y:n};o?(this.floorGraphics.fillStyle(3153414,.96),this.floorGraphics.lineStyle(1.8,16096779,.55)):(this.floorGraphics.fillStyle((a+i)%2===0?594210:792109,.95),this.floorGraphics.lineStyle(1,1976635,.55)),this.floorGraphics.beginPath(),this.floorGraphics.moveTo(l.x,l.y),this.floorGraphics.lineTo(d.x,d.y),this.floorGraphics.lineTo(h.x,h.y),this.floorGraphics.lineTo(c.x,c.y),this.floorGraphics.closePath(),this.floorGraphics.fillPath(),this.floorGraphics.strokePath()}}renderOHTRails(){this.railGraphics.clear();const e=this.saveGame.facility.bayGridSize,s=-160;this.railGraphics.lineStyle(2.5,440020,.35);const a=this.toScreen(1,1),i=this.toScreen(e.width-2,1),r=this.toScreen(e.width-2,e.height-2),n=this.toScreen(1,e.height-2);this.railGraphics.beginPath(),this.railGraphics.moveTo(a.x,a.y+s),this.railGraphics.lineTo(i.x,i.y+s),this.railGraphics.lineTo(r.x,r.y+s),this.railGraphics.lineTo(n.x,n.y+s),this.railGraphics.closePath(),this.railGraphics.strokePath()}renderMachines(){const e=new Map(this.saveGame.staff.map(s=>[s.id,s]));for(const s of this.saveGame.machines){const{x:a,y:i}=this.toScreen(s.gridX,s.gridY),r=(s.gridX+s.gridY)*10+50;let n=this.machineMap.get(s.id);if(n){if(n.container.setPosition(a,i),n.container.setDepth(r),!n.sprite&&this.textures.exists(s.modelId)){n.fallback&&(n.fallback.destroy(),n.fallback=void 0);const c=this.add.image(0,-25,s.modelId),u=118;c.setDisplaySize(u,u),n.container.addAt(c,1),n.sprite=c}if(n.ledArc.setFillStyle(this.getLEDColor(s.status)),n.label.setText(`${s.name} (${Math.round(s.wear)}%)`),s.status==="PROCESSING"){if(!n.processingText){const c=this.add.text(0,-104,"⚡ 加工中",{fontFamily:"Noto Sans TC, sans-serif",fontSize:"10px",fontStyle:"bold",color:"#38bdf8",backgroundColor:"rgba(8, 47, 73, 0.95)",padding:{x:5,y:2}});c.setOrigin(.5),n.container.add(c),n.processingText=c}}else n.processingText&&(n.processingText.destroy(),n.processingText=void 0);const o=N.isMachineInYellowRoom(s,this.saveGame.facility.yellowRoomTiles);if((s.category==="LITHO"||s.category==="TRACK")&&!o){if(!n.yellowAlertText){const c=this.add.text(0,-125,"🚨 缺乏黃光防護 (良率 0%)",{fontFamily:"Noto Sans TC, sans-serif",fontSize:"10px",fontStyle:"bold",color:"#ffffff",backgroundColor:"rgba(220, 38, 38, 0.95)",padding:{x:6,y:3}});c.setOrigin(.5),n.container.add(c),n.yellowAlertText=c}}else n.yellowAlertText&&(n.yellowAlertText.destroy(),n.yellowAlertText=void 0);const d=s.assignedEngineerId?e.get(s.assignedEngineerId):null,h=O.checkTPMConditions(s,d);if(h.isTPMActive&&!n.tpmText){const c=this.add.text(0,-104,"🛡️ TPM 零故障",{fontFamily:"Noto Sans TC, sans-serif",fontSize:"10px",fontStyle:"bold",color:"#10b981",backgroundColor:"rgba(6, 78, 59, 0.92)",padding:{x:5,y:2}});c.setOrigin(.5),n.container.add(c),n.tpmText=c}else!h.isTPMActive&&n.tpmText&&(n.tpmText.destroy(),n.tpmText=void 0)}else{const o=this.add.container(a,i);o.setDepth(r);const l=this.add.ellipse(0,10,88,38,0,.4);o.add(l);let d,h;const c=118;this.textures.exists(s.modelId)?(d=this.add.image(0,-25,s.modelId),d.setDisplaySize(c,c),o.add(d)):(h=this.createFallbackMachineGraphic(s),o.add(h));const u=this.getLEDColor(s.status),p=this.add.circle(0,-82,6,u);o.add(p);const m=this.add.text(0,18,`${s.name} (${Math.round(s.wear)}%)`,{fontFamily:"Noto Sans TC, sans-serif",fontSize:"11px",fontStyle:"bold",color:"#f8fafc",backgroundColor:"rgba(15, 23, 42, 0.88)",padding:{x:6,y:3}});m.setOrigin(.5),o.add(m);const b=s.assignedEngineerId?e.get(s.assignedEngineerId):null,T=O.checkTPMConditions(s,b);let y;T.isTPMActive&&(y=this.add.text(0,-104,"🛡️ TPM 零故障",{fontFamily:"Noto Sans TC, sans-serif",fontSize:"10px",fontStyle:"bold",color:"#10b981",backgroundColor:"rgba(6, 78, 59, 0.92)",padding:{x:5,y:2}}),y.setOrigin(.5),o.add(y));let w;s.status==="PROCESSING"&&(w=this.add.text(0,-104,"⚡ 加工中",{fontFamily:"Noto Sans TC, sans-serif",fontSize:"10px",fontStyle:"bold",color:"#38bdf8",backgroundColor:"rgba(8, 47, 73, 0.95)",padding:{x:5,y:2}}),w.setOrigin(.5),o.add(w));const E=N.isMachineInYellowRoom(s,this.saveGame.facility.yellowRoomTiles),M=s.category==="LITHO"||s.category==="TRACK";let v;M&&!E&&(v=this.add.text(0,-125,"🚨 缺乏黃光防護 (良率 0%)",{fontFamily:"Noto Sans TC, sans-serif",fontSize:"10px",fontStyle:"bold",color:"#ffffff",backgroundColor:"rgba(220, 38, 38, 0.95)",padding:{x:6,y:3}}),v.setOrigin(.5),o.add(v));const S=96,R=96;o.setInteractive(new Phaser.Geom.Rectangle(-S/2,-R+15,S,R),Phaser.Geom.Rectangle.Contains),o.on("pointerdown",L=>{this.pointerDownMachineId=s.id,L.event&&L.event.stopPropagation()}),o.on("pointerover",()=>{const L=this.machineMap.get(s.id);L!=null&&L.sprite&&L.sprite.setTint(3718648)}),o.on("pointerout",()=>{const L=this.machineMap.get(s.id);L!=null&&L.sprite&&L.sprite.clearTint()}),o.on("pointerup",L=>{this.pointerDownMachineId===s.id&&this.totalDragDistance<=this.dragThreshold&&(L.event&&L.event.stopPropagation(),f.playClick(),this.isPlannerMode&&this.plannerTool==="MOVE_MACHINE"?this.selectMachineToMove(s):this.isPlannerMode||this.onMachineClickCallback&&this.onMachineClickCallback(s)),this.pointerDownMachineId=null}),this.machineMap.set(s.id,{container:o,ledArc:p,label:m,tpmText:y,processingText:w,yellowAlertText:v,sprite:d,fallback:h})}}}createFallbackMachineGraphic(e){const s=this.add.graphics(),a=60;let i=3900150;return e.category==="LITHO"&&(i=16096779),e.category==="TRACK"&&(i=1096065),e.category==="ETCH"&&(i=9133302),e.category==="DIFF"&&(i=15485081),e.category==="CMP"&&(i=440020),s.fillStyle(i,.9),s.beginPath(),s.moveTo(0,-70),s.lineTo(a/2,-60),s.lineTo(0,-50),s.lineTo(-a/2,-60),s.closePath(),s.fillPath(),s.fillStyle(i,.7),s.beginPath(),s.moveTo(-a/2,-60),s.lineTo(0,-50),s.lineTo(0,0),s.lineTo(-a/2,-10),s.closePath(),s.fillPath(),s.fillStyle(i,.5),s.beginPath(),s.moveTo(0,-50),s.lineTo(a/2,-60),s.lineTo(a/2,-10),s.lineTo(0,0),s.closePath(),s.fillPath(),s}getLEDColor(e){switch(e){case"IDLE":return 1096065;case"PROCESSING":return 440020;case"MAINTENANCE":return 16096779;case"EXPLODED":return 15680580}}spawnTechnicians(){const e=Math.min(6,Math.max(2,this.saveGame.staff.length));for(let s=0;s<e;s++){const a=this.add.container(0,0);a.setDepth(200);const i=this.add.ellipse(0,4,18,9,0,.35);if(a.add(i),this.textures.exists("tech_cleanroom")){const n=this.add.image(0,-18,"tech_cleanroom");n.setDisplaySize(48,48),a.add(n)}else{const n=this.add.circle(0,-12,8,16317180),o=this.add.rectangle(0,-12,8,4,3718648),l=this.add.rectangle(0,-4,12,12,14870768);a.add([l,n,o])}const r=this.toScreen(2+s,3);a.setPosition(r.x,r.y),this.technicians.push({container:a,targetX:r.x,targetY:r.y,speed:.6+Math.random()*.4})}}spawnAGVCarriers(){if(this.saveGame.unlockedFeatures.agv)for(let e=0;e<2;e++){const s=this.add.container(0,0);s.setDepth(205);const a=this.add.ellipse(0,4,24,12,0,.4);if(s.add(a),this.textures.exists("agv_carrier")){const r=this.add.image(0,-14,"agv_carrier");r.setDisplaySize(54,40),s.add(r)}else{const r=this.add.rectangle(0,-8,28,16,165063),n=this.add.rectangle(0,-18,16,12,1096065),o=this.add.circle(10,-8,3,15680580);s.add([r,n,o])}const i=this.toScreen(1+e*3,2);s.setPosition(i.x,i.y),this.agvCarriers.push({container:s,targetX:i.x,targetY:i.y,speed:1.1+e*.2})}}spawnOHTShuttles(){const e=this.add.container(0,-160);if(e.setDepth(500),this.textures.exists("oht_shuttle")){const a=this.add.image(0,16,"oht_shuttle");a.setDisplaySize(56,42),e.add(a)}else{const a=this.add.rectangle(0,0,8,12,4674921),i=this.add.rectangle(0,10,32,18,959977),r=this.add.rectangle(0,22,20,16,1096065),n=this.add.circle(12,10,3,2278750);e.add([a,i,r,n])}const s=this.toScreen(1,1);e.setPosition(s.x,s.y-160),this.ohtShuttles.push({container:e,progress:0,speed:.002})}update(e,s){const a=this.saveGame.facility.bayGridSize,i=[this.toScreen(1,1),this.toScreen(a.width-2,1),this.toScreen(a.width-2,a.height-2),this.toScreen(1,a.height-2)];for(const r of this.ohtShuttles){r.progress=(r.progress+r.speed*(s/16))%1;const n=i.length,o=Math.floor(r.progress*n),l=(o+1)%n,d=r.progress*n%1,h=i[o],c=i[l],u=h.x+(c.x-h.x)*d,p=h.y+(c.y-h.y)*d-160;r.container.setPosition(u,p)}for(const r of this.technicians){const n=r.targetX-r.container.x,o=r.targetY-r.container.y,l=Math.sqrt(n*n+o*o);if(l<4){const d=Math.floor(Math.random()*(a.width-2))+1,h=Math.floor(Math.random()*(a.height-2))+1,c=this.toScreen(d,h);r.targetX=c.x,r.targetY=c.y}else r.container.x+=n/l*r.speed*(s/16),r.container.y+=o/l*r.speed*(s/16)}for(const r of this.agvCarriers){const n=r.targetX-r.container.x,o=r.targetY-r.container.y,l=Math.sqrt(n*n+o*o);if(l<4){const d=Math.floor(Math.random()*(a.width-2))+1,h=Math.floor(Math.random()*(a.height-2))+1,c=this.toScreen(d,h);r.targetX=c.x,r.targetY=c.y}else r.container.x+=n/l*r.speed*(s/16),r.container.y+=o/l*r.speed*(s/16)}}setPlannerMode(e,s="NONE"){this.isPlannerMode=e,this.plannerTool=s,this.movingMachineId=null,this.plannerIndicatorGraphics.clear(),this.selectionRingGraphics.clear()}selectMachineToMove(e){if(this.movingMachineId===e.id){this.movingMachineId=null,this.selectionRingGraphics.clear(),this.plannerIndicatorGraphics.clear(),f.playClick();return}this.movingMachineId=e.id,f.playClick(),this.drawSelectionRing(e.gridX,e.gridY)}drawSelectionRing(e,s){this.selectionRingGraphics.clear();const{x:a,y:i}=this.toScreen(e,s);this.selectionRingGraphics.lineStyle(3.5,440020,.95);const r={x:a,y:i-this.tileHeight/2-2},n={x:a+this.tileWidth/2+4,y:i},o={x:a,y:i+this.tileHeight/2+2},l={x:a-this.tileWidth/2-4,y:i};this.selectionRingGraphics.beginPath(),this.selectionRingGraphics.moveTo(r.x,r.y),this.selectionRingGraphics.lineTo(n.x,n.y),this.selectionRingGraphics.lineTo(o.x,o.y),this.selectionRingGraphics.lineTo(l.x,l.y),this.selectionRingGraphics.closePath(),this.selectionRingGraphics.strokePath()}updatePlannerCursorIndicator(e,s){if(!this.isPlannerMode||!this.plannerIndicatorGraphics)return;this.plannerIndicatorGraphics.clear();const{gridX:a,gridY:i}=this.toGrid(e,s),r=this.saveGame.facility.bayGridSize;if(a<0||a>=r.width||i<0||i>=r.height)return;const{x:n,y:o}=this.toScreen(a,i),l={x:n,y:o-this.tileHeight/2},d={x:n+this.tileWidth/2,y:o},h={x:n,y:o+this.tileHeight/2},c={x:n-this.tileWidth/2,y:o};this.plannerTool==="PAINT_YELLOW"?(this.plannerIndicatorGraphics.fillStyle(16096779,.45),this.plannerIndicatorGraphics.lineStyle(2.5,16498468,.95)):this.plannerTool==="PAINT_WHITE"?(this.plannerIndicatorGraphics.fillStyle(165063,.45),this.plannerIndicatorGraphics.lineStyle(2.5,3718648,.95)):this.plannerTool==="MOVE_MACHINE"&&(this.saveGame.machines.some(p=>p.id!==this.movingMachineId&&p.gridX===a&&p.gridY===i)?(this.plannerIndicatorGraphics.fillStyle(15680580,.45),this.plannerIndicatorGraphics.lineStyle(2.5,16281969,.95)):(this.plannerIndicatorGraphics.fillStyle(1096065,.45),this.plannerIndicatorGraphics.lineStyle(2.5,3462041,.95))),this.plannerIndicatorGraphics.beginPath(),this.plannerIndicatorGraphics.moveTo(l.x,l.y),this.plannerIndicatorGraphics.lineTo(d.x,d.y),this.plannerIndicatorGraphics.lineTo(h.x,h.y),this.plannerIndicatorGraphics.lineTo(c.x,c.y),this.plannerIndicatorGraphics.closePath(),this.plannerIndicatorGraphics.fillPath(),this.plannerIndicatorGraphics.strokePath()}handlePlannerTileClick(e,s){var i,r,n;const a=this.saveGame.facility.bayGridSize;if(!(e<0||e>=a.width||s<0||s>=a.height)){if(this.plannerTool==="PAINT_YELLOW")this.saveGame.facility.yellowRoomTiles||(this.saveGame.facility.yellowRoomTiles=[]),this.saveGame.facility.yellowRoomTiles.some(l=>l.x===e&&l.y===s)||(this.saveGame.facility.yellowRoomTiles.push({x:e,y:s}),f.playClick(),this.renderFloor(),this.renderMachines(),(i=this.onStateUpdateCallback)==null||i.call(this));else if(this.plannerTool==="PAINT_WHITE"){if(this.saveGame.facility.yellowRoomTiles){const o=this.saveGame.facility.yellowRoomTiles.findIndex(l=>l.x===e&&l.y===s);o>=0&&(this.saveGame.facility.yellowRoomTiles.splice(o,1),f.playClick(),this.renderFloor(),this.renderMachines(),(r=this.onStateUpdateCallback)==null||r.call(this))}}else if(this.plannerTool==="MOVE_MACHINE"&&this.movingMachineId){if(this.saveGame.machines.some(d=>d.id!==this.movingMachineId&&d.gridX===e&&d.gridY===s)){f.playAlarm();return}const l=this.saveGame.machines.find(d=>d.id===this.movingMachineId);l&&(l.gridX=e,l.gridY=s,f.playDing(),this.movingMachineId=null,this.selectionRingGraphics.clear(),this.plannerIndicatorGraphics.clear(),this.renderMachines(),this.renderOHTRails(),(n=this.onStateUpdateCallback)==null||n.call(this))}}}setupCameraControls(){this.input.on("pointerdown",e=>{e.leftButtonDown()&&(this.isDragging=!0,this.dragStartX=e.x,this.dragStartY=e.y,this.totalDragDistance=0)}),this.input.on("pointermove",e=>{if(this.isPlannerMode){const s=this.cameras.main.getWorldPoint(e.x,e.y);this.updatePlannerCursorIndicator(s.x,s.y)}if(this.isDragging){if(!e.isDown||!e.leftButtonDown()){this.isDragging=!1;return}const s=e.x-this.dragStartX,a=e.y-this.dragStartY;this.totalDragDistance+=Math.hypot(s,a),this.totalDragDistance>this.dragThreshold&&(this.cameras.main.scrollX-=s*.85/this.cameras.main.zoom,this.cameras.main.scrollY-=a*.85/this.cameras.main.zoom),this.dragStartX=e.x,this.dragStartY=e.y}}),this.input.on("pointerup",e=>{const s=this.totalDragDistance>this.dragThreshold;if(this.isDragging=!1,this.pointerDownMachineId=null,!s&&this.isPlannerMode){const a=this.cameras.main.getWorldPoint(e.x,e.y),{gridX:i,gridY:r}=this.toGrid(a.x,a.y);this.handlePlannerTileClick(i,r)}}),window.addEventListener("mouseup",()=>{this.isDragging=!1,this.pointerDownMachineId=null}),window.addEventListener("blur",()=>{this.isDragging=!1,this.pointerDownMachineId=null}),this.input.on("wheel",(e,s,a,i)=>{const r=Phaser.Math.Clamp(this.cameras.main.zoom-i*.001,.45,2.2);this.cameras.main.setZoom(r)})}onResize(e){this.cameras.main.setSize(e.width,e.height)}updateState(e){this.saveGame=e,this.renderFloor(),this.renderMachines(),this.saveGame.unlockedFeatures.agv&&this.agvCarriers.length===0&&this.spawnAGVCarriers()}};g(z,"KEY","CleanroomScene");let V=z;class D{static getInitialAchievements(){return JSON.parse(JSON.stringify(this.INITIAL_ACHIEVEMENTS))}static checkAchievements(t){const e=[],s=new Map;for(const l of t.achievements)s.set(l.id,l);const a=l=>{const d=s.get(l);d&&!d.unlocked&&(d.unlocked=!0,e.push(d))};t.rollingYieldHistory.length>=1&&a("first_silicon"),(t.activeLots.some(l=>l.currentStation==="LIT"||l.currentStation==="ETCH"||l.currentStation==="DIFF")||t.rollingYieldHistory.length>=1)&&a("step_into_yellow");const r=t.activeOrders.filter(l=>l.status==="FULFILLED");r.length>=1&&a("first_cash"),t.unlockedFeatures.mesAutoDispatch&&a("mes_mastery"),r.some(l=>l.nodeNm<=350)&&a("submicron_explorer"),t.unlockedFeatures.cmp&&t.machines.some(l=>l.category==="CMP")&&a("copper_cmp_era"),t.machines.some(l=>l.modelId==="litho_arfi")&&a("immersion_wave"),t.machines.some(l=>l.modelId==="litho_euv"||l.modelId==="litho_highna")&&a("euv_domination");const n=new Map(t.staff.map(l=>[l.id,l]));let o=0;for(const l of t.machines){const d=l.assignedEngineerId?n.get(l.assignedEngineerId):null;O.checkTPMConditions(l,d).isTPMActive&&o++}if(o>=3&&a("tpm_zero_defect"),t.machines.some(l=>{var d;return l.category==="LITHO"&&(((d=l.pairedTrackIds)==null?void 0:d.length)??0)>=2})&&a("inline_cluster_master"),t.facility.cleanroomPhase>=4&&a("gigafab_expansion"),t.unlockedFeatures.agv&&t.unlockedFeatures.oht&&a("automation_highway"),t.rollingYieldHistory.some(l=>l>=.99)&&a("flawless_wafer"),t.rollingYieldHistory.length>=5){const l=t.rollingYieldHistory.slice(-5);l.reduce((h,c)=>h+c,0)/l.length>=.95&&a("five_star_foundry")}return t.player.cash>=1e8&&a("trillion_chip_dynasty"),{newlyUnlocked:e}}static triggerManualUnlock(t,e){const s=t.find(a=>a.id===e);return s&&!s.unlocked?(s.unlocked=!0,!0):!1}static claimReward(t,e){const s=t.find(a=>a.id===e);return s?s.unlocked?s.claimed?{success:!1,cash:0,message:"該成就獎勵已領取"}:(s.claimed=!0,{success:!0,cash:s.rewardCash,message:`🏆 成功領取成就【${s.title}】獎勵！獲得獎勵金 NT$ ${s.rewardCash.toLocaleString()}！`}):{success:!1,cash:0,message:"尚未達成該成就解鎖條件"}:{success:!1,cash:0,message:"找不到該成就"}}}g(D,"INITIAL_ACHIEVEMENTS",[{id:"first_silicon",category:"onboarding",title:"矽島啟航 (First Silicon)",description:"成功在廠房內完成並產出第一批晶圓。",rewardCash:5e4,unlocked:!1,claimed:!1},{id:"step_into_yellow",category:"onboarding",title:"邁入黃光密室 (Yellow Room Entry)",description:"首次完成微影站塗膠、曝光與顯影連線作業。",rewardCash:8e4,unlocked:!1,claimed:!1},{id:"first_cash",category:"onboarding",title:"首桶金進帳 (First Cash Delivery)",description:"成功履約第一張客戶製造合約並取得全額尾款。",rewardCash:1e5,unlocked:!1,claimed:!1},{id:"mes_mastery",category:"onboarding",title:"智慧製造大師 (MES Mastery)",description:"完成新手教學，解鎖並啟用 MES 智慧自動派工系統。",rewardCash:15e4,unlocked:!1,claimed:!1},{id:"submicron_explorer",category:"process",title:"突破次微米壁壘 (Sub-micron Explorer)",description:"成功承接並交付線寬 <= 350nm 之高階次微米訂單。",rewardCash:5e5,unlocked:!1,claimed:!1},{id:"copper_cmp_era",category:"process",title:"銅導線與平坦化時代 (CMP Era)",description:"解鎖並在廠房內運作 CMP 化學機械平坦化拋光設備。",rewardCash:1e6,unlocked:!1,claimed:!1},{id:"immersion_wave",category:"process",title:"水中折射奇蹟 (Immersion Wave)",description:"購買並安裝 Tier 5 ArFi 浸潤微影雙工件台設備 (TWINSCAN)。",rewardCash:5e6,unlocked:!1,claimed:!1},{id:"euv_domination",category:"process",title:"極紫外神之光 (EUV Domination)",description:"購買並啟用極紫外光微影巨獸 (EUV Scanner)。",rewardCash:2e7,unlocked:!1,claimed:!1},{id:"tpm_zero_defect",category:"operation",title:"零非計畫停機殿堂 (TPM Zero-Defect)",description:"同時維持 3 台以上機台處於 🛡️ TPM 24H 零故障在線維護保障狀態。",rewardCash:2e6,unlocked:!1,claimed:!1},{id:"inline_cluster_master",category:"operation",title:"雙軌並聯突破極限 (Inline Cluster Master)",description:"為微影機台並聯配套綁定 2 台以上 Track 塗膠顯影設備，消除產能瓶頸。",rewardCash:15e5,unlocked:!1,claimed:!1},{id:"gigafab_expansion",category:"operation",title:"GigaFab 超級晶圓廠 (GigaFab Expansion)",description:"將潔淨室無塵廠房拓建至 Phase 4 (24x24 巨型潔淨室)。",rewardCash:1e7,unlocked:!1,claimed:!1},{id:"automation_highway",category:"operation",title:"自動化天軌物流 (Automation Highway)",description:"同時解鎖地面 AGV 自走車與天花板 OHT 懸吊天軌系統。",rewardCash:3e6,unlocked:!1,claimed:!1},{id:"flawless_wafer",category:"yield",title:"神級黃金良率 (Flawless Wafer 99%+)",description:"成功生產交付一批最終良率達 99% 以上的頂級晶圓。",rewardCash:1e6,unlocked:!1,claimed:!1},{id:"rework_savior",category:"yield",title:"點石成金光阻重洗 (Rework Savior)",description:"成功對 Q-Time 逾期晶圓執行光阻重洗 (Rework)，拯救昂貴晶片免於報廢。",rewardCash:5e5,unlocked:!1,claimed:!1},{id:"five_star_foundry",category:"yield",title:"五星品質金字招牌 (Five-Star Foundry)",description:"累積至少 5 批出貨紀錄，且 RollingYieldIndex 滾動良率指數突破 95%！",rewardCash:8e6,unlocked:!1,claimed:!1},{id:"trillion_chip_dynasty",category:"yield",title:"稱霸全球矽島霸權 (Silicon Hegemony)",description:"總現金累積突破 NT$ 100,000,000，建立無可撼動的半導體傳奇帝國。",rewardCash:5e7,unlocked:!1,claimed:!1}]);class A{static createEmptyRecord(t,e,s,a=5e7,i=7e7){return{periodType:t,periodIndex:e,label:s,timestamp:Date.now(),revenue:{waferSales:0,nreFees:0,subsidies:0,totalRevenue:0},expenses:{depreciation:0,maintenance:0,utilities:0,payroll:0,scraps:0,capex:0,totalExpenses:0},grossProfit:0,grossMarginPct:0,netProfit:0,netMarginPct:0,endingCash:a,endingNetWorth:i}}static initFinancialState(t=5e7,e=7e7){return{daySeconds:0,currentDay:1,currentWeek:1,currentMonth:1,today:this.createEmptyRecord("DAY",1,"第 1 天 (Day 1)",t,e),thisWeek:this.createEmptyRecord("WEEK",1,"第 1 周 (Week 1)",t,e),thisMonth:this.createEmptyRecord("MONTH",1,"第 1 個月 (Month 1)",t,e),dailyHistory:[],weeklyHistory:[],monthlyHistory:[],allTimeRevenue:0,allTimeExpenses:0,allTimeProfit:0}}static calculateCompanyNetWorth(t){const e=t.player.cash,s=t.machines.reduce((r,n)=>{const o=n.tier*15e6,l=Math.max(.2,(100-n.wear)/100);return r+Math.round(o*l)},0),a=t.facility.cleanroomPhase*25e6,i=t.clawbackDebt||0;return Math.max(0,e+s+a-i)}static recordWaferSales(t,e){const s=this.ensureFinancialState(t);s.today.revenue.waferSales+=e,s.thisWeek.revenue.waferSales+=e,s.thisMonth.revenue.waferSales+=e,s.allTimeRevenue+=e,this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t)}static recordNREFee(t,e){const s=this.ensureFinancialState(t);s.today.revenue.nreFees+=e,s.thisWeek.revenue.nreFees+=e,s.thisMonth.revenue.nreFees+=e,s.allTimeRevenue+=e,this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t)}static recordSubsidy(t,e){const s=this.ensureFinancialState(t);s.today.revenue.subsidies+=e,s.thisWeek.revenue.subsidies+=e,s.thisMonth.revenue.subsidies+=e,s.allTimeRevenue+=e,this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t)}static recordMaintenance(t,e){const s=this.ensureFinancialState(t);s.today.expenses.maintenance+=e,s.thisWeek.expenses.maintenance+=e,s.thisMonth.expenses.maintenance+=e,s.allTimeExpenses+=e,this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t)}static recordCapEx(t,e){const s=this.ensureFinancialState(t);s.today.expenses.capex+=e,s.thisWeek.expenses.capex+=e,s.thisMonth.expenses.capex+=e,s.allTimeExpenses+=e,this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t)}static recordSigningBonus(t,e){const s=this.ensureFinancialState(t);s.today.expenses.payroll+=e,s.thisWeek.expenses.payroll+=e,s.thisMonth.expenses.payroll+=e,s.allTimeExpenses+=e,this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t)}static recordScrapLoss(t,e){const s=this.ensureFinancialState(t);s.today.expenses.scraps+=e,s.thisWeek.expenses.scraps+=e,s.thisMonth.expenses.scraps+=e,s.allTimeExpenses+=e,this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t)}static tickSimulation(t,e=1){const s=this.ensureFinancialState(t),a=t.machines.reduce((h,c)=>h+c.tier*1200,0)*e;s.today.expenses.depreciation+=Math.round(a),s.thisWeek.expenses.depreciation+=Math.round(a),s.thisMonth.expenses.depreciation+=Math.round(a);const i=t.machines.filter(h=>h.status==="PROCESSING").length,n=(t.facility.cleanroomPhase*800+i*600)*e;s.today.expenses.utilities+=Math.round(n),s.thisWeek.expenses.utilities+=Math.round(n),s.thisMonth.expenses.utilities+=Math.round(n);const d=t.staff.reduce((h,c)=>h+c.salary,0)/300*e;s.today.expenses.payroll+=Math.round(d),s.thisWeek.expenses.payroll+=Math.round(d),s.thisMonth.expenses.payroll+=Math.round(d),this.updateRecordTotals(s.today,t),this.updateRecordTotals(s.thisWeek,t),this.updateRecordTotals(s.thisMonth,t),s.daySeconds+=e,s.daySeconds>=this.DAY_SECONDS&&this.closeDay(t)}static closeDay(t){const e=this.ensureFinancialState(t);this.updateRecordTotals(e.today,t),e.dailyHistory.unshift(JSON.parse(JSON.stringify(e.today))),e.dailyHistory.length>14&&e.dailyHistory.pop(),e.daySeconds=0,e.currentDay+=1;const s=e.currentDay;e.today=this.createEmptyRecord("DAY",s,`第 ${s} 天 (Day ${s})`,t.player.cash,this.calculateCompanyNetWorth(t)),s%this.DAYS_PER_WEEK===1&&s>1&&this.closeWeek(t),s%this.DAYS_PER_MONTH===1&&s>1&&this.closeMonth(t)}static closeWeek(t){const e=this.ensureFinancialState(t);this.updateRecordTotals(e.thisWeek,t),e.weeklyHistory.unshift(JSON.parse(JSON.stringify(e.thisWeek))),e.weeklyHistory.length>8&&e.weeklyHistory.pop(),e.currentWeek+=1;const s=e.currentWeek;e.thisWeek=this.createEmptyRecord("WEEK",s,`第 ${s} 周 (Week ${s})`,t.player.cash,this.calculateCompanyNetWorth(t))}static closeMonth(t){const e=this.ensureFinancialState(t);this.updateRecordTotals(e.thisMonth,t),e.monthlyHistory.unshift(JSON.parse(JSON.stringify(e.thisMonth))),e.monthlyHistory.length>6&&e.monthlyHistory.pop(),e.currentMonth+=1;const s=e.currentMonth;e.thisMonth=this.createEmptyRecord("MONTH",s,`第 ${s} 個月 (Month ${s})`,t.player.cash,this.calculateCompanyNetWorth(t))}static updateRecordTotals(t,e){t.revenue.totalRevenue=t.revenue.waferSales+t.revenue.nreFees+t.revenue.subsidies,t.expenses.totalExpenses=t.expenses.depreciation+t.expenses.maintenance+t.expenses.utilities+t.expenses.payroll+t.expenses.scraps+t.expenses.capex;const s=t.expenses.depreciation+t.expenses.maintenance+t.expenses.utilities+t.expenses.scraps;t.grossProfit=t.revenue.totalRevenue-s,t.grossMarginPct=t.revenue.totalRevenue>0?Number((t.grossProfit/t.revenue.totalRevenue*100).toFixed(1)):0;const a=s+t.expenses.payroll;t.netProfit=t.revenue.totalRevenue-a,t.netMarginPct=t.revenue.totalRevenue>0?Number((t.netProfit/t.revenue.totalRevenue*100).toFixed(1)):0,t.endingCash=e.player.cash,t.endingNetWorth=this.calculateCompanyNetWorth(e)}static ensureFinancialState(t){return(!t.financialState||!t.financialState.today)&&(t.financialState=this.initFinancialState(t.player.cash,this.calculateCompanyNetWorth(t))),t.financialState}static generateCFOAdvisory(t,e){const s=t.revenue.totalRevenue,a=t.grossMarginPct,i=e.player.cash;return s===0?{rating:"WARNING",title:"💤 產線待命中 — 週期營收缺口警示",advice:"本週期尚未認列任何晶圓出貨尾款或 NRE 光罩開發款，但固定水電與工程師薪資持續流出。請立即前往【合約公告板】承接高毛利訂單！",metrics:"毛利率: 0.0% | 產能營收: NT$ 0"}:i<1e7?{rating:"CRITICAL",title:"🚨 流動資金偏低 — 嚴控資本開支",advice:"現金儲備低於安全水位！建議暫緩購買高價新機台，優先全力推進在製晶圓批次出貨，或檢查機台磨損避免意外炸機造成大修支出！",metrics:`流動現金: NT$ ${Math.round(i).toLocaleString()}（建議最低安全門檻: NT$ 20,000,000）`}:a>=53?{rating:"EXCELLENT",title:"🌟 傳奇毛利率 — 達到台積電 53% 卓越標竿！",advice:"恭喜！本週期毛利率高達 "+a+"%，超越全球半導體龍頭 53.0% 標竿！製程良率優異且 NRE 溢價充沛。建議積極將獲利轉入 CapEx 擴大產能，搶佔次世代製程領導地位！",metrics:`當期毛利率: ${a}%（超越全球龍頭標竿 53.0% 達成！）`}:a>=35?{rating:"GOOD",title:"⚖️ 獲利穩健 — 符合晶圓代工常態",advice:"收支結構健康，毛利率維持在良好的 35% ~ 50% 區間。建議透過 🛡️ TPM 在線保養維持零故障，並優化員工排班減少夜班過勞，進一步釋放產能。",metrics:`當期毛利率: ${a}%（符合產業健康標準 35% ~ 45%）`}:{rating:"WARNING",title:"⚠️ 毛利受壓 — 成本與耗損偏高",advice:"本週期毛利率偏低，主要受限於機台維修頻繁、折舊沉重或報廢損失。建議檢查機台配對狀態與工程師職級，減少晶圓報廢，拉升合格晶粒產出比率。",metrics:`當期毛利率: ${a}%（低於產業安全水準 35.0%）`}}}g(A,"DAY_SECONDS",30),g(A,"DAYS_PER_WEEK",7),g(A,"DAYS_PER_MONTH",28);class P{static createDefaultSave(t="矽島先進半導體",e="張創辦人",s="avatar_1"){const a=Date.now();return{schemaVersion:2,savedAt:a,lastOnlineTimestamp:a,player:{companyName:t,ceoName:e,avatarId:s,cash:5e7,foundryTier:1,popularity:100,unlockedK1:"BASE",unlockedCleanroomClass:"Class 10000"},unlockedFeatures:{cmp:!1,agv:!1,oht:!1,mesAutoDispatch:!1,mixAndMatchLitho:!1},facility:{cleanroomPhase:1,bayGridSize:{width:10,height:10},yellowRoomTiles:[{x:3,y:1},{x:4,y:1},{x:5,y:1},{x:6,y:1},{x:7,y:1},{x:3,y:2},{x:4,y:2},{x:5,y:2},{x:6,y:2},{x:7,y:2},{x:3,y:3},{x:4,y:3},{x:5,y:3},{x:6,y:3},{x:7,y:3}]},machines:[{id:"mach_film_1",modelId:"film_furnace",name:"熱氧化爐 (Thermal Oxidation)",category:"FILM",tier:1,gridX:1,gridY:2,wear:0,status:"IDLE",assignedEngineerId:null},{id:"mach_track_1",modelId:"track_clean",name:"手動旋塗熱板台 (Manual Track)",category:"TRACK",tier:1,gridX:4,gridY:2,wear:0,status:"IDLE",assignedEngineerId:null},{id:"mach_litho_1",modelId:"litho_contact",name:"接觸式微影機 (Contact Aligner)",category:"LITHO",tier:1,gridX:6,gridY:2,wear:0,status:"IDLE",assignedEngineerId:"staff_1",pairedTrackIds:["mach_track_1"]},{id:"mach_etch_1",modelId:"etch_plasma",name:"電漿乾式蝕刻機 (Dry Plasma Etcher)",category:"ETCH",tier:1,gridX:6,gridY:6,wear:0,status:"IDLE",assignedEngineerId:null},{id:"mach_diff_1",modelId:"diff_furnace",name:"擴散退火爐 (Diffusion Furnace)",category:"DIFF",tier:1,gridX:2,gridY:6,wear:0,status:"IDLE",assignedEngineerId:null}],staff:[{id:"staff_1",name:"Alex Miller",rank:"Skilled Worker",moduleSpecialty:"LITHO",fatigue:10,shiftMode:"THREE_SHIFT",workShift:"DAY",assignedMachineId:"mach_litho_1",salary:6e4}],activeOrders:[],activeLots:[],rollingYieldHistory:[],clawbackDebt:0,questState:{lastDateStr:new Date().toISOString().split("T")[0],dailyQuests:[],allDailyClaimed:!1,weeklyCompletedCount:0,weeklyTarget:15,weeklyClaimed:!1},achievements:D.getInitialAchievements(),gameTime:0,financialState:A.initFinancialState(5e7,7e7)}}static getUserProfiles(){try{const t=localStorage.getItem(this.REGISTRY_KEY);if(t){const e=JSON.parse(t);if(Array.isArray(e)&&e.length>0)return e}}catch(t){console.warn("讀取使用者目錄失敗:",t)}return this.initializeDefaultProfile()}static initializeDefaultProfile(){const t=localStorage.getItem(this.STORAGE_KEY_V2);let e="張創辦人",s="矽島先進半導體",a=1,i=5e7,r=Date.now();if(t)try{const l=JSON.parse(t);l.player&&(e=l.player.ceoName||e,s=l.player.companyName||s,a=l.player.foundryTier||a,i=l.player.cash||i,r=l.savedAt||r)}catch{}const n={id:"usr_default",name:e,companyName:s,foundryTier:a,cash:i,createdAt:r,lastPlayedAt:Date.now(),storageKey:this.STORAGE_KEY_V2},o=[n];try{localStorage.setItem(this.REGISTRY_KEY,JSON.stringify(o)),localStorage.setItem(this.ACTIVE_USER_ID_KEY,n.id)}catch{}return o}static getActiveUserProfile(){const t=this.getUserProfiles(),e=localStorage.getItem(this.ACTIVE_USER_ID_KEY),s=t.find(i=>i.id===e);if(s)return s;const a=t[0]||this.initializeDefaultProfile()[0];return localStorage.setItem(this.ACTIVE_USER_ID_KEY,a.id),a}static createUser(t,e){const s=t.trim()||`執行長 ${Math.floor(Math.random()*900+100)}`,a=(e==null?void 0:e.trim())||`${s}半導體`,i=`usr_${Date.now().toString(36)}_${Math.random().toString(36).substring(2,6)}`,r=`SILICON_TYCOON_SAVE_${i}`,n={id:i,name:s,companyName:a,foundryTier:1,cash:5e7,createdAt:Date.now(),lastPlayedAt:Date.now(),storageKey:r},o=this.createDefaultSave(a,s);o.userId=i,localStorage.setItem(r,JSON.stringify(o));const l=this.getUserProfiles();return l.push(n),localStorage.setItem(this.REGISTRY_KEY,JSON.stringify(l)),localStorage.setItem(this.ACTIVE_USER_ID_KEY,i),n}static renameUser(t,e){const s=e.trim();if(!s)return!1;const a=this.getUserProfiles(),i=a.find(n=>n.id===t);if(!i)return!1;i.name=s,localStorage.setItem(this.REGISTRY_KEY,JSON.stringify(a));const r=localStorage.getItem(i.storageKey);if(r)try{const n=JSON.parse(r);n.player&&(n.player.ceoName=s,localStorage.setItem(i.storageKey,JSON.stringify(n)))}catch{}return!0}static deleteUser(t){const e=this.getUserProfiles();if(e.length<=1)return{success:!1,message:"至少需要保留一個玩家存檔，無法全部刪除！"};const s=e.findIndex(r=>r.id===t);if(s===-1)return{success:!1,message:"找不到該玩家存檔！"};const a=e[s];return localStorage.removeItem(a.storageKey),e.splice(s,1),localStorage.setItem(this.REGISTRY_KEY,JSON.stringify(e)),localStorage.getItem(this.ACTIVE_USER_ID_KEY)===t&&localStorage.setItem(this.ACTIVE_USER_ID_KEY,e[0].id),{success:!0}}static switchActiveUser(t){return this.getUserProfiles().find(a=>a.id===t)?(localStorage.setItem(this.ACTIVE_USER_ID_KEY,t),this.loadFromLocalStorage()):null}static saveToLocalStorage(t){try{t.savedAt=Date.now(),t.lastOnlineTimestamp=Date.now();const e=this.getActiveUserProfile(),s=t.userId&&t.userId===e.id?e.storageKey:e.storageKey||this.STORAGE_KEY_V2,a=JSON.stringify(t);localStorage.setItem(s,a);const i=this.getUserProfiles(),r=i.find(n=>n.id===e.id);return r&&(r.cash=t.player.cash,r.foundryTier=t.player.foundryTier,r.companyName=t.player.companyName,r.name=t.player.ceoName,r.lastPlayedAt=Date.now(),localStorage.setItem(this.REGISTRY_KEY,JSON.stringify(i))),!0}catch(e){return console.error("LocalStorage 存檔失敗:",e),!1}}static loadFromLocalStorage(){try{const t=this.getActiveUserProfile();let e=localStorage.getItem(t.storageKey);if(!e&&t.id==="usr_default"&&(e=localStorage.getItem(this.STORAGE_KEY_V2)),e){const i=JSON.parse(e);if(i.schemaVersion===2)return i.staff&&(i.staff=this.normalizeStaffData(i.staff)),i.facility||(i.facility={cleanroomPhase:1,bayGridSize:{width:10,height:10}}),(!i.facility.yellowRoomTiles||i.facility.yellowRoomTiles.length===0)&&(i.facility.yellowRoomTiles=[{x:3,y:1},{x:4,y:1},{x:5,y:1},{x:6,y:1},{x:7,y:1},{x:3,y:2},{x:4,y:2},{x:5,y:2},{x:6,y:2},{x:7,y:2},{x:3,y:3},{x:4,y:3},{x:5,y:3},{x:6,y:3},{x:7,y:3}]),(!i.facility.bayGridSize||i.facility.bayGridSize.width<10)&&(i.facility.bayGridSize={width:10,height:10}),i.userId=t.id,i.financialState=A.ensureFinancialState(i),i}const s=localStorage.getItem(this.STORAGE_KEY_V1);if(s){const i=JSON.parse(s);if(i.schemaVersion===1){console.warn("偵測到舊版 SaveGameV1 存檔，執行自動升級至 SaveGameV2...");const r=this.migrateSaveV1toV2(i);return r.userId=t.id,r.financialState=A.ensureFinancialState(r),this.saveToLocalStorage(r),r}}const a=this.createDefaultSave(t.companyName,t.name);return a.userId=t.id,this.saveToLocalStorage(a),a}catch(t){return console.error("LocalStorage 讀檔失敗:",t),null}}static normalizeStaffData(t){return t.map((e,s)=>{const a=/[\u4e00-\u9fa5]/.test(e.name);let i=e.name;if(a||!i){const r=this.ENGLISH_FIRST_NAMES[s%this.ENGLISH_FIRST_NAMES.length],n=this.ENGLISH_LAST_NAMES[s%this.ENGLISH_LAST_NAMES.length];i=`${r} ${n}`}return{...e,name:i,workShift:e.workShift||(s%3===0?"DAY":s%3===1?"SWING":"NIGHT")}})}static migrateSaveV1toV2(t){var i;const e=new Date().toISOString().split("T")[0],s=t.machines.map(r=>({...r,pairedTrackIds:r.category==="LITHO"?[]:void 0})),a=t.activeOrders.map(r=>({...r,urgencyMultiplier:r.urgencyMultiplier??1,layerAllocations:[]}));return{schemaVersion:2,savedAt:t.savedAt??Date.now(),lastOnlineTimestamp:t.lastOnlineTimestamp??Date.now(),player:{...t.player},unlockedFeatures:{cmp:t.unlockedFeatures.cmp??!1,agv:t.unlockedFeatures.agv??!1,oht:t.unlockedFeatures.oht??!1,mesAutoDispatch:t.unlockedFeatures.mesAutoDispatch??!1,mixAndMatchLitho:!1},facility:{cleanroomPhase:((i=t.facility)==null?void 0:i.cleanroomPhase)??1,bayGridSize:{width:10,height:10},yellowRoomTiles:[{x:3,y:1},{x:4,y:1},{x:5,y:1},{x:6,y:1},{x:7,y:1},{x:3,y:2},{x:4,y:2},{x:5,y:2},{x:6,y:2},{x:7,y:2},{x:3,y:3},{x:4,y:3},{x:5,y:3},{x:6,y:3},{x:7,y:3}]},machines:s,staff:this.normalizeStaffData(t.staff??[]),activeOrders:a,activeLots:t.activeLots??[],rollingYieldHistory:t.rollingYieldHistory??[],clawbackDebt:t.clawbackDebt??0,questState:{lastDateStr:e,dailyQuests:[],allDailyClaimed:!1,weeklyCompletedCount:0,weeklyTarget:15,weeklyClaimed:!1},achievements:D.getInitialAchievements(),gameTime:t.gameTime??0}}static exportSaveToJson(t){return JSON.stringify(t,null,2)}static importSaveFromJson(t){try{const e=JSON.parse(t);return e.schemaVersion===2?{success:!0,state:e}:e.schemaVersion===1?{success:!0,state:this.migrateSaveV1toV2(e)}:{success:!1,error:"不相容的存檔格式版本！"}}catch(e){return{success:!1,error:`JSON 解析失敗: ${e.message}`}}}static calculateOfflineProgress(t,e){const s=Math.max(0,Math.floor((e-t.lastOnlineTimestamp)/1e3)),a=Math.min(14400,s),i={offlineDurationSeconds:a,lotsProcessed:0,wafersDelivered:0,revenueEarned:0,salaryPaid:0,utilityPaid:0,maintenanceExpense:0,debtRepaid:0,breakdownCount:0,explosionCount:0,tpmProtectedCount:0,netProfit:0};if(a<60)return i;const r=Math.floor(a/300),n=new Map(t.staff.map(m=>[m.id,m]));let o=0;for(const m of t.machines){const b=m.assignedEngineerId?n.get(m.assignedEngineerId):null;if(O.checkTPMConditions(m,b).isTPMActive)o++,m.wear=Math.min(5,m.wear),m.status="IDLE";else{const y=r*.4;m.wear=Math.min(100,m.wear+y),m.wear>=60&&Math.random()<.3&&(i.breakdownCount++,O.checkExplosionRisk(m,b).hasRisk&&Math.random()<.25?(i.explosionCount++,i.maintenanceExpense+=2e5*m.tier,m.status="EXPLODED"):(i.maintenanceExpense+=5e4*m.tier,m.status="MAINTENANCE"))}}i.tpmProtectedCount=o;const l=a/3600,d=t.staff.reduce((m,b)=>m+b.salary,0)/720,h=t.machines.length*15e3/720;if(i.salaryPaid=Math.round(d*l),i.utilityPaid=Math.round(h*l),t.unlockedFeatures.mesAutoDispatch&&t.activeOrders.length>0){const m=t.activeOrders.find(b=>b.status==="ACTIVE");if(m&&i.explosionCount===0){const b=Math.min(Math.floor(a/180),10);if(b>0){i.lotsProcessed=b;const T=b*5;i.wafersDelivered=T;const y=Math.round(T*100*m.unitPrice);i.revenueEarned=y;for(let w=0;w<b;w++)t.rollingYieldHistory.push(.92)}}}const c=i.revenueEarned,u=i.salaryPaid+i.utilityPaid+i.maintenanceExpense,p=c-u;if(p>0&&t.clawbackDebt>0){const m=Math.min(t.clawbackDebt,Math.round(p*.25));i.debtRepaid=m,t.clawbackDebt-=m}return i.netProfit=c-u-i.debtRepaid,t.player.cash=Math.max(0,t.player.cash+i.netProfit),t.gameTime+=a,t.lastOnlineTimestamp=e,t.savedAt=e,i}}g(P,"STORAGE_KEY_V2","SILICON_TYCOON_SAVE_V2"),g(P,"STORAGE_KEY_V1","SILICON_TYCOON_SAVE_V1"),g(P,"REGISTRY_KEY","SILICON_TYCOON_USERS_REGISTRY"),g(P,"ACTIVE_USER_ID_KEY","SILICON_TYCOON_ACTIVE_USER_ID"),g(P,"ENGLISH_FIRST_NAMES",["Alex","David","Sarah","Kevin","Emily","Michael","Jessica","James","Daniel","Rachel","Robert","Brian","Olivia","William","Sophia","Thomas"]),g(P,"ENGLISH_LAST_NAMES",["Miller","Chen","Smith","Williams","Johnson","Taylor","Davis","Wilson","Anderson","White","Harris","Martin","Clark","Lewis","Walker","Hall"]);class H{static getNodeSpec(t){return this.PRICING_TABLE.slice().reverse().find(s=>t<=s.nodeNm)||this.PRICING_TABLE[0]}static calculateUpfrontNRE(t,e,s=1){const a=this.getNodeSpec(t);return Math.round(a.baseNRE*e*s)}static calculateTrustMultiplier(t){if(t===null||isNaN(t))return 1;const e=.7+t*.5;return Math.max(.75,Math.min(1.25,Number(e.toFixed(3))))}static calculateUnitPrice(t,e,s,a){const i=this.getNodeSpec(t),r=1+(e-1)*.08,n=i.basePrice*r*s*a;return Number(n.toFixed(2))}static settleOrderPayout(t,e,s,a,i=0,r=0){const n=Math.max(0,Math.round(e*t.unitPrice-i));let o=0,l=r;if(l>0&&n>0){const c=a.reduce((p,m)=>p+m.salary,0)*1.5,u=s.cash+n;if(u>c){const p=u-c,m=Math.min(p*.25,n*.25);o=Math.min(l,Math.round(m)),l-=o}}const d=n-o;return{grossPayout:n,netPayout:d,debtDeducted:o,remainingDebt:l}}static calculateOverdueClawback(t,e,s=!1){const a=e-t.deadlineGameTime;return a<=0?{clawbackRatio:0,clawbackAmount:0,isCancelled:!1}:s&&a<=86400?{clawbackRatio:.1,clawbackAmount:Math.round(t.nrePaid*.1),isCancelled:!1}:a<=28800?{clawbackRatio:.3,clawbackAmount:Math.round(t.nrePaid*.3),isCancelled:!1}:a<=86400?{clawbackRatio:.7,clawbackAmount:Math.round(t.nrePaid*.7),isCancelled:!1}:{clawbackRatio:1,clawbackAmount:t.nrePaid,isCancelled:!0}}static generateContractBoard(t,e,s){const a=[],i=["聯發通訊","蘋果核心","輝達智能","高通晶創","超微運算","台積晶心","瑞昱音訊","博通網通"],r=this.PRICING_TABLE.filter(o=>o.minTier<=t),n=this.calculateTrustMultiplier(e);for(let o=0;o<6;o++){const l=r[Math.floor(Math.random()*r.length)],d=i[(o+Math.floor(Math.random()*5))%i.length],h=l.minTier<=2?3:5,c=l.minTier<=2?5:l.minTier<=4?12:24,u=Math.floor(Math.random()*(c-h+1))+h,p=[3,5,10,25][Math.floor(Math.random()*4)],m=l.nodeNm>=1e3?500:2e3,b=p*m,T=[1,1,1,1.2,1.5],y=T[Math.floor(Math.random()*T.length)],w=this.calculateUpfrontNRE(l.nodeNm,u,y),E=this.calculateUnitPrice(l.nodeNm,u,y,n),v=Math.round(u*30*p*.8/y+180),S=s+v;a.push({id:`ORD-${Date.now().toString(36).toUpperCase()}-${o}`,clientName:d,nodeNm:l.nodeNm,layerCount:u,totalDies:b,goodDiesDelivered:0,nrePaid:w,unitPrice:E,urgencyMultiplier:y,deadlineGameTime:S,status:"ACTIVE"})}return a}}g(H,"PRICING_TABLE",[{nodeNm:1e4,basePrice:2,baseNRE:8e4,minTier:1},{nodeNm:3e3,basePrice:4,baseNRE:18e4,minTier:1},{nodeNm:1e3,basePrice:6,baseNRE:4e5,minTier:2},{nodeNm:350,basePrice:10,baseNRE:9e5,minTier:3},{nodeNm:180,basePrice:18,baseNRE:2e6,minTier:3},{nodeNm:90,basePrice:40,baseNRE:55e5,minTier:4},{nodeNm:45,basePrice:80,baseNRE:15e6,minTier:4},{nodeNm:28,basePrice:200,baseNRE:45e6,minTier:5},{nodeNm:7,basePrice:600,baseNRE:16e7,minTier:6},{nodeNm:2,basePrice:1500,baseNRE:45e7,minTier:6}]);class ne{constructor(t,e){g(this,"container");g(this,"callbacks");const s=document.getElementById(t);if(!s)throw new Error(`找不到 HUD 容器: #${t}`);this.container=s,this.callbacks=e}render(t){var l,d,h,c,u,p,m,b,T,y,w,E,M,v,S,R,L;const e=t.player,s=t.unlockedFeatures.cmp,a=t.rollingYieldHistory.length>0?t.rollingYieldHistory.slice(-5).reduce((x,k)=>x+k,0)/Math.min(5,t.rollingYieldHistory.length):null,i=H.calculateTrustMultiplier(a),r=N.calculateFactoryWorkload(t.machines,t.staff,t.activeLots,t.unlockedFeatures,s);let n="#10b981";r.workloadPercent>85?n="#ef4444":r.workloadPercent>=70&&(n="#f59e0b");const o=f.isAudioMuted();this.container.innerHTML=`
      ...
      <div class="flex items-center gap-1.5">
        ...
        <button id="btn-quests" class="btn-sci-fi relative text-xs">
          📋 任務
          ${t.questState.dailyQuests.some(x=>x.completed&&!x.claimed)?'<span class="absolute -top-1 -right-1 w-2.5 h-2.5 rounded-full bg-amber-400"></span>':""}
        </button>

        <!-- 成就 -->
        <button id="btn-achievements" class="btn-sci-fi relative text-xs">
          🏆 成就
          ${t.achievements.some(x=>x.unlocked&&!x.claimed)?'<span class="absolute -top-1 -right-1 w-2.5 h-2.5 rounded-full bg-emerald-400"></span>':""}
        </button>
    ...
    `,(l=document.getElementById("btn-contracts"))==null||l.addEventListener("click",x=>{x.stopPropagation(),f.playClick(),this.callbacks.onOpenContracts()}),(d=document.getElementById("btn-store"))==null||d.addEventListener("click",x=>{x.stopPropagation(),f.playClick(),this.callbacks.onOpenStore()}),(h=document.getElementById("btn-hr"))==null||h.addEventListener("click",x=>{x.stopPropagation(),f.playClick(),this.callbacks.onOpenHR()}),(c=document.getElementById("btn-planner"))==null||c.addEventListener("click",x=>{var k,C;x.stopPropagation(),f.playClick(),(C=(k=this.callbacks).onOpenPlanner)==null||C.call(k)}),(u=document.getElementById("btn-quests"))==null||u.addEventListener("click",x=>{x.stopPropagation(),f.playClick(),this.callbacks.onOpenQuests()}),(p=document.getElementById("btn-achievements"))==null||p.addEventListener("click",x=>{x.stopPropagation(),f.playClick(),this.callbacks.onOpenAchievements()}),(m=document.getElementById("btn-advisory-alert"))==null||m.addEventListener("click",x=>{x.stopPropagation(),f.playClick(),this.callbacks.onOpenAdvisory()}),(b=document.getElementById("btn-finance"))==null||b.addEventListener("click",x=>{var k,C;x.stopPropagation(),f.playClick(),(C=(k=this.callbacks).onOpenFinance)==null||C.call(k)}),(T=document.getElementById("btn-hud-cash"))==null||T.addEventListener("click",x=>{var k,C;x.stopPropagation(),f.playClick(),(C=(k=this.callbacks).onOpenFinance)==null||C.call(k)}),(y=document.getElementById("btn-hud-profile-avatar"))==null||y.addEventListener("click",x=>{var k,C;x.stopPropagation(),f.playClick(),(C=(k=this.callbacks).onOpenLogin)==null||C.call(k)}),(w=document.getElementById("btn-hud-switch-user"))==null||w.addEventListener("click",x=>{var k,C;x.stopPropagation(),f.playClick(),(C=(k=this.callbacks).onOpenLogin)==null||C.call(k)}),(E=document.getElementById("btn-login-user"))==null||E.addEventListener("click",x=>{var k,C;x.stopPropagation(),f.playClick(),(C=(k=this.callbacks).onOpenLogin)==null||C.call(k)}),(M=document.getElementById("btn-toggle-mes"))==null||M.addEventListener("click",x=>{x.stopPropagation(),f.playClick();const k=!t.unlockedFeatures.mesAutoDispatch;t.unlockedFeatures.mesAutoDispatch=k,this.callbacks.onToggleMES(k),this.render(t)}),(v=document.getElementById("btn-hud-yield"))==null||v.addEventListener("click",x=>{var k,C;x.stopPropagation(),f.playClick(),(C=(k=this.callbacks).onOpenWaferMap)==null||C.call(k)}),(S=document.getElementById("btn-tutorial"))==null||S.addEventListener("click",x=>{var k,C;x.stopPropagation(),f.playClick(),(C=(k=this.callbacks).onOpenTutorial)==null||C.call(k)}),(R=document.getElementById("btn-sound"))==null||R.addEventListener("click",x=>{x.stopPropagation(),f.toggleMute(),f.playClick(),this.render(t)}),(L=document.getElementById("btn-save"))==null||L.addEventListener("click",x=>{x.stopPropagation(),f.playClick(),this.callbacks.onOpenSaveModal()})}}class Z{static show(t,e){const s=document.getElementById("modal-container");if(!s)return;let a="avatar_1";const i=()=>{var r,n,o;s.innerHTML=`
            ...
            <div class="flex flex-col items-center justify-center space-y-3">
              <div class="relative w-64 h-64 sm:w-72 sm:h-72 rounded-full bg-gradient-to-tr from-slate-900 via-slate-800 to-cyan-950 border-4 border-cyan-500/30 shadow-2xl p-6 flex items-center justify-center group">
                ...
                <div class="grid grid-cols-5 gap-2 w-full h-full relative z-10 p-2">
                  ${this.dies.map(u=>{var T;const p=((T=this.selectedDie)==null?void 0:T.index)===u.index;let m="bg-emerald-500 hover:bg-emerald-400 border-emerald-300/80 shadow-[0_0_8px_rgba(16,185,129,0.5)]",b="✓";return u.passed||(u.defectType==="CLUSTER"?(m="bg-red-600 hover:bg-red-500 border-red-400 shadow-[0_0_10px_rgba(239,68,68,0.7)]",b="✕"):u.defectType==="OPTICAL_DEFOCUS"?(m="bg-amber-500 hover:bg-amber-400 border-amber-300 shadow-[0_0_8px_rgba(245,158,11,0.6)]",b="⚠"):(m="bg-purple-600 hover:bg-purple-500 border-purple-400 shadow-[0_0_8px_rgba(168,85,247,0.6)]",b="●")),`
                      <button
...
${c.scienceNote}`)})}),t.querySelectorAll(".btn-buy-equipment").forEach(l=>{l.addEventListener("click",d=>{const h=d.currentTarget.getAttribute("data-model-id"),c=this.STORE_CATALOG.find(T=>T.modelId===h);if(!c)return;if(e.player.cash<c.price){alert("資金不足，無法完成設備採購！");return}e.player.cash-=c.price,A.recordCapEx(e,c.price),f.playCoinChime();const u=e.machines.length,p=u%4*2,m=Math.floor(u/4)*2,b={id:`MCH-${Date.now().toString(36).toUpperCase().slice(-5)}`,modelId:c.modelId,name:c.name.split(" (")[0],category:c.category,tier:c.tier,gridX:Math.min(7,p),gridY:Math.min(7,m),wear:0,status:"IDLE",assignedEngineerId:null,pairedTrackIds:c.category==="LITHO"?[]:void 0};e.machines.push(b),D.checkAchievements(e),s(),this.activeCategory="FLEET",this.render(t,e,s)})}),t.querySelectorAll(".btn-overhaul").forEach(l=>{l.addEventListener("click",d=>{const h=d.currentTarget.getAttribute("data-machine-id"),c=parseInt(d.currentTarget.getAttribute("data-cost")||"0",10),u=e.machines.find(p=>p.id===h);if(u){if(e.player.cash<c){alert("資金不足，無法支付大修費用！");return}e.player.cash-=c,A.recordMaintenance(e,c),u.wear=0,u.status="IDLE",f.playClick(),s(),this.render(t,e,s)}})}),t.querySelectorAll(".btn-decommission").forEach(l=>{l.addEventListener("click",d=>{const h=d.currentTarget.getAttribute("data-machine-id"),c=parseInt(d.currentTarget.getAttribute("data-refund")||"0",10),u=e.machines.findIndex(m=>m.id===h);if(u===-1||!confirm(`確定要報廢並變賣此機台嗎？將回收變賣金 NT$ ${c.toLocaleString()}`))return;const p=e.machines[u];if(p.assignedEngineerId){const m=e.staff.find(b=>b.id===p.assignedEngineerId);m&&(m.assignedMachineId=null)}e.player.cash+=c,e.machines.splice(u,1),f.playCoinChime(),s(),this.render(t,e,s)})})}}g(G,"activeCategory","LITHO"),g(G,"STORE_CATALOG",[{modelId:"litho_contact",name:"Contact Aligner (接觸式微影機)",category:"LITHO",tier:1,price:25e5,throughputWpm:10,rayleighLimitNm:3007,description:"半導體萌芽期主力，光罩物理緊貼晶圓表面進行紫外曝光，維修容易。",scienceNote:"利用汞燈紫外混光 (436nm) 貼合曝光。因光罩直接碰觸晶圓表面，容易刮傷光罩與產生落塵，極限線寬約 3µm。",assetPath:$.machines.litho_contact.path},{modelId:"litho_projection",name:"1x Projection Aligner (1:1 投影曝光機)",category:"LITHO",tier:1,price:6e6,throughputWpm:15,rayleighLimitNm:1798,description:"反射鏡等倍投影微影，光罩懸空不接觸晶圓，徹底終結光罩刮傷磨損。",scienceNote:"Perkin-Elmer 經典反射光學系統，以凹面鏡聚焦達成 1:1 無接觸曝光，大幅提升光罩壽命與開局良率。",assetPath:$.machines.litho_projection.path},{modelId:"litho_gline",name:"G-Line Stepper (步進縮小曝光機)",category:"LITHO",tier:2,price:18e6,throughputWpm:25,rayleighLimitNm:997,description:"4:1 縮小投影透鏡，逐區步進曝光（Step-and-Repeat），進入 1µm 時代。",scienceNote:"高壓汞燈 g-line (436nm) 搭配數值孔徑 NA=0.35 之複合縮小透鏡，將光罩圖案縮小 4 倍投射，突破微米大關。",assetPath:$.machines.litho_gline.path},{modelId:"litho_iline",name:"I-Line Stepper (高壓汞燈微影機)",category:"LITHO",tier:3,price:35e6,throughputWpm:55,rayleighLimitNm:584,description:"次微米時代霸主，波長 365nm，支援精密對準與多層金屬互連製程。",scienceNote:"採用更短波長之高強度汞燈 i-line (365nm) 與 NA=0.50 鏡頭，成功壓制繞射效應，可清晰成像至 500nm。",assetPath:$.machines.litho_iline.path},{modelId:"litho_krf",name:"KrF DUV Scanner (準分子雷射微影機)",category:"LITHO",tier:4,price:85e6,throughputWpm:120,rayleighLimitNm:283,description:"深紫外光 (DUV) 準分子雷射，邁入動態連續掃描曝光 (Step-and-Scan)。",scienceNote:"248nm 氟化氪 (KrF) 準分子雷射光源，必須搭配化學增幅光阻 (CAR) 放大光化學反應，支援 0.25µm 製程。",assetPath:$.machines.litho_krf.path},{modelId:"litho_arfdry",name:"ArF Dry Scanner (氟化氬乾式微影機)",category:"LITHO",tier:4,price:18e7,throughputWpm:120,rayleighLimitNm:182,description:"193nm 紫外雷射，將大氣乾式微影發揮至極致，跨越次百奈米門檻。",scienceNote:"利用 193nm 氟化氬雷射與高折射石英透鏡群，是半導體製程縮小至 90nm/65nm 的核心關鍵機台。",assetPath:$.machines.litho_arfdry.path},{modelId:"litho_arfi",name:"ArFi Immersion TWINSCAN (浸潤式微影機)",category:"LITHO",tier:5,price:45e7,throughputWpm:260,rayleighLimitNm:114,description:"鏡頭與晶圓間注入超純水折射光線，雙工件台磁浮掃描，大氣產速最快！",scienceNote:"林本堅博士提出之革命性技術：利用水之折射率 n=1.44 巧妙將等效數值孔徑提升至 NA=1.35，多重曝光下推進至 7nm！",assetPath:$.machines.litho_arfi.path},{modelId:"litho_euv",name:"EUV Scanner (極紫外光微影巨獸)",category:"LITHO",tier:6,price:25e8,throughputWpm:180,rayleighLimitNm:33,description:"13.5nm 極紫外光，全真空反射鏡系統，單次曝光推進 7nm/5nm/3nm！",scienceNote:"以高功率二氧化碳雷射轟擊融熔錫滴激發電漿，產生 13.5nm EUV 光子，全機在超高真空運行，受抽真空限制產能為 180 片/分。",assetPath:$.machines.litho_euv.path},{modelId:"litho_highna",name:"High-NA EUV (高數值孔徑次世代巨獸)",category:"LITHO",tier:6,price:6e9,throughputWpm:180,rayleighLimitNm:20,description:"0.55 NA 變形數值孔徑透鏡，埃米世代霸主，稱霸矽島之終極神兵。",scienceNote:"採用變形鏡頭 (Anamorphic Optics)，X/Y 軸非對稱倍率，單次曝光極限線寬可達 20nm 以下，引領 2nm 埃米時代。",assetPath:$.machines.litho_highna.path},{modelId:"track_manual",name:"手動旋塗熱板台 (Manual Spin & Bake)",category:"TRACK",tier:1,price:8e5,throughputWpm:6,description:"⚠️ 開局先天產能瓶頸！人工滴膠手動離心旋塗與熱板預烤，產能僅 6 片/分。",scienceNote:"利用真空吸盤固定晶圓，手動注射光阻後以 3000 RPM 高速旋轉甩出均勻薄膜，再由人員夾入熱板烘烤。",assetPath:$.machines.track_manual.path},{modelId:"track_single",name:"單軌自動塗膠顯影機 (Single Track)",category:"TRACK",tier:2,price:45e5,throughputWpm:16,description:"初步自動化旋轉塗膠與自動烘烤模組，大幅減少人工操作失誤。",scienceNote:"機械手臂自動傳送晶圓至旋塗杯，自動注膠均勻成膜，並整合冷卻板 (Chill Plate) 精確控制膜厚。",assetPath:$.machines.track_single.path},{modelId:"track_dual",name:"雙軌連線 Track (Dual Track)",category:"TRACK",tier:3,price:12e6,throughputWpm:35,description:"雙獨立機械臂分開處理塗膠與顯影，有效提升次微米連線吞吐量。",scienceNote:"將塗膠旋塗單元 (Coater) 與顯影槽 (Developer) 實體隔離，避免顯影鹼液氣體污染光阻，保障微影良率。",assetPath:$.machines.track_dual.path},{modelId:"track_clean",name:"多工位精密 Clean Track",category:"TRACK",tier:4,price:3e7,throughputWpm:75,description:"多旋塗室並聯，高速熱板陣列，建議為先進微影機配備 2 台以上！",scienceNote:"配置多組 Coater/Developer 模組與快速溫控熱板，支援化學增幅光阻嚴苛的曝光後烘烤 (PEB) 溫度控制。",assetPath:$.machines.track_clean.path},{modelId:"track_advanced",name:"先進極限分子級 Track",category:"TRACK",tier:6,price:25e7,throughputWpm:160,description:"分子級膜厚控制，完美適配 EUV 超薄金屬氧化物光阻 (MOR)。",scienceNote:"具備超微量旋塗技術與化學氣相沉積底膜 (Underlayer)，將光阻粗糙度 (LWR) 降至分子級極限。",assetPath:$.machines.track_advanced.path},{modelId:"film_furnace",name:"高溫熱氧化爐管 (Horizontal Furnace)",category:"FILM",tier:1,price:18e5,throughputWpm:12,description:"利用 1000°C 高溫水汽使矽表面長出堅硬均勻的二氧化矽 (SiO2) 絕緣保護層。",scienceNote:"利用高純度氧氣或水蒸氣在高溫下與矽晶圓反應：Si + O2 -> SiO2，生長厚度均勻的高品質絕緣氧化層。",assetPath:$.machines.film_furnace.path},{modelId:"film_pecvd",name:"電漿增強化學氣相沉積機 (PECVD / ALD)",category:"FILM",tier:4,price:25e6,throughputWpm:110,description:"利用電漿在低溫下快速沉積氮化矽、金屬介電質，並支援原子層沉積 (ALD)。",scienceNote:"以射頻電漿解離前驅氣體，可在較低溫度 (300°C) 下沉積薄膜，避免破壞底層已摻雜之電晶體結構。",assetPath:$.machines.film_pecvd.path},{modelId:"etch_wet",name:"濕式酸槽清洗台 (Wet Chemical Bench)",category:"ETCH",tier:1,price:15e5,throughputWpm:12,description:"利用氫氟酸 (HF) 與化學酸液浸泡溶解未受光阻保護之薄膜，等向性腐蝕。",scienceNote:"化學濕法腐蝕屬於等向性蝕刻 (Isotropic)，容易產生側向掏空 (Undercut)，適合 3µm 以上粗線寬。",assetPath:$.machines.etch_wet.path},{modelId:"etch_plasma",name:"電漿乾式蝕刻機 (RIE / ICP-RIE)",category:"ETCH",tier:3,price:28e6,throughputWpm:50,description:"以高能反應離子轟擊進行垂直非等向性蝕刻，線條邊緣垂直銳利！",scienceNote:"反應性離子蝕刻 (RIE) 結合物理離子轟擊與化學自由基反應，具備極高垂直各向異性 (Anisotropic)，是次微米微影的關鍵搭檔。",assetPath:$.machines.etch_plasma.path},{modelId:"diff_furnace",name:"熱擴散摻雜爐管 (Thermal Diffusion)",category:"DIFF",tier:1,price:2e6,throughputWpm:10,description:"將磷或硼蒸氣高溫擴散滲透進矽晶格中，形成 N 型與 P 型半導體通道。",scienceNote:"利用高溫晶格熱運動使雜質原子由高濃度向低濃度擴散，控溫容易但橫向擴散量大。",assetPath:$.machines.diff_furnace.path},{modelId:"diff_implanter",name:"大束流離子佈植機 (Ion Implanter)",category:"DIFF",tier:2,price:15e6,throughputWpm:20,description:"將雜質原子電離成高能離子束，如子彈般精確轟擊打入矽晶圓特定深度。",scienceNote:"高壓電場加速磷/砷/硼離子束，可獨立精確控制植入劑量與深度，無橫向擴散失真，是現代電晶體的核心技術。",assetPath:$.machines.diff_implanter.path},{modelId:"cmp_polisher",name:"化學機械平坦化研磨機 (CMP Polisher)",category:"CMP",tier:3,price:2e7,throughputWpm:40,description:"化學研磨液搭配高速研磨墊，將晶圓表面磨至分子級平坦，解鎖多層金屬佈線！",scienceNote:"利用研磨液 (Slurry) 的化學腐蝕軟化與奈米磨料的機械研磨，實現全晶圓奈米級全域平坦化 (Global Planarization)。",assetPath:$.machines.cmp_polisher.path}]);class W{static show(t,e){const s=document.getElementById("modal-container");s&&(this.candidates.length===0&&this.generateCandidates(t.player.foundryTier),this.render(s,t,e))}static generateCandidates(t){const e=["LITHO","TRACK","FILM","ETCH","DIFF","CMP"];this.candidates=[];for(let s=0;s<4;s++){const a=this.FIRST_NAMES[Math.floor(Math.random()*this.FIRST_NAMES.length)],i=this.LAST_NAMES[Math.floor(Math.random()*this.LAST_NAMES.length)],r=e[Math.floor(Math.random()*e.length)];let n="Young Specialist",o=2e4,l=45e3,d="專精基礎機台操作，磨損累積 -10%，微影 k1 -0.01。適合操作 Tier 1~2。";const h=Math.random();t>=5&&h>.6?(n="Fellow",o=5e5,l=35e4,d="頂級半導體物理泰斗，磨損累積 -80%，微影 k1 -0.06，良率 +15%，可抵銷先進製程視窗損失！"):t>=3&&h>.4?(n="Senior Engineer",o=12e4,l=15e4,d="多年產線調機權威，磨損累積 -50%，微影 k1 -0.04，良率 +10%。適合操作 Tier 3~5。"):t>=2&&h>.3&&(n="Skilled Worker",o=5e4,l=75e3,d="熟練製程技師，磨損累積 -25%，微影 k1 -0.02，良率 +5%。適合操作 Tier 1~3。"),this.candidates.push({id:`CAN-${Date.now().toString(36).slice(-4)}-${s}`,name:`${a} ${i}`,rank:n,moduleSpecialty:r,signingBonus:o,salary:l,description:d})}}static render(t,e,s){var r;const a=e.staff.reduce((n,o)=>n+o.salary,0),i=((r=e.staff[0])==null?void 0:r.shiftMode)||"THREE_SHIFT";t.innerHTML=`
    ...
    `,this.bindEvents(t,e,s,a)}static bindEvents(t,e,s,a){var n,o,l,d,h,c,u,p,m,b,T;const i=()=>{f.playClick(),t.innerHTML="",window.removeEventListener("keydown",r)},r=y=>{y.key==="Escape"&&a&&i()};window.addEventListener("keydown",r),a&&((n=document.getElementById("btn-close-login"))==null||n.addEventListener("click",i),(o=document.getElementById("btn-cancel-login"))==null||o.addEventListener("click",i),(l=document.getElementById("modal-backdrop-login"))==null||l.addEventListener("click",y=>{y.target===document.getElementById("modal-backdrop-login")&&i()})),t.querySelectorAll(".user-profile-item").forEach(y=>{y.addEventListener("click",w=>{const E=w.currentTarget.getAttribute("data-user-id");E&&(f.playClick(),this.selectedUserId=E,this.isEditingName=!1,this.isCreatingUser=!1,this.render(t,e,s,a))})}),(d=document.getElementById("btn-create-user-toggle"))==null||d.addEventListener("click",()=>{f.playClick(),this.isCreatingUser=!this.isCreatingUser,this.isEditingName=!1,this.render(t,e,s,a)}),(h=document.getElementById("btn-cancel-create"))==null||h.addEventListener("click",()=>{f.playClick(),this.isCreatingUser=!1,this.render(t,e,s,a)}),(c=document.getElementById("btn-confirm-create"))==null||c.addEventListener("click",()=>{const y=document.getElementById("input-new-username"),w=document.getElementById("input-new-company"),E=(y==null?void 0:y.value.trim())||"",M=(w==null?void 0:w.value.trim())||void 0;if(!E){alert("請輸入執行長姓名！");return}f.playCoinChime();const v=P.createUser(E,M);this.selectedUserId=v.id,this.isCreatingUser=!1,this.render(t,e,s,a)}),(u=document.getElementById("btn-rename-user-toggle"))==null||u.addEventListener("click",()=>{this.selectedUserId&&(f.playClick(),this.isEditingName=!this.isEditingName,this.isCreatingUser=!1,this.render(t,e,s,a))}),(p=document.getElementById("btn-cancel-rename"))==null||p.addEventListener("click",()=>{f.playClick(),this.isEditingName=!1,this.render(t,e,s,a)}),(m=document.getElementById("btn-confirm-rename"))==null||m.addEventListener("click",()=>{if(!this.selectedUserId)return;const y=document.getElementById("input-rename-username"),w=y==null?void 0:y.value.trim();if(!w){alert("名稱不能為空！");return}f.playClick(),P.renameUser(this.selectedUserId,w),this.isEditingName=!1,this.render(t,e,s,a)}),(b=document.getElementById("btn-delete-user"))==null||b.addEventListener("click",()=>{if(!this.selectedUserId)return;const y=P.getUserProfiles(),w=y.find(M=>M.id===this.selectedUserId);if(!w)return;if(y.length<=1){alert("這是唯一的玩家存檔，無法刪除！");return}if(!confirm(`確定要徹底刪除玩家【${w.name}】（${w.companyName}）的存檔嗎？此動作不可逆！`))return;f.playClick();const E=P.deleteUser(this.selectedUserId);if(!E.success){alert(E.message||"刪除失敗");return}this.selectedUserId=P.getActiveUserProfile().id,this.render(t,e,s,a)}),(T=document.getElementById("btn-confirm-play"))==null||T.addEventListener("click",()=>{if(!this.selectedUserId)return;f.playCoinChime();const y=P.switchActiveUser(this.selectedUserId);if(!y){alert("載入該存檔失敗，將進入預設存檔！");return}i(),s(y)})}}g(j,"selectedUserId",null),g(j,"isEditingName",!1),g(j,"isCreatingUser",!1);class le{constructor(t,e,s,a,i){g(this,"topHUD");g(this,"state");g(this,"onStateUpdated");g(this,"onUserSwitched");g(this,"onTogglePlanner");g(this,"isPlannerActive",!1);g(this,"currentPlannerTool","MOVE_MACHINE");this.state=t,this.onStateUpdated=s,this.onUserSwitched=a,this.onTogglePlanner=i,this.topHUD=new ne("top-hud",{onOpenContracts:()=>this.openContracts(),onOpenStore:()=>this.openStore(),onOpenHR:()=>this.openHR(),onOpenQuests:()=>this.openQuests(),onOpenAchievements:()=>this.openAchievements(),onOpenAdvisory:()=>this.openAdvisory(),onToggleMES:r=>this.onStateUpdated(),onOpenSaveModal:()=>this.openSaveModal(),onOpenWaferMap:()=>this.openWaferMap(),onOpenTutorial:()=>this.openTutorial(),onOpenFinance:()=>this.openFinancialReport(),onOpenLogin:()=>this.openUserLogin(),onOpenPlanner:()=>this.togglePlannerMode()}),q.init(t,e,s),(!t.player.companyName||t.player.companyName==="矽島先進半導體")&&Z.show(t,()=>{this.render(),this.onStateUpdated(),U.isCompleted()||this.openTutorial()}),this.render()}render(){this.topHUD.render(this.state),this.renderOrderStatusWidget()}renderOrderStatusWidget(){var w,E,M;const t=document.getElementById("hud-widgets");if(!t)return;if(this.state.activeOrders.length===0){t.innerHTML=`
      ...
      `}const m=this.state.unlockedFeatures.cmp,b=[{key:"FILM",name:"薄膜沉積",en:"FILM",icon:"🧪",match:(v,S)=>v==="FILM"},{key:"TRACK_COAT",name:"光阻塗膠",en:"TRACK",icon:"🌀",match:(v,S)=>v==="LIT"&&S==="COAT"},{key:"LITHO",name:"微影曝光",en:"LITHO",icon:"🔬",match:(v,S)=>v==="LIT"&&S==="EXPOSE"},{key:"TRACK_DEV",name:"顯影烘烤",en:"DEVELOP",icon:"♨️",match:(v,S)=>v==="LIT"&&S==="DEVELOP"},{key:"ETCH",name:"電漿蝕刻",en:"ETCH",icon:"⚡",match:(v,S)=>v==="ETCH"},{key:"DIFF",name:"高溫擴散",en:"DIFF",icon:"🔥",match:(v,S)=>v==="DIFF"}];m&&b.push({key:"CMP",name:"平坦化研磨",en:"CMP",icon:"💎",match:v=>v==="CMP"});let T=-1;a&&a.status==="PROCESSING"&&(T=b.findIndex(v=>v.match(a.currentStation,a.litSubStep)));const y=e.goodDiesDelivered>=e.totalDies||s.length>0&&s.every(v=>v.status==="COMPLETED");t.innerHTML=`
      <div id="hud-order-status-bar" class="hud-order-bar cursor-pointer" title="點擊檢視訂單詳情與批次資訊">
        ...
        <div class="flex items-center gap-1.5 w-full overflow-x-auto pt-1">
          ${b.map((v,S)=>{let R="step-waiting",L="待加工",x="text-slate-500";if(y)R="step-completed",L="✓ 完工",x="text-emerald-400";else if(S<T)R="step-completed",L="✓ 完工",x="text-emerald-400";else if(S===T){const J=(a==null?void 0:a.stationProgressSeconds)||0,se=(a==null?void 0:a.stationRequiredSeconds)||10;R="step-active",L=`⚡ ${J}/${se}s`,x="text-cyan-300 font-bold"}const k=v.key.startsWith("TRACK")?"TRACK":v.key==="LITHO"?"LITHO":v.key,C=this.state.machines.find(J=>J.category===k),X=(C==null?void 0:C.status)==="EXPLODED";return`
              <div class="pipeline-step ${R} ${X?"border-red-500/80 bg-red-950/30":""}" title="${v.name} (${v.en})${C?" - "+C.name:""}">
                ...
                <div class="flex items-center justify-between w-full px-1 text-[10px] mt-0.5">
                  ...
                  <span class="${X?"text-red-400 font-bold animate-pulse":x}">
                    ${X?"💥故障":L}
                  </span>
                </div>
              </div>
    ...
    `,(a=document.getElementById("btn-close-save-modal"))==null||a.addEventListener("click",s),(i=document.getElementById("btn-return-save"))==null||i.addEventListener("click",s),(r=document.getElementById("modal-backdrop-save"))==null||r.addEventListener("click",d=>{d.target===d.currentTarget&&s()}),(n=document.getElementById("btn-export-save"))==null||n.addEventListener("click",()=>{f.playClick();const d=P.exportSaveToJson(this.state),h=new Blob([d],{type:"application/json"}),c=URL.createObjectURL(h),u=document.createElement("a");u.href=c,u.download=`silicon_tycoon_save_${Date.now()}.json`,u.click(),URL.revokeObjectURL(c)}),(o=document.getElementById("btn-import-save"))==null||o.addEventListener("click",()=>{var d;(d=document.getElementById("file-import-save"))==null||d.click()}),(l=document.getElementById("file-import-save"))==null||l.addEventListener("change",d=>{var c;const h=(c=d.target.files)==null?void 0:c[0];if(h){const u=new FileReader;u.onload=p=>{var T;const m=(T=p.target)==null?void 0:T.result,b=P.importSaveFromJson(m);b.success&&b.state?(P.saveToLocalStorage(b.state),alert("存檔匯入成功！即將重新載入遊戲。"),window.location.reload()):alert(`匯入失敗: ${b.error}`)},u.readAsText(h)}})}showNotice(t){const e=document.createElement("div");e.className="fixed top-20 left-1/2 -translate-x-1/2 z-50 px-4 py-2 rounded-lg bg-slate-900/95 border border-cyan-500/50 text-cyan-200 text-xs font-medium shadow-2xl animate-bounce",e.innerText=t,document.body.appendChild(e),setTimeout(()=>e.remove(),2500)}}class de{static show(t,e,s){const a=document.getElementById("modal-container");a&&this.render(a,t,e,s)}static render(t,e,s,a){const i=$.machines[e.modelId],r=(i==null?void 0:i.path)||"./assets/machines/litho_contact.png",n=G.STORE_CATALOG.find(x=>x.modelId===e.modelId),o=n?Math.round(n.price*.15):3e5,l=n?Math.round(n.price*.4):8e5,d=Math.round(e.wear),h=s.staff.find(x=>x.id===e.assignedEngineerId);let c=!1,u=!1;h&&(c=O.checkTPMConditions(e,h).isTPMActive,u=O.checkExplosionRisk(e,h).hasRisk);let p=null,m=null;if(e.category==="LITHO"){const x=F.OPTICAL_CATALOG[e.modelId];if(x){const k=F.calculateEffectiveK1(s.player.unlockedK1,e.wear,h||null);p={effectiveK1:k.effectiveK1,formula:`Base(${k.k1Tech.toFixed(2)}) + 磨損(+${k.deltaWear.toFixed(3)}) - 調校(-${k.deltaEngineer.toFixed(2)}) + 疲勞(+${k.deltaFatigue.toFixed(2)})`},m=Math.round(k.effectiveK1*(x.wavelengthNm/x.numericalAperture))}}const b=e.category==="LITHO",T=s.machines.filter(x=>x.category==="TRACK"&&x.status!=="EXPLODED"),y=e.pairedTrackIds||[],w=N.BASE_THROUGHPUT_BY_TIER.LIT[e.tier]||10;let E=0;for(const x of y){const k=s.machines.find(C=>C.id===x);k&&(E+=N.BASE_THROUGHPUT_BY_TIER.TRACK[k.tier]||6)}const M=b&&(y.length===0||E<w),v=s.activeLots.filter(x=>x.status!=="PROCESSING"?!1:e.category==="TRACK"?x.currentStation==="LIT"&&(x.litSubStep==="COAT"||x.litSubStep==="DEVELOP"):e.category==="LITHO"?x.currentStation==="LIT"&&x.litSubStep==="EXPOSE":x.currentStation===e.category),S=v.length>0,R=N.isMachineInYellowRoom(e,s.facility.yellowRoomTiles),L=e.category==="LITHO"||e.category==="TRACK";t.innerHTML=`
          ...
          <div class="modal-body p-6 overflow-y-auto flex-1 space-y-4 text-xs">
                ...
                <div class="space-y-1.5 pt-1 font-mono text-xs">
                  ${v.map(x=>`
                    <div class="p-2.5 rounded-lg bg-slate-950/80 border border-cyan-500/30 flex items-center justify-between">
                      <div>
                        <span class="text-cyan-300 font-bold">${x.lotId}</span>
                        <span class="text-[11px] text-slate-400 ml-2">第 ${x.currentLayer}/${x.totalLayers} 層 [${x.currentStation}${x.litSubStep?" - "+x.litSubStep:""}]</span>
                      </div>
                      <div class="text-emerald-400 font-bold">
                        良率 ${(x.yieldMultiplier*100).toFixed(0)}%
                      </div>
                    </div>
                  `).join("")}
                </div>
              ...
              <div class="p-3.5 rounded-xl bg-slate-900/80 border ${M?"border-amber-500/40":"border-slate-800"} space-y-3">
                ...
                `:`
                  <div class="space-y-1.5 max-h-36 overflow-y-auto pr-1">
                    ${T.map(x=>{const k=y.includes(x.id),C=N.BASE_THROUGHPUT_BY_TIER.TRACK[x.tier]||6;return`
                        <label class="flex items-center justify-between p-2 rounded-lg bg-slate-950/60 border ${k?"border-cyan-500/40 bg-cyan-950/10":"border-slate-800"} cursor-pointer hover:border-slate-700">
                          <div class="flex items-center gap-2">
                            <input
                              ...
                              ${k?"checked":""}
                            />
                            <span class="font-semibold text-slate-200 text-xs">${x.name}</span>
                            <span class="text-[10px] text-slate-400 font-mono">(Tier ${x.tier})</span>
                          </div>
            ...
            <div class="p-3.5 rounded-xl bg-slate-900/80 border border-slate-800 space-y-2.5">
              ...
              <select id="select-station-engineer" class="select-sci-fi w-full py-2 px-3 rounded-lg bg-slate-950 border border-slate-800 text-slate-200 text-xs">
                ...
                ${s.staff.map(x=>`
                  <option value="${x.id}" ${e.assignedEngineerId===x.id?"selected":""}>
                    ${x.name} - ${x.rank} [專長: ${x.moduleSpecialty}] (疲勞: ${Math.round(x.fatigue)}%)
                  </option>
                `).join("")}
              </select>
            </div>
